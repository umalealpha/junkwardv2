...
export default function BatchCreatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await apiClient.post('/batch-create', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
      setResult({ success: true, message: 'File uploaded successfully. Processing will begin shortly.' })
      setFile(null)
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-800">Batch Policy Create</h1>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 max-w-2xl">
        <div className="mb-6">
          ...
          <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
            ...
            <li>Fill in the required policy data in the template columns.</li>
            <li>Upload the completed file (.xlsx, .xls, or .csv).</li>
            <li>The system will validate and process your file in the background.</li>
