...
export default function FraudAlerts() {
  ...
  const loadAlerts = useCallback(() => {
    ...
    apiClient
      ...
      .catch(() => setError('Failed to load fraud alerts.'))
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4">
            <div className="flex items-center justify-between px-6 py-4 border-b">
              <h3 className="text-lg font-semibold text-gray-800">Review Alert #{reviewAlert.id}</h3>
              <button onClick={() => setReviewAlert(null)} className="text-gray-400 hover:text-gray-600">&times;</button>
            </div>
            <div className="px-6 py-4 space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-ace-primary">{reviewAlert.policy_number}</p>
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-1 focus:ring-ace-primary focus:border-ace-primary"
      ...
      <div className="flex flex-wrap gap-3 items-end">
        <div>
          ...
          <select
            ...
            className="px-3 py-1.5 border border-gray-300 rounded-md text-sm focus:ring-1 focus:ring-ace-primary"
          >
        ...
        <div>
          ...
          <input
            ...
            className="px-3 py-1.5 border border-gray-300 rounded-md text-sm w-48 focus:ring-1 focus:ring-ace-primary focus:border-ace-primary"
          />
        </div>
      </div>
              ...
              {!loading && alerts.length === 0 ? (
                ...
                alerts.map((alert) => (
                  <tr key={alert.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-4 py-2 font-medium text-ace-primary">{alert.policy_number}</td>
                ...
                p === '...' ? (
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded border text-sm ${
                      p === currentPage ? 'bg-ace-primary text-white border-ace-primary' : 'text-gray-600 hover:bg-gray-100'
                    }`}
                  >
                    {p}
                  </button>
