...
<div id="content" style="margin-bottom: 0px;">
    @if(count($data) > 0)
        ...
        <p style="font-size: large"> {{ count($data) }} Contract active for cancelled policies.</p>
        <table class="table-responsive" style="border-collapse: collapse;width:100%">
            ...
            @foreach($data as $p)
                <tr>
                    ...
                    <td>
                        <p style="color: #000000; margin: 0px;">
                            <b>{{ $p->contractNumber }}</b>
                        </p>
                    </td>
                    <td>
                        <p style="color: #000000; margin: 0px;">
                            <b>{{ $p->contractActive }}</b>
                        </p>
                    </td>
                    <td>
                        <p style="color: #000000; margin: 0px;">
                            <b>{{ $p->totalInstallmentActive }}</b>
                        </p>
                    </td>
                </tr>
            @endforeach
    ...
    @else
        <p>No contracts are active for today's cancelled policies.</p>
    @endif
