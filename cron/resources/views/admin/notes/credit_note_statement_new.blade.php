...
<body>
            ...
            <table style="width:100%;">
                <tr valign="middle">
                    <td width="50%">
                        ...
                        <p style="font-size: 13px; margin: 0px;color: black!important;">Bar 1, Botswana Innovation Hub</p>
                        ...
                        <p style="margin: 0px!important;">godirect@alphadirect.co.bw | <a href="mailto: www.alphadirect.co.bw" style="color: #2e77c3!important;">www.alphadirect.co.bw</a></p>
                    </td>
                    <td width="50%">
    ...
    <p style="text-align: justify; font-size: 11px;margin:0px; padding:0px;">If you have any questions concerning this invoice, contact Unami Butale | + 267 392 8264 | businessdev@alphadirect.co.bw</p><br>
