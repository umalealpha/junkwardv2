    ...
    <div class="container clearfix" style="position: relative; padding: 40px 0px;">
        <div class="inner-container clearfix" style="z-index: 11; max-width:650px;margin: auto; ">
            <div style="margin-bottom: 0px;text-align: center;">
                <img src="https://d20dgglp0tqnyi.cloudfront.net/Document/Policy_Document/new-logo/new_logo.png" alt="logo" width="180px">
            </div>
            <div>
                <p style="margin-bottom:10px;text-align: center;"> Digital Policy Cover Notice </p>
            </div>
            ...
            <table class="table-responsive" style="border-collapse: collapse;width:100%">
                ...
                <tr>
                    <td>
                        <h4 style="margin: 0px; font-weight: 600; "><u>COVER NOTE & PROOF OF INSURANCE : <span style="text-transform: uppercase">{{ $policy->firstName.' '.$policy->lastName }}</span></u></h4>
                ...
                <tr>
                    <td>
                        <p>This serves to confirm that <span style="font-weight: 600;"><span style="text-transform: uppercase">{{ $policy->firstName.' '.$policy->lastName }}</span></span> in accordance with their instructions, is comprehensively covered
                            on the following class by <span style="font-weight: 600;">Alpha Direct Insurance Company(Pty) Ltd.</span> by <span style="font-weight: 600;"> Alpha Direct Insurance Company(Pty) Ltd.</span></p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h4 style="margin:0px; font-weight: 600;">Motor Comprehensive :</h4>
                ...
                <tr>
                    <td>
                        @if($policy->financial_interest != null)
                            <h4 style="margin:0px; font-weight: 600;">Financial Interest of <span style="text-transform: uppercase">{{ $policy->financial_interest }}</span> is noted.</h4>
                        @else
                            <h4 style="margin:0px; font-weight: 600;">No Financial Interest of Bank is provided to Alpha Direct Insurance Company.</h4>
                        @endif
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>Period of Insurance (Renewable) – <span style="text-transform: capitalize;font-weight: bold">{{ $from }} to {{ $to }}</span></p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p><span style="font-weight: 600;">Territorial Limits:</span> Loss must occur in the Republic of Botswana, Namibia, Lesotho, SouthAfrica, Malawi, Zimbabwe and Swaziland.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h4 style="margin: 0px;">Premium Payment Warranty</h4>
                        <p>This cover is issued on condition that the premiums have been paid upon presentation of our debit note or as agreed as well as receipt of KYC documentation.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>Kindly render any assistance they may need and do not hesitate to contact the undersigned for any enquiries, clarifications and amendments.</p>
                    </td>
                </tr>
            </table>
