                    ...
                    <div class="col-lg-4 text-center">
                        ...
                        <label>
                            ...
                            <h5>Policy Status: <span class="kt-badge  kt-badge--success kt-badge--inline kt-badge--pill"
                                ...
                                'SUCCESS' || $transaction->status == 'Success'))<span
                            ...
                            <h5>Policy Status:
                                ...
                                'Success'))<span class="kt-badge  kt-badge--success kt-badge--inline kt-badge--pill"
                                    style="font-size:15px"> Payment Success</span>
                                @elseif($transaction && ($transaction->status == 'PENDING' || $transaction->status ==
                                'A'))<span class="kt-badge  kt-badge--info kt-badge--inline kt-badge--pill"
                                    style="font-size:15px"> Payment Pending</span>
                                        ...
                                        <form action="{{route('admin.policy.uploadKycImages',$policy->id)}}"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="kt-avatar" id="driving_license"
                                                        style="float: left; clear: left;">
                                                        {{-- @if($kyc != null && $kyc->driving_license == NULL) --}}
                                                        @if(!isset($kyc->driving_license))
                                                            <div class="kt-avatar__holder" id="driving_license"
                                                        ...
                                                        <a href="{!! \AlphaDirect\Helper::getCloudFrontURL($kyc->driving_license) !!}"
                                                            ...
                                                            pathinfo($kyc->driving_license, PATHINFO_EXTENSION)
                                                            == 'xlsx' || pathinfo($kyc->driving_license,
                                                            ...
                                                            pathinfo($kyc->driving_license, PATHINFO_EXTENSION)
                                                            == 'jpg' || pathinfo($kyc->driving_license,
                                                        ...
                                                        {{--<div class="kt-avatar__holder"
                                                                                style="background-image:url({!! Storage::disk('s3')->url($kyc->driving_license) !!})">
                                                                            </div>--}}
                                                        @endif
                                                        ...
                                                        <label class="kt-avatar__upload" data-toggle="kt-tooltip"
                                                            title="Change Image">
                                                            <i class="fa fa-pen"></i>
                                                            <input type='file' class="driving_license"
                                                ...
                                                <div class="col-md-2">
                                                    <h3 class="col-form-label" style="float: left;">Omang ID Front
                                                    </h3>
                                                    <div class="kt-avatar" id="omang_pic"
                                                        style="float: left; clear: left;">
                                                        ...
                                                        <a href="{!! \AlphaDirect\Helper::getCloudFrontURL($kyc->omang) !!}"
                                                            target="_blank" download>
                                                            @if(pathinfo($kyc->omang, PATHINFO_EXTENSION) ==
                                                            'pdf')
                                                            <img src="{{asset('images/pdf.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->omang, PATHINFO_EXTENSION) ==
                                                            'docx' || pathinfo($kyc->omang, PATHINFO_EXTENSION)
                                                            == 'doc' || pathinfo($kyc->omang,
                                                            PATHINFO_EXTENSION) == 'docm')
                                                            <img src="{{asset('images/word.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->omang, PATHINFO_EXTENSION) ==
                                                            'xls' || pathinfo($kyc->omang, PATHINFO_EXTENSION)
                                                            == 'xlsx' || pathinfo($kyc->omang,
                                                            PATHINFO_EXTENSION) == 'csv')
                                                            <img src="{{asset('images/excel.png')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->omang, PATHINFO_EXTENSION) ==
                                                            'jpeg' || pathinfo($kyc->omang, PATHINFO_EXTENSION)
                                                            == 'jpg' || pathinfo($kyc->omang,
                                                            PATHINFO_EXTENSION) == 'png')
                                                        ...
                                                        {{-- <div class="kt-avatar__holder"
                                                                                style="background-image:url({!! Storage::disk('s3')->url($kyc->omang) !!})">
                                                                            </div>--}}
                                                        @endif
                                                        @if($kyc == null || ($kyc != null && $kyc->compliance != 1))
                                                        <label class="kt-avatar__upload" data-toggle="kt-tooltip"
                                                            title="Change Image">
                                                            <i class="fa fa-pen"></i>
                                                            <input type='file' class="omang_pic" name="omang_pic"
                                                                <?php echo config('app.accept_attr'); ?>
                                                                <?php echo config('app.accept_msg'); ?> />
                                                        </label>
                                                        @endif
                                                ...
                                                <div class="col-md-2">
                                                    <h3 class="col-form-label" style="float: left;">Omang ID Back
                                                    </h3>
                                                    <div class="kt-avatar" id="omang_pic"
                                                        style="float: left; clear: left;">
                                                        ...
                                                        <a href="{!! \AlphaDirect\Helper::getCloudFrontURL($kyc->omangBack) !!}"
                                                            target="_blank" download>
                                                            @if(pathinfo($kyc->omangBack, PATHINFO_EXTENSION) ==
                                                            'pdf')
                                                            <img src="{{asset('images/pdf.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->omangBack, PATHINFO_EXTENSION) ==
                                                            'docx' || pathinfo($kyc->omangBack, PATHINFO_EXTENSION)
                                                            == 'doc' || pathinfo($kyc->omangBack,
                                                            PATHINFO_EXTENSION) == 'docm')
                                                            <img src="{{asset('images/word.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->omangBack, PATHINFO_EXTENSION) ==
                                                            'xls' || pathinfo($kyc->omangBack, PATHINFO_EXTENSION)
                                                            == 'xlsx' || pathinfo($kyc->omangBack,
                                                            PATHINFO_EXTENSION) == 'csv')
                                                            <img src="{{asset('images/excel.png')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->omangBack, PATHINFO_EXTENSION) ==
                                                            'jpeg' || pathinfo($kyc->omangBack, PATHINFO_EXTENSION)
                                                            == 'jpg' || pathinfo($kyc->omangBack,
                                                            PATHINFO_EXTENSION) == 'png')
                                                            <img src="{{ \AlphaDirect\Helper::getCloudFrontURL($kyc->omangBack) }}"
                                                                width="100%" height="auto">
                                                            @else
                                                            <img src="{{asset('images/doc.png')}}" width="100%"
                                                                height="auto">
                                                        ...
                                                        {{-- <div class="kt-avatar__holder"
                                                                                style="background-image:url({!! Storage::disk('s3')->url($kyc->omangBack) !!})">
                                                                            </div>--}}
                                                        @endif
                                                        @if($kyc == null || ($kyc != null && $kyc->compliance != 1))
                                                        <label class="kt-avatar__upload" data-toggle="kt-tooltip"
                                                            title="Change Image">
                                                            <i class="fa fa-pen"></i>
                                                            <input type='file' class="omangBack" name="omangBack"
                                                                <?php echo config('app.accept_attr'); ?>
                                                                <?php echo config('app.accept_msg'); ?> />
                                                        </label>
                                                        @endif
                                                ...
                                                <div class="col-md-2">
                                                    <h3 class="col-form-label" style="float: left;">Proof of
                                                        Residence</h3>
                                                    <div class="kt-avatar" id="proof_residence"
                                                        style="float: left; clear: left;">
                                                        ...
                                                        <a href="{!! \AlphaDirect\Helper::getCloudFrontURL($kyc->proof_residence) !!}"
                                                            target="_blank" download>
                                                            @if(pathinfo($kyc->proof_residence,
                                                            PATHINFO_EXTENSION) == 'pdf')
                                                            <img src="{{asset('images/pdf.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->proof_residence,
                                                            PATHINFO_EXTENSION) == 'docx' ||
                                                            pathinfo($kyc->proof_residence, PATHINFO_EXTENSION)
                                                            == 'doc' || pathinfo($kyc->proof_residence,
                                                            PATHINFO_EXTENSION) == 'docm')
                                                            <img src="{{asset('images/word.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->proof_residence,
                                                            PATHINFO_EXTENSION) == 'xls' ||
                                                            pathinfo($kyc->proof_residence, PATHINFO_EXTENSION)
                                                            == 'xlsx' || pathinfo($kyc->proof_residence,
                                                            PATHINFO_EXTENSION) == 'csv')
                                                            <img src="{{asset('images/excel.png')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->proof_residence,
                                                            PATHINFO_EXTENSION) == 'jpeg' ||
                                                            pathinfo($kyc->proof_residence, PATHINFO_EXTENSION)
                                                            == 'jpg' || pathinfo($kyc->proof_residence,
                                                            PATHINFO_EXTENSION) == 'png')
                                                        ...
                                                        {{-- <div class="kt-avatar__holder"
                                                                                style="background-image:url({!! Storage::disk('s3')->url($kyc->proof_residence) !!})">
                                                                            </div>--}}
                                                        @endif
                                                        @if($kyc == null || ($kyc != null && $kyc->compliance != 1))
                                                        <label class="kt-avatar__upload" data-toggle="kt-tooltip"
                                                            title="Change Image">
                                                            <i class="fa fa-pen"></i>
                                                            <input type='file' class="proof_residence"
                                                ...
                                                <div class="col-md-2">
                                                    <h3 class="col-form-label" style="float: left;">Proof Of
                                                        Income</h3>
                                                    <div class="kt-avatar" id="proof_income"
                                                        style="float: left; clear: left;">
                                                        ...
                                                        <a href="{!! \AlphaDirect\Helper::getCloudFrontURL($kyc->proof_income) !!}"
                                                            target="_blank" download>
                                                            @if(pathinfo($kyc->proof_income, PATHINFO_EXTENSION)
                                                            == 'pdf')
                                                            <img src="{{asset('images/pdf.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->proof_income,
                                                            PATHINFO_EXTENSION) == 'docx' ||
                                                            pathinfo($kyc->proof_income, PATHINFO_EXTENSION) ==
                                                            'doc' || pathinfo($kyc->proof_income,
                                                            PATHINFO_EXTENSION) == 'docm')
                                                            <img src="{{asset('images/word.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->proof_income,
                                                            PATHINFO_EXTENSION) == 'xls' ||
                                                            pathinfo($kyc->proof_income, PATHINFO_EXTENSION) ==
                                                            'xlsx' || pathinfo($kyc->proof_income,
                                                            PATHINFO_EXTENSION) == 'csv')
                                                            <img src="{{asset('images/excel.png')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->proof_income,
                                                        ...
                                                        {{-- <div class="kt-avatar__holder"
                                                                                style="background-image:url({!! Storage::disk('s3')->url($kyc->proof_income) !!})">
                                                                            </div>--}}
                                                        @endif
                                                        @if($kyc == null || ($kyc != null && $kyc->compliance != 1))
                                                        <label class="kt-avatar__upload" data-toggle="kt-tooltip"
                                                            title="Change Image">
                                                            <i class="fa fa-pen"></i>
                                                            <input type='file' class="proof_income" name="proof_income"
                                                                <?php echo config('app.accept_attr'); ?>
                                                                <?php echo config('app.accept_msg'); ?> />
                                                        </label>
                                                        @endif
                                                ...
                                                <div class="col-md-2">
                                                    <h3 class="col-form-label" style="float: left;">Passport
                                                    </h3>
                                                    <div class="kt-avatar" id="passport_pic"
                                                        style="float: left; clear: left;">
                                                        ...
                                                        {{-- @if (str_contains($kyc->passport, 'media.getmati.com'))
                                                                                <a href="{!! $kyc->passport !!}"
                                                                                    target="_blank" download>
                                                                                        <img src="{{ $kyc->passport }}"
                                                        width="100%" height="auto">
                                                        </a>
                                                        @else --}}
                                                        <a href="{!! \AlphaDirect\Helper::getCloudFrontURL($kyc->passport) !!}"
                                                            target="_blank" download>
                                                            @if(pathinfo($kyc->passport, PATHINFO_EXTENSION) ==
                                                            'pdf')
                                                            <img src="{{asset('images/pdf.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->passport, PATHINFO_EXTENSION)
                                                            == 'docx' || pathinfo($kyc->passport,
                                                            PATHINFO_EXTENSION) == 'doc' ||
                                                            pathinfo($kyc->passport, PATHINFO_EXTENSION) ==
                                                            'docm')
                                                            <img src="{{asset('images/word.ico')}}" width="100%"
                                                                height="auto">
                                                            @elseif(pathinfo($kyc->passport, PATHINFO_EXTENSION)
                                                            == 'xls' || pathinfo($kyc->passport,
                                                        ...
                                                        {{-- <div class="kt-avatar__holder"
                                                                                style="background-image:url({!! Storage::disk('s3')->url($kyc->passport) !!})">
                                                                            </div>--}}
                                                        @endif
                                                        @if($kyc == null || ($kyc != null && $kyc->compliance != 1))
                                                        <label class="kt-avatar__upload" data-toggle="kt-tooltip"
                                                            title="Change Image">
                                                            <i class="fa fa-pen"></i>
                                                            <input type='file' class="passport_pic" name="passport_pic"
                                                                <?php echo config('app.accept_attr'); ?>
                                                                <?php echo config('app.accept_msg'); ?> />
                                                        </label>
                                                        @endif
                                            ...
                                            @if($kyc == null || ($kyc != null && $kyc->compliance != 1))
                                            <button type="submit" class="btn btn-primary">Upload Customer KYC
                                                Images</button>
                                            @endif
                                        </form>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="kt-avatar" style="float: left; clear: left;">
                                                            ...
                                                            @else
                                                            <div class="kt-avatar__holder"
                                                                style="background-image:url({{ \AlphaDirect\Helper::getCloudFrontURL($pok->cell_phone_back) }}) !important;">
                                                            </div>
                                                            @endif
                                                            <label class="kt-avatar__upload" data-toggle="kt-tooltip"
                                                                title="Back">
            ...
            <div class="tab-pane" id="kt_portlet_base_demo_3_2_transactions_content" role="tabpanel">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        ...
                        <a class="btn btn-primary" style="margin-left: 840px" href="{{ route('admin.documents.accountStatement',$policy->id) }}">Account Statement</a>
                    </div>
                </div>
