        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{ route('admin.policy.index') }}" class="kt-subheader__breadcrumbs-link"> Quote </a> <span class="kt-subheader__breadcrumbs-separator"></span>
                        ...
                        <div class="row">
                            ...
                            @if($user->profile->omang != null)
                                <div class="form-group">
                                    ...
                                    <input id="omang" type="text" class="form-control id-type validateGroup1" name="omang" pattern="[0-9]{9}" maxlength="9"  value="{{$user->profile->omang}}" >
                                    <p class="existingOmangError" style="color:#e61c30;display:none;" >Customer with this Omang ID already exist</p>
                                </div>
                            @else
                                <div class="form-group">
                                    <label>Passport Number</label>
                                    <input id="passport" type="text" class="form-control id-type validateGroup1" name="passport" placeholder="Please enter passport number" maxlength="12" value="{{$user->profile->passport}}" >
                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="kt-radio-inline">
                                        <label class="kt-radio">
                                            <input type="radio" name="gender" class="input-group gender" id="male" value="1" @if($user->profile->gender == 1) checked @endif
                                            class="premiumField">
                                            Male <span></span>
                                        </label>
                                        <label class="kt-radio">
                                            <input type="radio" name="gender" class="input-group gender" id="female" value="0" @if($user->profile->gender == 0) checked @endif class="premiumField">
                                            Female<span></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control email" name="email" placeholder="Please enter customer email address" value="{{ $user->email}}">
                                </div>
                                <div class="form-group">
                                    <label>Physical Address</label>
                                    <input type="text" class="form-control address" name="address" placeholder="Please enter customers physical address" value="{{ $user->profile->address }}"  maxlength="60" required>
                                </div>
                                <div class="form-group">
                                    <label>Date Of Birth</label>
                                    <input type="text" class="form-control kt_datepicker_1 dob" name="dob" id="dob" autocomplete="off" value="{{$user->profile->dob}}"  placeholder="Select date"/>
                                </div>
                            </div>
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <div class="row">
                                    <div class="col-12">
                                        @can('quote-edit')
                                        <button type="submit" value="Submit" class="btn btn-brand" data-toggle="tooltip" data-placement="top" title="Create Policy">Update</button>
                                        @endcan
