...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // for prod tier; graphite-test-write for staging cron).
        // V2-owned tables: anomaly_findings, public_otps, v2_pdf_jobs,
        // api_error_log, policy_lifecycle (V2-side), audits, etc.
        // ============================================================
        'mysql_system' => [
            'driver'    => 'mysql',
            // Read/write split — mirrors backend/config/database.php.
            // SELECT routes to DB_HOST_READONLY / DB_HOST_RO (load-balanced
            // across whichever values the cron task def sets — typically
            // one replica pinned for cron-only bulk reads); writes +
            // transactions + post-write sticky reads route to DB_HOST_SYSTEM
            // (V2 master). When the read vars are unset, the read array
            // gracefully falls back to master — today's behaviour, no
            // breakage on rollout.
            'read' => [
