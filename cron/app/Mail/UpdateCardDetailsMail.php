...
class UpdateCardDetailsMail extends Mailable
{
    ...
    {
        $mail_subject = "Alphadirect | Update card details";
        ...
        $mail = $this->from('insurance@alphadirect.co.bw', 'Alpha Direct')
            ...
            ->markdown('Mail.updateCardDetailsView', compact('mail_data', 'customer_id','link'));
