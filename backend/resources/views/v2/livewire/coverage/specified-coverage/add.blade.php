            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        {{-- <div class="col-sm-3">
                            <div class="form-floating mb-3">
                                <x-form-input type="text" name="specidied_coverages.added_by"  placeholder="Added By" wire:model.defer='specidied_coverages.added_by'/>
                                <x-form-label for="specidied_coverages.added_by" required value="{{ __('Added By') }}"/>
                                <x-form-input-error name="specidied_coverages.added_by"/>
                            </div>
                        </div> --}}
                    </div>
                </div>
