            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-floating mb-3">
                                <x-check-box label="{{ __('Vehicle') }}" id="" wire:model.defer="coverage.has_vehicle"/>
                                <x-form-input-error name="coverage.has_vehicle"/>
                            </div>
                        </div>
                        {{-- <div class="col-sm-3">
                            <div class="form-floating mb-3">
                                <x-check-box label="{{ __('Risk Address') }}" id="" wire:model.defer="coverage.has_risk_address"/>
                                <x-form-input-error name="coverage.has_risk_address"/>
                            </div>
                        </div> --}}
                    </div>
