		...
		<div class="card">
			<div class="card-header">
				<div class="card-title m-0">
					<h3 class="fw-bold m-0">Add Sub Coverages</h3>
				</div>
				<div class="card-title m-0">
				  <a href="{{route('subcoverage')}}" target="_blank" class="btn btn-primary">View List</a>
				</div>
			</div>
			<!--begin::Card body-->
			<div class="card-body"
			...
			>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-floating mb-3">
							<x-form-input type="text" name="s_CoverageName.0" placeholder="Coverage Name" wire:model.defer='s_CoverageName.0'/>
							<x-form-label for="s_CoverageName.0" required value="{{ __('Coverage Name') }}"/>
                ...
                <div class="row">
				   <div class="col-sm-6">
						<div class="form-floating mb-6">
							<x-form-input type="text"  placeholder="Description" wire:model.defer='s_CoverageDesc.0'/>
				    ...
				    <div class="col-sm-6">
						<div class="form-floating mb-3">
							<x-select
								...
								wire:model.defer='s_CoverageGroupName.0' />
							<x-form-label for="s_CoverageGroupName.0" required value="{{ __('Select Coverage Group Name') }}"/>
							<x-form-input-error name="s_CoverageGroupName.0"/>
						</div>
					</div>
				    <div class="col-sm-6">
						<div class="form-floating mb-3">
				...
				<div class="row">
				    <div class="col-sm-6">
						<div class="form-floating mb-3">
							<x-select wire:model.defer="s_SubCoverageMainName.0" aria-label="Type"
							:options="array('Main'=>'Main','Heading'=>'Heading')"/>
							<x-form-label for="s_SubCoverageMainName.0" required value="{{ __('Select Title') }}" />
							<x-form-input-error name="s_SubCoverageMainName.0"/>
						</div>
					</div>
			    </div>
