                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                    <div class="form-floating mb-3">
                                        ...
                                        <x-form-label for="seleced_rules.{{ $id }}" required value="{{ __('Select Rule') }}"/>
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    {{-- <x-select id="seleced_rules_{{ $id }}" wire:model.defer="seleced_rules.{{ $id }}"
                                     aria-label="Type"
                                    :options="$this->ValidationRules"
                                    />
                                    <x-form-label for="seleced_rules_{{ $id }}" required value="{{ __('Select Rule') }}"/>
                                    <x-form-input-error name="seleced_rules.{{ $id }}"/> --}}
                                </div>
                            </div>
                        </div>
