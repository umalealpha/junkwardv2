<div>
    <div class="card card-flush overflow-hidden h-xl-100" x-data="{ totalPolicyCount: @entangle('totalPolicyCount') }">
        <!--begin::Header-->
        <!-- <div class="card-header pt-7"> -->
            <!--begin::Title-->
            <!-- <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold text-gray-800">Loss ratio percentages</span>
        ...
        <div class="card-body pt-5">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Policies</a>
                        <!--end::Title-->
                    </div>
                    <!--end::Content-->
                    <!--begin::Wrapper-->
            ...
            <div class="">
                ...
                @foreach($this->products as $name => $sums)
                <!--begin::Item-->
                <div class="d-flex flex-stack">
                    <!--begin::Section-->
                    <div class="d-flex align-items-center me-5">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-dark fs-6">{{ucfirst($name)}}</a>
                            <!--end::Title-->
                            <!--begin::Desc-->
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin::Number-->
                        <span class="text-gray-800 fw-bold fs-4 me-3">{{ round($sums[0],1) }}</span>
                        <span class="text-gray-800 fw-bold fs-4 me-3">({{ round($sums[1],1) }})</span>
                        <!--end::Number-->
                        <!--begin::Info-->
                        <div class="m-0">
                            <!--begin::Label-->
                            ...
                            {{round($this->getPercentage($sums[0],$sums[1]),1)}}%</span>
                            @elseif(($sums[0])<($sums[1]))
