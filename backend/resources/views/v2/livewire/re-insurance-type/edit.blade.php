<div>
    <x-slot name="breadcrum">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Reinsurance Type</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="{{ $colSize }}">
                            <div class="form-floating mb-3">
                                <x-check-box label="{{ __('Status') }}" id="" wire:model.defer="reinsurancetype.status"/>
