                        ...
                        <div class="kt-portlet">
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="form-floating mb-3">
                                                <x-form-input type="text" name="reinsurance_formula.formula_code" placeholder="Formula Code" wire:model.defer='reinsurance_formula.formula_code'/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-4">
                                            <div class="form-floating mb-3">
                                                ...
                                                <x-form-input-error name="reinsurance_formula_details.group_id"/>
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-floating mb-3">
                                                <x-select-search id="vehicle_type" wire:model.lazy="reinsurance_formula_details.vehicle_type" aria-label="Please choose Motor Type"
                                                    :options="$this->allMotorType ?? []"  listner="vehicle_type"  disabled="{{ !$this->editable }}" />
                                                <x-form-label for="vehicle_type" required value="{{ __('Please choose the motor type') }}"  />
                                                <x-form-input-error name="reinsurance_formula_details.vehicle_type"/>
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-floating mb-3">
                                        ...
                                        <div class="col-2">
                                            <div class="form-floating mb-3">
                                                <x-form-date type="text" class="kt_datepicker_1" id="reinsurance_formula_details_date_from" name="reinsurance_formula_details_date_from" placeholder="From" wire:model.defer='date_from'/>
                                        ...
                                        <div class="col-2">
                                            <div class="form-floating mb-3">
                                                <x-form-date type="text" class="kt_datepicker_1" id="reinsurance_formula_details_date_to" name="reinsurance_formula_details_date_to" placeholder="To" wire:model.defer='date_to'/>
