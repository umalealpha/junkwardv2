...
<div style="margin-bottom: 0px;max-width: 900px; margin: auto; position: relative;">
    <div style="position: absolute; top:0;left:0;">
        <img src="https://d20dgglp0tqnyi.cloudfront.net/Document/Policy_Document/new-top-corner/top-corner.png" alt="" style="z-index: -1;">
    </div>
    <div class="container clearfix" style="position: relative; padding: 40px 0px;">
        <div class="inner-container clearfix" style="z-index: 11; max-width:650px;margin: auto; ">
            ...
            @if(isset($policy->billing) && $policy->billing == "RealPay")
            ...
            <table class="table-responsive" style="border-collapse: collapse;width:100%">
                ...
                <tr>
                    <td>
                        <h4 style="margin:0px; font-weight: 600;">Terminated {{ $product }} Policy:</h4>
                        <p style="margin-top: 0px;text-transform: uppercase">{{ $policy->policyNumber }}@if(isset($policy->estimated_value) && $policy->estimated_value > 0) - <span style="font-weight: 600;">P{{ $policy->estimated_value }}</span>@endif</p>
                        @if(isset($cancelEffectiveFrom))
                            <p style="margin-top: 0px;">Cancellation effective from : <span style="font-weight: 600;">{{ $cancelEffectiveFrom }}</span></p>
                        @endif
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>The above policy no longer has insurance cover with us. </p>
