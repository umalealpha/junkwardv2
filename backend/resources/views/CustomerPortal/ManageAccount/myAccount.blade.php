                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                        ...
                                        <form id="kt_form" name="ClaimForm" class="kt-form" action="{{Route('agent-savePolicy')}}" method="POST" accept="image/jpeg , image/bmp , image/png" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                            <!--begin: Form Wizard Step 1-->
                                            <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current" style="width:80%">
                                               <h3 class="kt-section__title" >Edit Form</h3>
                                                <div class="kt-heading kt-heading--md">My Details</div>
                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                  <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="lname" title="Customers Last Name" placeholder="Last Name" required> 
                                                       </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="cellphone" title="Customers Phone Number" placeholder="Cellphone Number" required> 
                                                       </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="address" title="Customers Address" placeholder="Address" required> 
                                                          </div>
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label>Omang ID/Passport Number</label>
                                                            <input type="text" class="form-control" name="id" placeholder="Omang ID" title="Customers Omang ID or Passport Number" required> 
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input  type="date" class="form-control" id="dob" name="dob" title="Customers age, must be 18 years or older" placeholder="DD/MM/YYYY"
                                                  ...
                                                  <div class="kt-heading kt-heading--md">My Bank Details</div>
                                                  <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
					                            	...
					                            	<input id="billingCell" type="text" class="form-control" name="billingCell" aria-describedby="emailHelp" placeholder="Myzaka/Orange Cell" disabled>
															</div>
                                                  ...
                                                  <div class="row">
                                                     ...
                                                     <br>
                                                      <div class="row">
                                                    <div class="col-lg-12">
													 <button id="submitForm" type="submit" class="btn btn-success btn-lg btn-block" onclick="document.getElementById('kt_form').submit();">Submit Changes</button>
                                                     </form>
