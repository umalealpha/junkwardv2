...
<!-- 
                                                ...
                                                <button class="btn btn-secondary mr-4" type="button" id="kt_datatable_uncheck_all">Unselect all rows</button> -->
                                                    ...
                                                    <!-- <input   id="checking" class="kt-checkbox kt-checkbox--single kt-checkbox--solid" type="checkbox"> -->
                                                        <!-- <button type="button" id="payNow" data-target=".bd-example-modal-lg" data-toggle="modal" class="btn btn-outline-success active" title="Pay Installments Now">Pay Now</button> -->
...
var datatable = $('#clientinstallmentDt').KTDatatable({
  ...
  data: {
    ...
    source: {
      read: {
        method:'GET',
        url: '{{ \Config::get('values.graphite_url') }}/realpay/getInstallments?contractNumber='+$.urlParam("id"),
        map: function(raw) {
  ...
  columns: [
...

    {
      ...
      template: function(row, index, datatable) {
        ...
        return ' <input  class="kt-checkbox kt-checkbox--single kt-checkbox--solid" type="checkbox" disabled="disabled">';
...

    {
      ...
      template: function(row, index, datatable) {
        ...
        if(row['ns0:status'] == 'A'){
         ...
         return  '<form method="POST" action="{{ \Config::get('values.graphite_url') }}/realpay/editInstallment">\
                                ...
                                <button  type="submit" class="btn btn-outline-primary active">Pay\
              </form>'
            }
...
//         $.ajax({
//             type: "POST",
//             url: "{{ \Config::get('values.graphite_url') }}/realpay/editInstallment/m",
//             data: {"refs": arr, "action": "A"},
//             success: ()=>{
