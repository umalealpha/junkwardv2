                                                                             ...
                                                                             <div class="col">
                                                                                 <div class="dropdown">
                                                                                     ...
                                                                                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="right" data-skin="dark" data-container="body" data-original-title="Tooltip title">Claim ID</a>
                                                                                         <a class="dropdown-item" href="#">Policy ID</a>
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Tooltip title">Vehicle Registration Number</a>
                                                                                     </div>
                                                                                 </div>
                                                                             </div>
                                                                         </div>
                                                    ...
                                                    <div class="kt-form__group kt-form__group--inline kt-margin-r-10">
                                                        ...
                                                        <div class="kt-form__control" style="width: 160px;">
                                                            <select class="form-control bootstrap-select" id="kt_form_status" title="Status">
                                                                ...
                                                                <option value="3">Motor Reg. No</option>
...
var datatable = $('#policies').KTDatatable({
  ...
  columns: [
    ...
    },
    {
      ...
      title: 'Claim Number',
      template: function(row, index, datatable) {
        return '2019-Glass-'+row.policyNumber;
      },
    },
    {
      field: 'vehiclePlate',
      title: 'Motor Reg. No',
      template: function(row, index, datatable) {
        return row.vehiclePlate.toUpperCase();
...

    {
      ...
      return '<a href="processClaim/'+row.id+'" type="button" class="btn btn-hover-brand btn-icon btn-pill" title="Process Claim"><i class="la la-folder-open-o"></i></button>';
      },
    }],
});
