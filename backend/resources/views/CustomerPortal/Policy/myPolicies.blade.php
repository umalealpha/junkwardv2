                                           ...
                                           <div class="col-lg-12 newsearch1"> 
                                             <form class="navbar-form navbar-search" role="search">
                                                                     ...
                                                                     <button type="button" class="btn btn-outline-hover-secondary" disabled="disabled"><i class="fa fa-search"></i></button>
                                                                         <input type="text" class="form-control" placeholder="Search For Your Policies" name="query" id="query">
                                                                             ...
                                                                             <div class="col">
                                                                                 <!-- <div class="dropdown">
                                                                                     ...
                                                                                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="right" data-skin="dark" data-container="body" data-original-title="Tooltip title">Action</a>
                                                                                         <a class="dropdown-item" href="#">Another action</a>
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Tooltip title">Something else here</a>
                                                                                     </div>
                                                                                 </div> -->
                                                                             </div>
                                                                         </div>
  ...
  columns: [
    {
      ...
      template: function(row, index, datatable) {
        return '<a href="policyDetail/'+row.id+'">'+row.policyNumber+'</a>';
      },
    },
    {
      field: 'customerName',
...

    {
      ...
      return '<div class="dropdown ' + dropup + '">\
                        ...
                        <div class="dropdown-menu dropdown-menu-right">\
                            <a class="dropdown-item" href="viewPolicy/'+row.id+'"><i class="la la-folder-open"></i>View Policy Details</a>\
                    ...
                    <button type="button" class="btn btn-hover-brand btn-icon btn-pill showViewModal" onClick="viewData(this)" data-toggle="modal" data-id="'+row.id+'" data-data='+JSON.stringify(row)+' data-target="#viewModal" title="View Policies"><i class="la la-eye"></i></button>\
                    <a href="agent-edit/'+row.id+'" class="btn btn-hover-brand btn-icon btn-pill showEditModal" title="Edit"><i class="la la-edit"></i></button>\
                    ';
      },
    }],
});
