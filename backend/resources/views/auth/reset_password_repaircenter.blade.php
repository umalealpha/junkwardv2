...
<head>
    <meta charset="utf-8"/>
    <title>AlphaDirect | Reset Password For Repaircenter</title>
            ...
            <div class="kt-login-v2__body">
                ...
                <div class="kt-login-v2__wrapper">
                    <div class="kt-login-v2__container">
                        ...
                        <!--begin::Form-->
                        <form class="kt-login-v2__form kt-form" id="reset" method="post" action="{{ url('/api/frontendpay/updatePassword_repaircenter') }}">
