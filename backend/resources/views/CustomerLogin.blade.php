...
<html lang="{{ app()->getLocale() }}">
  ...
  <div class="login card p-4" style="margin-top:30px">
     ...
     <form action="{{Route('authenticateCustomer')}}" method="POST">
      {{ csrf_field() }}
      <img src="{{asset('Logo.png')}}" class="rounded mx-auto d-block" alt="...">
          <div class="md-form">
             <i class="fas fa-user prefix"></i>
             <input type="text" id="inputValidationEx1" name="email" class="form-control validate">
          <label for="inputValidationEx1">Email OR Cellphone</label>
          </div>
          <div class="md-form">
            <i class="fas fa-lock prefix"></i>
            <input type="password" id="inputValidationEx2" name="password" autocomplete="off" class="form-control validate">
