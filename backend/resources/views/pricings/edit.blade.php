    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Edit Pricing</h3>
                ...
                <form action="{{ route('pricings.update', $pricing->id) }}" method="POST">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <select name="gender" class="form-control" required>
                                    <option value="Male" {{ $pricing->gender == 'Male' ? 'selected' : '' }}>Male</option>
                                    <option value="Female" {{ $pricing->gender == 'Female' ? 'selected' : '' }}>Female</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" name="age_from" value="{{ $pricing->age_from }}" class="form-control" required>
                            </div>
                        </div>
                        {{-- Age To --}}
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" name="age_to" value="{{ $pricing->age_to }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" name="age" value="{{ $pricing->age }}" class="form-control" required>
                            </div>
                        </div> --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" name="product" value="{{ old('product', $pricing->product) }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" step="0.01" name="premium" value="{{ $pricing->premium }}" class="form-control" required>
                            </div>
                        </div> --}}
                        {{-- Premium --}}
                        <div class="form-group row">
                        ...
                        {{-- <div class="form-group row">
                            <label class="col-3 col-form-label">Main</label>
                            <div class="col-8">
                                <input type="number" step="0.01" id="main" name="main" value="{{ $pricing->main }}" class="form-control" required>
                            </div>
                        </div> --}}
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" step="0.01" id="total_premium" name="total_premium"
                                    value="{{ $pricing->premium + $pricing->adult_dependent + $pricing->child_dependent }}"
...
<script>
    ...
    // Run on page load (so edit form shows correct total immediately)
