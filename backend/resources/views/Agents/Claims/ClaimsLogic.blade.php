                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                        ...
                                        <form id="glassClaim1" action="{{Route('ClaimForm')}}" class="kt-form" id="kt_form" method="POST">
                                        {{csrf_field()}}
                                               ...
                                               <h3 class="kt-section__title">Glass Claim Form</h3>
                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <select class="custom-select form-control" name="glassType" >
                                                        <option value="Front Windscreen">Front Windscreen</option>
                                                    ...
                                                    <select class="custom-select form-control" name="glassType" disabled>
                                                        <option value="{{$glass_claims->glassType}}">{{$glass_claims->glassType}}</option>
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="kt-radio-inline">
                                                     @if($vehicleDetails->purpose == null)
                                                        ...
                                                        <label class="kt-radio">
                                                         ...
                                                         <label class="kt-radio">
                                                            <input type="radio" name="purpose" value="Private" >
                                                            Private <span></span> 
                                                        </label>
                                                        @elseif($vehicleDetails->purpose == 'Business')
                                                           <label class="kt-radio">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-lg-6">
														...
														<input readonly class="form-control" type="date" name ="incidentDate" value="{{$glass_claims->incidentDate}}" id="example-date-input" >
                                                		@else
														<input class="form-control" type="date" name="incidentDate" id="example-date-input" >
                                                        @endif
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                    <div class="form-group">
															...
															<div class="kt-radio-inline">
                                                                ...
                                                                @elseif($glass_claims->damageExtent == 'Cracked')
                                                                    <input type="radio" name="damageExtent" value="{{$glass_claims->damageExtent}}" checked disabled>
																	Cracked <span></span> 
																</label>
                                                                	<label class="kt-radio">
                                                  ...
                                                  <div class="row">
                                                    	<div class="col-lg-6">
                                                            ...
                                                            <input readonly type="text" class="form-control" name="causeOfDamage" value="{{$glass_claims->causeOfDamage}}" placeholder="Cause of Damage" > 
															
                                                            @else
                                                            <input type="text" class="form-control" name="causeOfDamage"> 
                                                    	...
                                                    	<div class="col-lg-6">
															...
															<div class="kt-radio-inline">
																...
																<label class="kt-radio">
                                                                @if($glass_claims->thirdPartyInsurance == 0)
																	<input type="radio" name="thirdPartyInsurance" value="{{$glass_claims->thirdPartyInsurance}}"  disabled>
																	Yes <span></span> 
																</label>
                                                                	<label class="kt-radio">
																	<input type="radio" name="thirdPartyInsurance" checked disabled>
																	No <span></span> 
																</label>
                                                                @else
                                                                    <input type="radio" name="thirdPartyInsurance" value="1" checked disabled>
																	Yes <span></span> 
																</label>
                                                                	<label class="kt-radio">
																	<input type="radio" name="thirdPartyInsurance"  disabled>
																	No <span></span> 
																</label>
                                                    	...
                                                    	<div class="col-lg-12">
															...
															<div class="kt-radio-inline">
																...
																<label class="kt-radio">
                                                                	...
                                                                	<label class="kt-radio">
																	<input type="radio" name="thirdParty" id="closeThird" checked>
																	No <span></span> 
																</label>
                                                  ...
                                                  <div class="row" id="thirdParty" style="display:none">
                                                    ...
                                                    <div class="col-lg-12">
														<div class="form-group">
														<label>Upload Third Party's Vehicle Registration</label>
														<div></div>
                                                  ...
                                                  <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        @if($glass_claims->glassAddress == null)
                                                         <select class="custom-select form-control" name="glassAddress" >
                                                            <option value="Front Windscreen">Front Windscreen</option>
                                                            <option value="Door Window">Door Window</option>
                                                            <option value="Back Window">Back Window</option>
                                                            <option value="Mirrors">Mirrors</option>
                                                        ...
                                                        @else
                                                        <select class="custom-select form-control" name="glassAddress" readonly>
                                                            <option value="{{$glass_claims->glassAddress}}">{{$glass_claims->glassAddress}}</option>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        @if($glass_claims->breakSize == null)
                                                        <select class="custom-select form-control" name="breakSize" >
                                                        ...
                                                        @else
                                                        <select class="custom-select form-control" name="breakSize" readonly>
                                                            <option value="{{$glass_claims->breakSize}}">{{$glass_claims->breakSize}}</option>
                                                   ...
                                                   <button class="btn btn-success btn-lg btn-block" onclick="document.getElementById('glassClaim1').submit();">Submit Claim</button>
                                                  <div class="kt-separator kt-separator--border-dashed kt-separator--space-lg"></div>
                                                  <div class="row">
					...
					<div class="kt-widget5__item">
						<div class="kt-widget5__content">
							<div class="kt-widget5__pic">
								<img class="kt-widget7__img" src="{{asset('/media/flags/PG-Flat-full-logo.png')}}" height="150px" alt="">
							</div>
                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-4">
                                                            <div class="form-group">
                                                                <label>CVV:</label>
                                                                <input type="password" class="form-control" name="billing_card_cvv" placeholder="" value="450" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
