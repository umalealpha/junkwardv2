        ...
        <div class="kt-grid kt-grid--hor kt-grid--root">
            <!-- begin:: Page -->
                        ...
                        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
							...
							<tr>
								<th>Name:</th>
								<td>{{$policies->firstName}} {{$policies->lastName}}</td>
							  </tr>
							  <tr>
								<th>Cellphone:</th>
...
<div class="dropdown">
  ...
  @if ($policies->policyPlan == null)



       @foreach ($policyPlan as $pp )
          <li><a>P{{$pp->cost}}/month – for P{{$pp->sumInsured}} of insurancec cover</a></li>
  
        @endforeach
        @else
                    <li><a>P{{$selectedPolicyPlan->cost}}/month – for P{{$selectedPolicyPlan->sumInsured}} of insurance cover</a></li>
        ...
        @endif
							  ...
							  <tr>
								<th>Sum Insured:</th>
								<td>P {{number_format($selectedPolicyPlan->sumInsured, 2)}}</td>
							  </tr>
							  <tr>
								<th>Premium</th>
								<td>
									<table class="preminum">
										<tr>
											<th>Name</th>
											<td>P {{number_format($selectedPolicyPlan->cost, 2)}}</td>
										</tr>
										<tr>
											<th>Vat(5%)</th>
											<td>P {{5/100 * $selectedPolicyPlan->cost }}</td>
										</tr>
										<tr class="total">
											<th>Total</th>
											<td>P {{5/100 * $selectedPolicyPlan->cost + $selectedPolicyPlan->cost}}</td>
										</tr>
									</table>
								</td>
							  </tr>
