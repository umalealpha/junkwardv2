...
{{--                                                <a href="{{Route('makePolicy')}}" class="btn btn-outline-brand" ><i class="flaticon2-add-circular-button"></i></a>--}}
                                            @endif   
                                            </div>
                                            </div>
                                        </div>
...
<script>
    ...
    "colors": {
       ...
       <script src="{{asset('css/app/custom/general/components/base/popovers.js')}}" type="text/javascript"></script>
...
<script>
  ...
  @endif
   ...
   @if(Session::has('notCompliant'))
    Toastify({
      text: "{{ Session::get('notCompliant') }}",
      duration: 4000,
      newWindow: true,
      gravity: "top", // `top` or `bottom`
      positionRight: true, // `true` or `false`
