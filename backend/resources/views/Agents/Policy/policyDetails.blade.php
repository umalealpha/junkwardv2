        ...
        <div class="row ol-lg-12">
            ...
            <div class="col-lg-3 text-center">
                ...
                <label>
                    ...
                    <h5>Compliance: <span style="color:#CC0000"> Not Compliant</span></h5>
                    @endif
                    <span></span>
                </label>
            </div>
                            ...
                            <div class="kt-portlet__body">
                                <div class="row">
                                    <table class="table table-hover table-striped">
                                        <tr>
                                            <th>Name:</th>
                                            <td><a href="{{Route('agent-viewCustomerDetails',['id'=>$userDetails->id ])}}"> {{$userDetails->firstName}} {{$userDetails->lastName}}</a></td>
                                        </tr>
                                        <tr>
                                            <th>Cellphone:</th>
            ...
            $("#activatePolicyButton").on("click", function() {
                ...
                $.ajax({
                                ...
                                data: {
                                     ...
                                     product:"FNBNDOBW",
                                     installmentAmount:"{{$selectedPolicyPlan->premium}}"
...
var datatable = $('#clientinstallmentDt').KTDatatable({
  ...
  data: {
    ...
    source: {
      read: {
        method:'GET',
        url: urlValue+'realpay/getInstallments?clientNumber='+"{{$policies->policyNumber}}",
        map: function(raw) {
            $('.loading').css("display","none");
