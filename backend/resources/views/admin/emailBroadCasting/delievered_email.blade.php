                ...
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="{{Route('admin.product.index')}}" class="kt-subheader__breadcrumbs-link"><span
                                class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Admin</span>
                        </a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $("#email_log_table").on("click", "a.confirm-delete", function (event) {
    ...
    $(document).ready(function () {
        ...
        var KTDatatablesDataSourceAjaxServer = function () {
            ...
            var initTable1 = function () {
                // begin first table
                table = $('#email_log_table').DataTable({
                    responsive: true,
                    processing: true,
                    language: {
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{!! route('admin.emailBroadCasting.delieveredEmails') !!}',
                        data: function (d) {
