                        ...
                        <div class="kt-section">
                            <div class="kt-section__content">
                                <table class="table table-striped m-table">
                                    ...
                                    <tr>
                                        <th>Name:</th>
                                        @if($emailBroadCast->name != NULL)
                                            <td>{!! $emailBroadCast->name !!}</td>
                                        @else
                                            <td>Unavailable</td>
                                        @endif
                                    ...
                                    <tr>
                                        <th>Hook:</th>
                                            ...
                                            @foreach($hooks as $hook)
                                                @if($emailBroadCast->hook_slug == $hook->slug)
                                                    <td>{!! $hook->name !!}</td>
                                                @endif
                                            @endforeach
                                    ...
                                    <tr>
                                        <th>Subject:</th>
                                        @if($emailBroadCast->subject != 1)
                                            <td>{!! $emailBroadCast->subject !!}</td>
                                        @else
                                            <td>Unavailable</td>
                                        @endif
                                    </tr>
                                    <tr>
                                        <th>Message:</th>
                                        @if($emailBroadCast->text != null)
                                            <td>{!! html_entity_decode($emailBroadCast->text) !!}</td>
                                        @else
                                            <td>Unavailable</td>
                                        @endif
                                    </tr>
                    ...
                    <div class="kt-portlet__foot kt-portlet__foot--solid">
                        <div class="kt-form__actions">
                            <div class="row">
                                <div class="col-3"></div>
                                <div class="col-9">
                                    <a class="btn btn-secondary" href="{{ route('admin.emailBroadCasting.index') }}" >Back</a>
                                </div>
