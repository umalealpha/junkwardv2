    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="productCreate" action="{{ route('admin.paymentVendor.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" title="Payment Vendor name is required" maxlength="25" name="vendorName" value="{!! old('vendorName') !!}" placeholder="Enter Payment Vendor name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" title="Payment Vendor name is required" maxlength="25" name="vendorLabel" value="{!! old('vendorLabel') !!}" placeholder="Enter Payment Vendor name">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="email" class="form-control" title="Payment Vendor email is required" name="vendorEmail" value="{!! old('vendorEmail') !!}" placeholder="Enter Payment Vendor email">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" title="Payment Vendor Telephone is required" maxlength="20" name="vendorTelephone" value="{!! old('vendorTelephone') !!}" placeholder="Enter Payment Vendor telephone">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="time" class="form-control" title="off time start"  name="offtimestart" value="{!! old('offtimestart') !!}" >
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="time" class="form-control" title="off time end" name="offtimeend" value="{!! old('offtimeend') !!}" >
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
