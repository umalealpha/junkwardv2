    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="typeForm" action="{{ route('admin.productType.update', $producttype->id) }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="name" value="{!! $producttype->name !!}" title="Product type is required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="sumassured" value="{!! $producttype->sum_assured_limit !!}" title="Sum assured is required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                    <span class="kt-switch" >
                                        <label>
                                            <input id="switchValue" type="checkbox" @if($producttype->status) checked="checked" @endif  name="status" {{--value="1"--}}  onchange="statusMsg()">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('admin.productType.index') }}" >Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
