    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="deptForm" action="{{ route('admin.sms.store') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <select  class="form-control kt_selectpicker" name="hook" id="user_label"
                                         data-live-search="true" title="Please Select hook ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input  class="form-control" name="sms_limit">
                    ...
                    <div class="kt-portlet__foot kt-portlet__foot--solid">
                        <div class="kt-form__actions">
                            <div class="row">
                                <div class="col-3"></div>
                                <div class="col-9">
                                    <button type="submit" style="margin-left: 190px;" value="Submit" id="btn" class="btn btn-brand">Submit</button>
