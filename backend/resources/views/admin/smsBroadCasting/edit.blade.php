    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{ URL::to('admin/sms') }}" class="kt-subheader__breadcrumbs-link">
                        SMS Template </a> <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="deptForm" action="{{ route('admin.sms.update',$sms->id) }}"
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input"  class="col-2 col-form-label">Enter Name</label>
                                <div class="col-10">
                                    <input  class="form-control" name="name"  value="{{$sms->name }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <select class="form-control kt_selectpicker"
                                        ...
                                        id="user_label"  name="main_type" title="Please Select template field">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <select  class="form-control kt_selectpicker" name="hook" title="Please Select hook"
                                         id="user_label" data-live-search="true">

                                    @foreach($hooks as $hook)
                                        <option value="{{ $hook->slug }}" @if($sms->hook_slug == $hook->slug) selected
                        ...
                        <div class="form-group row">
                            <label for="example-text-input"  class="col-2 col-form-label">Which Day:</label>
                            <div class="col-10">
                                <select  class="form-control kt_selectpicker" name="which_day" title="Please Select Day"
                                         id="which_day" data-live-search="true">

                                    @for($i=1; $i<=20 ; $i++)
                                        <option value="{{ $i }}" @if($sms->which_day == $i) selected
                                                @endif>{{ $i }}</option>
                                    @endfor
                        ...
                        <div class="form-group row">
                            <label for="example-text-input"  class="col-2 col-form-label">SMS Limit</label>
                            <div class="col-10">
                                <input  class="form-control" name="sms_limit" value="{{$sms->sms_limit}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <textarea class="form-control" id="summary-ckeditor"
                                          name="summary-ckeditor">{{html_entity_decode($sms->text)}}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <button type="submit" style="margin-left: 190px;" value="Submit" id="btn" class="btn btn-brand">Update</button>
                                    @endcan
                                    <button class="btn btn-brand" type="button" id="loadBtn" style="display:none" > <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading... </button>

                                    <a class="btn btn-secondary" href="{{ route('admin.sms.index') }}" >Cancel</a>
                                </div>
...
<script>
    ...
    CKEDITOR.replace( 'summary-ckeditor', {
        ...
        uploadUrl: "{!! route('admin.sms.ckeupload',['_token' => csrf_token()]) !!}",
