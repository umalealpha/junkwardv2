...
<style>
/* Custom CSS for AD Group KYC Link Details Page */
.timeline {
    position: relative;
    padding: 0;
    list-style: none;
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="flex-grow-1">
                            ...
                            <p class="text-muted mb-0">
                                Customer: <strong>{{ $link->customer ? $link->customer->firstName . ' ' . $link->customer->lastName : 'Unknown' }}</strong>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="info-item">
                                ...
                                <div class="info-value">
                                    <a href="{{ route('admin.ad-group-kyc.campaign.show', $link->campaign_id) }}" class="text-primary">
                                        {{ $link->campaign->name ?? 'AD Group KYC Campaign' }}
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="timeline">
                        ...
                        <div>
                            <div class="timeline-item">
                                ...
                                <div class="timeline-body">
                                    AD Group KYC link generated for customer
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="timeline-item">
                                <span class="time">
                                    <i class="fas fa-clock"></i> {{ $link->sent_at->format('M d, H:i') }}
                                </span>
                                <h3 class="timeline-header">Link Sent</h3>
                                <div class="timeline-body">
                                    Notification sent via {{ $link->delivery_method ?? 'email' }}
                        ...
                        <div>
                            <div class="timeline-item">
                                <span class="time">
                                    <i class="fas fa-clock"></i> {{ $link->opened_at->format('M d, H:i') }}
                                </span>
                                <h3 class="timeline-header">Link Opened</h3>
                                <div class="timeline-body">
                                    Customer accessed the AD Group KYC link
                        ...
                        <div>
                            <div class="timeline-item">
                                <span class="time">
                                    <i class="fas fa-clock"></i> {{ $link->otp_verified_at->format('M d, H:i') }}
                                </span>
                        ...
                        <div>
                            <div class="timeline-item">
                                <span class="time">
                                    <i class="fas fa-clock"></i> {{ $link->completed_at->format('M d, H:i') }}
                                </span>
                                <h3 class="timeline-header">Link Completed</h3>
                                <div class="timeline-body">
                                    Customer completed the AD Group KYC process
                                </div>
                            </div>
                        </div>
                        @endif
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge badge-info">EMAIL, SMS, WHATSAPP</span>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                            ...
                            @if($link->customer)
                                <table class="table table-borderless">
                                    <tr>
                                        ...
                                        <td>{{ $link->customer->firstName . ' ' . $link->customer->lastName }}</td>
                                    </tr>
                                    <tr>
...
function viewLinkDetails() {
    // This would open the actual AD Group KYC link in a new tab
    const linkUrl = '{{ url("/ad-group-kyc/verify") }}/' + '{{ $link->unique_token }}';
