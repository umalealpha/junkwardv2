    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}"
                        ...
                        href="{{route('admin.KycFields.index')}}" class="kt-subheader__breadcrumbs-link">KYC Fields </a>
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="storeForm" action="{{ route('admin.KycFields.store') }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                       title="name is required" placeholder="Enter name" value="{{old('name') }}">
                                @error('name')
