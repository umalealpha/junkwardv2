            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Re Insurance Claims Profile</span>
                    </div>
                </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="exportTable" style="display: none;">
                            ...
                            <tr>
                                ...
                                <th>Reserve Payment Amt</th>
                                <th>Coverag Name</th>
                                <th>Rserve / Payment Amt</th>
                                <th>Motor Desc</th>
                                <th>Motor Desc2</th>
{{--                                <th>Net Percent</th>--}}
{{--                                <th>Quota Percent</th>--}}
{{--                                <th>Surplus Percent</th>--}}
{{--                                <th>Fac Percent</th>--}}
{{--                                <th>Surplus Amt</th>--}}
{{--                                <th>Facultative Amt</th>--}}
                                <th>TermStartDate</th>
                                <th>TermEndDate</th>
                                <th>VATInclude</th>
                            </tr>
...
<script>
    ...
    var filterDateto =-1;
    var url = '{!! url('admin/report/reInsuranceClaimsprofileExport/:filter') !!}';
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table = $('#claim_report').DataTable({
                ...
                order : [1, 'DESC'],
                ajax: {
                    url: '{!! route('admin.report.reInsuranceClaimsProfile') !!}',
                    type: 'post',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
                ...
                columns: [
                    ...
                    {data: 'trans_sub_type'},
                    {data: 'reserve_payment_amt'},
                    {data: 'coverage_name'},
                    {data: 'motor_desc'},
                    {data: 'motor_desc2'},
                    // {data: 'net_percent'},
                    // {data: 'quota_percent'},
                    // {data: 'surplus_percent'},
                    // {data: 'fac_percent'},
                    // {data: 'surplus_amt'},
