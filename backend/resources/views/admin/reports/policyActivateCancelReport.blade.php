            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Policy Activate and Cancel Report
                    </h3>
                    <span class="kt-subheader__separator kt-hidden"></span>
                    <div class="kt-subheader__breadcrumbs">
                        <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="{{Route('admin.policy.index')}}" class="kt-subheader__breadcrumbs-link"><span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Activate and Cancel Report</span> </a>
                    </div>
                </div>
            </div>
            <!-- end:: Subheader -->
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__body">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <select name="policyStatus_filter" class="form-control" id="policyStatus_filter">
                                ...
                                <option style="text-transform: capitalize" value="1">Activation</option>
                                <option style="text-transform: capitalize" value="2">Cancellation</option>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable mt-2" id="exportTable">
                        <thead>
                        <tr>
                            <th>Excel Uploaded File Download</th>
                            <th>Excel Perform File Download</th>
                            <th>Perform</th>
                            <th>status</th>
                            <th>Activity By</th>
                            <th>Created At</th>
        ...
        var initTable2 = function() {
            table2 = $('#exportTable').DataTable({
              ...
              //  paginate:false, table length
                ...
                ajax: {
                    url: '{!! route("admin.policy.policyActivateCancelReportData") !!}',
                    data: function (d) {
                        d.policyStatus_filter = policyStatus_filter;
                ...
                order: [1, 'DESC'],
                columns: [
                    {data: 'excel_uploaded_file',name:'excel_uploaded_file'},
                    {data: 'excel_perform_file',name:'excel_perform_file'},
