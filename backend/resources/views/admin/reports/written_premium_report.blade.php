            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Written Premium Report</span>
                    </div>
                </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="claim_report">
                            ...
                            <tr>
                                ...
                                <th>Term End</th>
                                <th>Booking Date</th>
                                <th>Trans Eft. Start</th>
                                <th>Trans Eft. End</th>
                                <th>Written Premum </th>
...
<script>
    ...
    var filterDateto =-1;
    var url = '{!! url('admin/report/writtenPremiumReportExport/:filter') !!}';
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table = $('#claim_report').DataTable({
                ...
                order : [1, 'DESC'],
                ajax: {
                    url: '{!! route('admin.report.written_premium_report') !!}',
                    type: 'post',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
