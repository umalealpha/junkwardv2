            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Motor Comprehensive Report
                    </h3>
                    <span class="kt-subheader__separator kt-hidden"></span>
                    <div class="kt-subheader__breadcrumbs">
                        <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"><span class="kt-subheader__breadcrumbs-link">Report</span> </a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a class="kt-subheader__breadcrumbs-link"><span class="kt-subheader__breadcrumbs-link  kt-subheader__breadcrumbs-link--active">Motor Comprehensive Report</span> </a>
                    </div>
                </div>
...
<script>
    ...
    {{--            ],--}}
    {{--            ajax: {--}}
    {{--                url: '{!! route('admin.report.policyVehicleData') !!}',--}}
    {{--                data: function (d) {--}}
    ...
    var filterDateFrom = '-1';
    var filterDateto = '-1';
    var url = '{!! url('qoutes/motorCompExport/:filter') !!}';
    var KTDatatablesDataSourceAjaxServer2 = function() {
        ...
        var initTable2 = function() {
            table2 = $('#exportTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('admin.report.allPolicyVehicleData') !!}',
                    data: function (d) {
