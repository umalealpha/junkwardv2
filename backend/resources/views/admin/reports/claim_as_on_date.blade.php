            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Claim As On Date </span>
                    </div>
                </div>
            </div>
            <!-- end:: Subheader -->
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="claim_report">
                            ...
                            <tr>
                                ...
                                <th>Reported Date</th>
                                <th>MaxTrans</th>
                                <th>Claim_SubStatus_na</th>
                                <th>Total Reserve</th>
                                <th>Total Payment</th>
                                <th>Balance</th>
                                <th>Loss Rpt Attach Y/N</th>
                                <th>Salvage/SubrogationReserve</th>
                                <th>Salvage/SubrogationPayment</th>
                                <th>Claims Allocated To</th>
                            </tr>
                            </thead>
                        </table>
                        <!--end: Datatable -->
...
<script>
    ...
    var filterDateto =-1;
    var url = '{!! url('admin/report/claimAsOnDateDataExport/:filter') !!}';
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table = $('#claim_report').DataTable({
                ...
                order : [1, 'DESC'],
                ajax: {
                    url: '{!! route('admin.report.claim_as_on_date') !!}',
                    type: 'post',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
                ...
                columns: [
                   {data: 'claim_no'},
                    ...
                    {data: 'reported_date'},
                    {data: 'max_trans'},
                    {data: 'claim_sub_status_na'},
                    {data: 'total_reserve'},
                    {data: 'total_payment'},
                    {data: 'balance'},
                    {data: 'loss_rpt_attach_y_or_n'},
                    {data: 'salvage_subrogation_reserve'},
                    {data: 'salvage_subrogation_payment'},
                    {data: 'claims_allocated_to'},
