            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Transaction  Summary Product Report
                    </h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Transaction  Summary Product Report</span>
                    </div>
                </div>
...
<script>
    ...
    var filterDateto =-1;
    var url = '{!! url('admin/report/transactionSummaryProductReportExport/:filter') !!}';
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#claim_report').DataTable({
                ...
                order : [1, 'DESC'],
                ajax: {
                    url: '{!! route('admin.report.transaction_summary') !!}',
                    type:'post',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
