            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Earned premium with Unearned Report
                    </h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Earned premium with Unearned Report</span>
                    </div>
                </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="claim_report">
                            ...
                            <tr>
                                ...
                                <th>Period Earned Premium</th>
                                <th>Unearned Premium</th>
                                <th>Total Earned Premium</th>
                                <th>Term Start Date</th>
                                <th>Term End Date</th>
                                <th>Trans Effective From</th>
                                <th>Trans Effective To</th>
                                <th>Booking Date</th>
                                <th>VAT Earned</th>
                                <th>VAT Unearned</th>
                                <th>Levy Earned</th>
...
<script>
    ...
    var filterDateto =-1;
    var url = '{!! url('admin/report/earnedPremiumReportExport/:filter') !!}';
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#claim_report').DataTable({
                ...
                order : [1, 'DESC'],
                ajax: {
                    url: '{!! route('admin.report.earnedPremiumReportData') !!}',
                    type: 'post',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
                ...
                columns: [
                    ...
                    {data: 'name'},
                    {data: 'insured_name'},
                    {data: 's_transaction_type'},
                    {data: 'no_of_days'},
                    {data: 'written_premium'},
                    {data:  null, render: function(data,type,row) { return 'P '+data["earned_premium"]}},
                    {data:  null, render: function(data,type,row) { return 'P '+data["unearned_premium"]}},
                    {data: 'total_earned_premium'},
                    {data: 'term_start_date'},
                    {data: 'term_end_date'},
                    {data: 'd_trance_effective_from'},
                    {data: 'd_trance_effective_to'},
                    {data: 'booking_date'},
                    {data:  null, render: function(data,type,row) { return 'P '+(data["earned_premium"] * 0.12).toFixed(2)}},
                    {data:  null, render: function(data,type,row) { return 'P '+(data["unearned_premium"] * 0.12).toFixed(2)}},
                    {data:  null, render: function(data,type,row) { if(data["product_id"] === '3') {return 'P '+(data["earned_premium"] * 0.08).toFixed(2)} else { return 0 } }},
                    {data:  null, render: function(data,type,row) { if(data["product_id"] === '3') {return 'P '+(data["unearned_premium"] * 0.08).toFixed(2)} else { return 0 } }},
                ],
            });
        };
        return {
