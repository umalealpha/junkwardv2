        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                ...
                <div class="kt-subheader__toolbar">
                    <div class="row">
                    <div class="col-sm-3">
                        <a href="{{url('admin/report/summary-age-analysis-data-export')}}" type="button" class="btn btn-primary">Export</a>
                    </div>
                </div>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#exportTable').DataTable({
                ...
                "order": [[ 1, "desc" ]],
                ajax: {
                    url: '{!! url('admin/report/summary-age-analysis-data') !!}'
                },
                columns: [
                    {data: 'policyNumber',name:'policyNumber'},
                    {data: 'customer_name',name:'policyNumber'},
                    {data: 'balance',name:'policyNumber'},
                    {data: '30_days',name:'policyNumber'},
                    {data: '60_days',name:'policyNumber'},
                    {data: '90_days',name:'policyNumber'},
                    {data: '120_days_above',name:'policyNumber'}
