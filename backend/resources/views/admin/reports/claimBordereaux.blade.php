            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Claim Bordereaux Report</span>
                    </div>
                </div>
            </div>
            <!-- end:: Subheader -->
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="claim_report">
                            ...
                            <tr>
                                ...
                                <th>Netretention_SI</th>
                                <th>Quotasharing_SI</th>
                                <th>Surplus_SI</th>
                                <th>Facultative_SI</th>
                                <th>Tran#  PK</th>
                                <th>RISK Master FK</th>
                                <th>Motor PK</th>
                                <th>ParentCoverageCode</th>
                                <th>s_TreatyName</th>
                                <th>RegulatoryMappingName</th>
                                <th>TermStartDate</th>
                                <th>TermEndDate</th>
                                <th>VATInclude</th>
                            </tr>
...
<script>
    ...
    var filterDateto =-1;
    var url = '{!! url('admin/report/claimBordereauxExport/:filter') !!}';
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#claim_report').DataTable({
                ...
                order : [1, 'DESC'],
                ajax: {
                    url: '{!! route('admin.report.getClaimBordereaux') !!}',
                    type: 'post',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
                ...
                columns: [
                    ...
                    {data: 'Netretention_SI'},
                    {data: 'Quotasharing_SI'},
                    {data: 'Surplus_SI'},
                    {data: 'Facultative_SI'},
                    {data: 'Tran_PK'},
                    {data: 'RiskMasterFK'},
                    {data: 'MotorPK'},
                    {data: 'ParentCoverageCode'},
                    {data: 's_TreatyName'},
