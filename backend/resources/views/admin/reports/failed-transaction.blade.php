                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select name="trans_ref" class="form-control" id="trans_ref">
                                    <option value="-1">All</option>
                                    @foreach($failedRefs as $failedRef)
                                        <option style="text-transform: capitalize" value="{!! $failedRef->statusRef !!}">{!! $failedRef->statusRef !!}</option>
                                    @endforeach
                                </select>
                            </div>
                            {{--  <div class="col-sm-3">
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#policy_table').DataTable({
                ...
                ajax: {
                    url: '{!! route('admin.transaction-report.data') !!}',
                    data: function (d) {
                        ...
                        d.filterPolicyDateFrom = filterPolicyDateFrom;
                        d.filterPolicyDateto = filterPolicyDateto;
                        d.filterPolicyDateto = filterPolicyDateto;
                        d.agent_id =agent_id;
    ...
    var KTDatatablesDataSourceAjaxServer2 = function() {
        ...
        var initTable2 = function() {
            table2 = $('#exportTable').DataTable({
                ...
                ajax: {
                    url: '{!! route('admin.report.allfailedtransactionData') !!}',
                    data: function (d) {
                        d.policyStatus_filter = policyStatus_filter;
                        d.product_filter = product_filter;
                        d.product_plan = product_plan;
