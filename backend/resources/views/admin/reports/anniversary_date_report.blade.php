            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Anniversary Date Report</span>
                    </div>
                </div>
            </div>
            <!-- end:: Subheader -->
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="claim_report">
                            ...
                            <tr>
                                <th>Policy_No</th>
                                <th>n_TermMaster_PK</th>
                                <th>n_PolicyMaster_FK</th>
                                <th>d_TermStartDate</th>
                                <th>d_TermEndDate</th>
                                <th>n_TermLastTranFK</th>
                                <th>For Monthly </th>
                                <th>n_TermSequence</th>
                                <th>Anniversary Start </th>
                                <th>Anniversary End Date</th>
                                <th>n_AnniversarySequen</th>
                                <th>n_TermResetCounter</th>
                            </tr>
                            </thead>
                        </table>
                        <!--end: Datatable -->
...
<script>
    ...
    var filterDateto =-1;
    var url = '{!! url('admin/report/anniversaryDateReportExport/:filter') !!}';
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#claim_report').DataTable({
                ...
                order : [1, 'DESC'],
                ajax: {
                    url: '{!! route('admin.report.anniversary_date_report') !!}',
                    type: 'post',
                    data: function (d) {
                        d._token = "{{ csrf_token() }}";
                ...
                columns: [
                    {data: 'policyNumber'},
                    {data: 'n_term_master_pk'},
                    {data: 'n_policy_master_fk'},
                    {data: 'd_term_start_date'},
                    {data: 'd_term_end_date'},
                    {data: 'n_term_last_tran_fk'},
                    {data: 'for_monthly'},
                    {data: 'n_term_sequence'},
                    {data: 'anniversary_start'},
                    {data: 'anniversary_end_date'},
                    {data: 'n_anniversary_sequen'},
                    {data: 'n_term_reset_counter'},
                ],
            });
        };
        return {
