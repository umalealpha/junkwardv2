        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span> <a href="" class="kt-subheader__breadcrumbs-link"> Update </a>
            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                ...
                <div class="kt-portlet">
                    <!--begin::Form-->
                    <form id="storeForm" action="{{ route('admin.re-rating.update',$data->id) }}" method="POST" enctype="multipart/form-data" class="kt-form">
                        <!-- CSRF Token -->
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row" style="margin-bottom: 1rem;">
                                ...
                                <div class="col-6">
                                    <select class="form-control selectpicker" name="role" placeholder="Select Role" title="Select Role" disabled>
                                        @foreach($roles as $role)
                                        <option @if($role->id == $data->role) selected @endif value="{{ $role->id }}">{{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row" style="margin-bottom: 1rem;">
                                ...
                                <div class="col-6">
                                    <select class="form-control selectpicker" name="type" id="" disabled>
                                        <option value="">Select Type</option>
                                        <option value="1" @if($data->type != null && $data->type== 1 ) selected @else  @endif>Quote</option>
                                        <option value="2" @if($data->type != null && $data->type== 2 ) selected @else  @endif>Policy</option>
                                        <option value="3" @if($data->type != null && $data->type== 3 ) selected @else  @endif>Policy Renewal</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" name="discount" value="{{ $data->discount }}" placeholder="Please provide discount value in %" title="Please provide discount value in %" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" name="surcharge" value="{{ $data->surcharge }}" placeholder="Please provide surchage value in %" title="Please provide surchage value in %" />
                                </div>
                            </div>
                        </div>
