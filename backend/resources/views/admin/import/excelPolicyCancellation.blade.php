            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        <form action="{{ route('admin.policy.getExcelPolicyCancellation') }}" id="PolicyCancellationExcelImportForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="form-group mt-4">
                                            ...
                                            <a href="{{ \AlphaDirect\Helper::getCloudFrontURL('Document/Policy_Document/cancel_policy/bookCancelpolicy_(6).xlsx') }}" class="btn btn-info">Download Excel</a>
                                        </div>
                                </div>
                            </div>
                        </form>
