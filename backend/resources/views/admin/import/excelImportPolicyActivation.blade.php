            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Excel Import For Policy Activation
                    </h3>
            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        <form action="{{ route('admin.policy.getExcelImportPolicyActivation') }}" id="PolicyActivationExcelImportForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="form-group mt-4">
                                            ...
                                            <a href="{{ \AlphaDirect\Helper::getCloudFrontURL('Document/Policy_Document/excel-import-policy-activate/BookActivatepolicy.xlsx') }}" class="btn btn-info">Download Excel</a>
                                        </div>
                                </div>
