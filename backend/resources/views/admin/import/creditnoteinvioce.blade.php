        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    Credit Note And Invioce Generate
                    </h3>
            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        <form action="{{ route('admin.policy.CreditNoteAndInvioceGen') }}" id="getExcelImportForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="kt-portlet__foot kt-portlet__foot--solid">
                                        <div class="kt-form__actions">
                                            <div class="row">
                                                <div class="col-3"></div>
                                                <div class="col-9">
                                                    <button type="submit" id="btn" value="Submit" class="btn btn-brand">Generate</button>
...
<script>
    $(document).ready(function(){
        jQuery.validator.addMethod("policynum", function(value, element) {
            return this.optional( element ) || /^[a-zA-Z]{3}[0-9]{10}$/.test( value );
        }, 'Please enter valid policy number ex. MIS1234567890');
        $( "#getExcelImportForm" ).validate({
            rules: {
                policyNumber:{
                    required:true,
                    maxlength: 13,
            ...
            messages:{
                policyNumber: {
                    ...
                    maxlength: "Policy number should be of 13 Digits",
                }
            }
        });
    });
