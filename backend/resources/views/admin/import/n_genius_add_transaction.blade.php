            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Excel Import For N-Genius Transaction
                    </h3>
            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        <form action="{{ route('admin.policy.get_excel_n_genius_add_transaction') }}" id="PolicyActivationExcelImportForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="form-group mt-4">
                                            ...
                                            <a href="{{ \AlphaDirect\Helper::getCloudFrontURL('Document/Policy_Document/N-Genius-Excel-upload-for-add-Transaction/BookN-Genius-Add-Trxn.xlsx') }}" class="btn btn-info">Download Excel</a>
                                        </div>
                                </div>
