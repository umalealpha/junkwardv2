            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        <!--begin: Datatable -->
                        <table class="table table-striped table-bordered table-hover table-checkable" id="vcs_event_table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Policy Number</th>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table.DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.vcs-event-log.data') !!}',
                columns: [
                    {data: 'id'},
                    {data: 'policyNumber'},
