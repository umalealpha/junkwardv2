        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    Fetch Realpay Contract Details
                </h3>
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Fetch Contract Details</span>
                </div>
            </div>
        </div>
        <!-- end:: Subheader -->
    ...
    <!-- begin:: Content -->
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="fetchContract" action="{{ route('admin.fetchDetails') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="policyNumber"  title="Policy Number is required" placeholder="Enter Policy Number">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="clientNumber"  title="Client Number is required" placeholder="Enter Client Number">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="contractNumber"  title="Contract Number is required" placeholder="Enter Contract Number">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control kt_selectpicker" name="product" title="Please choose product" data-live-search="true" id="carMakeDropDown" required>
