                ...
                @can('product-create')
                    <div class="kt-subheader__toolbar">
                        <div class="kt-subheader__wrapper">
                            <a href="{{ URL::to('admin/product/create') }}" class="btn btn-sm btn-elevate btn-brand btn-elevate" id="" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Add New"> <span class="kt-opacity-11" id="">Add New</span>&nbsp; <i class="flaticon2-add-1 kt-padding-l-5 kt-padding-r-0"></i> </a>
                        </div>
                    </div>
                @endcan
            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <select name="productType_filter" class="form-control" id="productType_filter">
                                    ...
                                    @foreach($productType as $productTypes)
                                        <option style="text-transform: capitalize" value="{!! $productTypes->id !!}">{!! $productTypes->name !!}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
