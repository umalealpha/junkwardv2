    ...
    <!-- begin:: Content -->
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="contractCreate" action="{{ route('admin.addContractManually') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="policy_number"  title="Please provide policy number" placeholder="Please provide policy number">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control" name="billingDay">
                                    <option value="" disabled selected>Select billing day</option>
                                    @for($i=1;$i<29;$i++)
                        ...
                        <div class="form-group row">
                            <label  class="col-3 col-form-label">Pro-rata Premium :</label>
                            <div class="col-9">
                                <input  class="form-control" name="first_premium"  title="Please provide pro rata premium" placeholder="Please provide pro rata premium">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="premium"  title="Please provide premium" placeholder="Please provide premium">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                    </div>
