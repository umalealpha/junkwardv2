            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="{{Route('admin.policy_payment_status')}}" class="kt-subheader__breadcrumbs-link"><span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Policy Payment Status</span> </a>
                    </div>
                </div>
            </div>
            <!-- end:: Subheader -->
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <label>Filter By Balance</label>
                                <select name="balance_filter" class="form-control" id="balance_filter">
                                    <option value="-1">All</option>
                                    <option style="text-transform: capitalize" value="0">Positive</option>
                                    <option style="text-transform: capitalize" value="1">Negative</option>
                                    <option style="text-transform: capitalize" value="2">Zero</option>
                                </select>
                            </div>
                        </div>
                            {{--<div class="col-sm-6">--}}
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="policy_table">
                            ...
                            <tr>
                                ...
                                <th>Total Premium Due on Customer</th>
                                <th>Total Payment Paid by Customer</th>
                                <th>Balance</th>
                                <th>Failed Tx Count</th>
                                <th>Policy Status</th>
                                <th>Action</th>
                            </tr>
                            </thead>
...
<script>
    ...
    var balance_filter = '-1';
    var url = '{!! url('admin/payamentStatusDumpDataExport/:filter') !!}';
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#policy_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('admin.policy_payment_status.data') !!}',
                    data: function (d) {
                        d.policyStatus_filter = policyStatus_filter;
                        d.balance_filter = balance_filter;
                    }
                    },
                ...
                buttons: [
                    {
                        ...
                        action: function(e,dt,node,config){
                            var url1 = url.replace(':filter','?policyStatus_filter='+policyStatus_filter+'&balance_filter='+balance_filter);
                ...
                order: [0, 'DESC'],
                columns: [
                    {data: 'policyNumber',name:'policy_payment_status_dump.policyNumber'},
                    {data: 'premium',name:'policy_payment_status_dump.premium'},
                    {data: 'premium_freq',name:'policy_payment_status_dump.premium_freq'},
                    {data: 'total_prem_due_customer',name:'policy_payment_status_dump.total_prem_due_customer'},
                    {data: 'total_payment_paid_by_cust',name:'policy_payment_status_dump.total_payment_paid_by_cust'},
                    {data: 'balance',name:'policy_payment_status_dump.balance'},
                    {data: 'failed_tx_count',name:'policy_payment_status_dump.failed_tx_count'},
                    {data: 'policy_status',name:'policy_payment_status_dump.policy_status'},
                    {data: 'action'}
                ],
