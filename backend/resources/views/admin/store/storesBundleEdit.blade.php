                    ...
                    <form id="storeForm" action="{{ route('admin.store.bundle.update') }}" method="POST"
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <label for="example-text-input" class="col-3 col-form-label">Stores Name:</label>
                                <div class="col-6">
                                    <select class="form-control selectpicker" name="stores[]" multiple
                                        placeholder="Select stores name" title="Select stores name">
