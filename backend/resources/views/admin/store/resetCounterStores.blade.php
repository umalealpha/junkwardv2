        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}"
                            ...
                            class="kt-subheader__breadcrumbs-separator"></span> <a href="{{route('admin.store')}}"
                            class="kt-subheader__breadcrumbs-link"> Store </a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Reset
                            Stores counter</span>
                    </div>
                </div>
            </div>
            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                ...
                <div class="kt-portlet">
                    <!--begin::Form-->
                    <form id="storeForm" action="{{ route('admin.store.bundle.update') }}" method="POST"
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    ...
                                    <label for="example-text-input" class="col-2 col-form-label">Maximum warehouse
                                        inventory</label> --}}
                                    <label for="example-text-input" class="col-2 col-form-label">Actual Count</label>
                                ...
                                <div class="col-2">
                                    <input type="number" name="data[{{ $index }}][counter]" id="counter_{{ $index }}"
                                        class="form-control" min="0" required>
                                </div>

                                <div class="col-2">
                                    <button class="btn btn-brand btn-sm" type="button" value="+"
                                        id="increment">+</button>
                                    <button class="btn btn-brand btn-sm" type="button" value="-"
                                        id="decrement">-</button>
                                    <button class="btn btn-brand btn-sm" type="button" value="reset"
                ...
                $("#storeForm").validate({
                    ...
                    messages: {
                        stores: {
                            ...
                            notEqualTo: "Please select stores",
                        },
                    },
