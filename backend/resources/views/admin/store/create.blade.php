    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="storeForm" action="{{ route('admin.store.store') }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="order"
                                       placeholder="Please provide store Name" title="Please provide appearance order"/>
                        ...
                        <div class="form-group row" style="margin-bottom: 1rem;">
                            ...
                            <div class="col-6">
                                <select class="form-control selectpicker" name="partner"
                                        placeholder="Select partner name" title="Select partner name">
                                    @foreach($partners as $partner)
                                        <option value="{{ $partner->id }}">{{ $partner->name }}</option>
                                    @endforeach
                                </select>
                                <a href="{{ route('admin.store.addPartner') }}" target="_blank"
                                   style="display: block;padding-top:15px"> Didn't find partner
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                    <textarea class="form-control" name="address" placeholder="Please provide address"
                                              title="Please provide address" required maxlength="500"></textarea>
                            </div>
                        </div>
