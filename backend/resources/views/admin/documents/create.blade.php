    ...
    <!-- begin:: Content -->
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="accountCreate" action="{{ route('admin.documents.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                ...
                                @foreach($products as $product)
                                    <option value="{!! $product->id !!}" content="{!! $product->name !!}">{!! $product->name !!}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-9">
                                <select class="form-control kt_selectpicker" id="document_cat" name="document_cat" title="Please choose document category" data-live-search="true" required>
                                    @foreach($doc_types as $type)
                                        <option value="{!! $type->value !!}" content="{!! $type->value !!}">{!! $type->value !!}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="document_name"  title="Document name is required" placeholder="Please enter document name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                    <span class="kt-switch">
                                        <label>
                                            <input id="statusValue" type="checkbox" name="statusValue" value="1"
                                                   onchange="status()">
