    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="transFormRealpaySave" action="{{ route('transFormviewRealpay') }}" method="POST" enctype="multipart/form-data" class="kt-form">
                    <!-- CSRF Token -->
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <a href="{{ URL::to('admin/reconsilation/realpayExport') }}" class="btn btn-sm btn-elevate btn-brand btn-elevate" id="" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Download"> <span class="kt-opacity-11" id="">Download</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Realpay Reconsilation Import</label>
                            <div class="col-9">
        ...
        <div class="kt-portlet__body">
            ...
            <br>
            <table class="table table-striped table-bordered table-hover table-checkable" id="RealpayPaymenttable">
                <thead>
                <tr>
                    <th>ID</th>
...
<script>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#RealpayPaymenttable').DataTable({
                responsive: true,
                searchDelay: 500,
                language:{
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('getTransFormviewRealpay') !!}',
                    data: function (d) {
