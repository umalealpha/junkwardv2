    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="regionEdit" action="{{ route('admin.region.update', $region->id) }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="name" class="form-control" name="name" value="{!! $region->name !!}" placeholder="Enter Region name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="currency" value="{!! $region->currency !!}"  title="Region currency is required" placeholder="Enter Currency">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="vat"  value="{!! $region->vat !!}" title="VAT is required" placeholder="Enter VAT">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="tax"  value="{!! $region->tax !!}" title="Service Tax is required" placeholder="Enter Service Tax">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="registration"  value="{!! $region->registration !!}" title="Registration Number is required" placeholder="Enter Registration Number">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        {{--Add multiple values--}}
                        ...
                        <div class="kt-repeater" id="multipleValues" >
                            <div class="kt-repeater__data-set">
                                <div data-repeater-list="regionLicense">
                                    <div data-repeater-item class="kt-repeater__item">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label licenseLabel">License:</label>
                                            <div class="col-lg-3">
                                                <input type="text" name="lic_name" class="form-control" placeholder="Enter License Name">
                                            </div>
                                            <div class="col-lg-3">
                                                <input type="number" name="lic_num" class="form-control" placeholder="Enter License Number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            @foreach($regionLicenses as $regionLicens)
                                <div class="kt-repeater__data-set">
                                    <div data-repeater-item class="kt-repeater__item">
                                        <div class="kt-repeater__close kt-repeater__close--align-right form-group" style="height: 0px;text-align: right;margin-bottom: 0px;position: relative;right: 10%">
                                            <a href="{{route('admin.region.regionLicenseDelete',$regionLicens->id)}}" class="btn btn-danger"> <i class="la la-close"></i> Remove License </a>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label"></label>
                                            <div class="col-lg-3">
                                                <input type="text" name="lic_name[{{$regionLicens->id}}]" class="form-control" value="{{$regionLicens->license_name}}" placeholder="Enter license name">
                                            </div>
                                            <div class="col-lg-3">
                                                <input type="number" name="lic_num[{{$regionLicens->id}}]" class="form-control" value="{{$regionLicens->license_number}}" placeholder="Enter license number">
                                            </div>
                                        </div>
                            ...
                            <div class="kt-repeater__add-data">
                                <span data-repeater-create="" class="btn btn-info btn-sm addMore" style="margin-left: 26%;"> <i class="la la-plus"></i> Add </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-top: 1%">
                            ...
                            <div class="col-9">
                                <span class="kt-switch" >
                                    <label>
                                        <input id="switchValue" type="checkbox" @if($region->status) checked="checked" @endif name="status" value="1" onchange="statusMsg()">
