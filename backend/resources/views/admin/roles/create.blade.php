    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="batchForm" action="{{ route('admin.roles.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('name', null, array('placeholder' => 'Name','class' => 'form-control roleName')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control kt_selectpicker" title="Please select rule group"
                                    ...
                                    @foreach($ruleGroups as $key=>$rule_group)
                                        <option value="{{$rule_group->n_PrValidationRuleGroupMasters_PK}}">{{ $rule_group->s_RuleCode }} - {{ $rule_group->s_RuleDesc }}</option>
                                    @endforeach
                               </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                &nbsp&nbsp
                                <label class="kt-checkbox kt-checkbox--brand selectSpan" hidden>
...
<script>
    $('.roleName').keyup(function(){
        var role = $(this).val();
        if (role == "Super Admin" || role == "super admin" || role == "admin"){
