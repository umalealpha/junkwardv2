            ...
            <div class="kt-portlet">
                ...
                <form id="cron"  action="{{ route('admin.smsControl.store') }}" method="POST" enctype="multipart/form-data" class="">
                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                     <input type="hidden" name="id" value="{{ $smsControl->id }}" />
                    <div class="kt-portlet__body">

                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Sms Fuction Name</label>
                            <div class="col-8">
                                <input type="text" class="form-control" name="function_name" value="{{ $smsControl->function_name }}"  placeholder="Enter cron name">
                      ...
                      <div class="form-group row">
                                <label for="example-text-input" class="col-3 col-form-label">Sms Function Status</label>

                                                    <label class="kt-radio" style="margin-left: 10px;">
                                                        <input type="radio" name="status" @if($smsControl->status == 1) checked @endif class="form-control condition" value="1">Activated<span></span>
                                                    </label>
                                                    <label class="kt-radio" style="margin-left: 10px;">
                                                        <input type="radio" name="status"  @if($smsControl->status != 1) checked @endif  class="form-control  condition"
