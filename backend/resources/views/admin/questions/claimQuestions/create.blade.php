 ...
 <div id="kt_header_mobile" class="kt-header-mobile kt-header-mobile--fixed ">
    ...
    <div class="kt-grid kt-grid--hor kt-grid--root">
         ...
         <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span> <a href="" class="kt-subheader__breadcrumbs-link"> Administration </a> <span class="kt-subheader__breadcrumbs-separator"></span> <a href="" class="kt-subheader__breadcrumbs-link"> Claim Questions</a> <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <!--begin::Form-->
            <form id="typeForm" action="{{ route('claim.question.save') }}"
