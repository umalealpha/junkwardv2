            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="{{Route('admin.product.index')}}" class="kt-subheader__breadcrumbs-link"><span
                                    class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Product</span>
                        </a>
                    </div>
                </div>
                @can('product-create')
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper">
                        <a href="{{ URL::to('admin/product/create') }}"
                           ...
                           data-placement="left" data-original-title="Add New"> <span class="kt-opacity-11" id="">Add New</span>&nbsp;
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <select name="productType_filter" class="form-control" id="productType_filter">
                                    <option value="-1">All</option>
                                    @foreach($productType as $productTypes)
                                        <option style="text-transform: capitalize"
                                                value="{!! $productTypes->id !!}">{!! $productTypes->name !!}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
