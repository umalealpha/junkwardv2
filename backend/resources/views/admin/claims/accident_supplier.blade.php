...
<div class="kt-portlet kt-portlet--height-fluid">
    <div class="kt-portlet__head">
        ...
        @if ($claims->status != 'Closed')
            <div class="col-lg-5">
                <button class="btn btn-brand" style="float:right; margin-top: 2%;" id="quoteRequest" type="button" data-toggle="collapse" data-target="#Suppliercollapse" aria-expanded="false" aria-controls="collapseExample"> Add Quote Request </button>
                <button class="btn btn-success" style="float:right; margin-top: 2%;  margin-right: 10px;" id="uploadPO" type="button" data-toggle="collapse" data-target="#POcollapse" aria-expanded="false" aria-controls="collapseExample"> Upload PO </button>
            </div>
        @endif
    </div>
