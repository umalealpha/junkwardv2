...
<div class="form-group row">
    ...
    <div class="col-9">
        <input type="text" id="lossDate" name="lossDate" class="form-control kt_datepicker_1 dob" autocomplete="off" title="Please select date of loss/stolen/damage" value="" placeholder="Date of Loss/stolen/Damage">
    </div>
</div>
