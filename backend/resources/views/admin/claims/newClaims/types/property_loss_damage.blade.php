...
{{-- <div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <input type="text" class="form-control" name="broker_agent" value="" >
        </div>
    </div>
</div> --}}
...
{{-- <div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <input type="text" class="form-control" name="policy_no" value="" >
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="name_occupation" ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="address_tele_no" ></textarea>
        </div>
    </div>
</div> --}}
...
{{-- <div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="date_time_of_loss_damage" ></textarea>
        </div>
    </div>
</div> --}}
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="loss_damage_discovered"  ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="loss_damage_occurred" ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="premises_occupied"   ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="last_occupied"  ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="purpose_of_occupation"   ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="nature_interruption"  ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="loss_for_each_item"  ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="previously_suffered_loss" ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="give_details"   ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="name_of_insurer"  ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="reference_no_station" ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="interest_insured_property" ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="other_insurance_covering"  ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="give_name_insurer"  ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="value_all_property"  ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <textarea type="text" class="form-control" name="when_last_valued" ></textarea>
        </div>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="Production col-8" style="margin-left: 10px;">
        <div class="form-group row">
            <input type="text" class="form-control" name="name_of_account" value="" >
        </div>
    </div>
</div>
