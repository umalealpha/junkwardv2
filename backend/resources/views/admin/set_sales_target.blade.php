    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="storeSalesTarget" action="{{ route('storeSalesTarget') }}" method="POST" enctype="multipart/form-data" class="kt-form">
                    <!-- CSRF Token -->
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                   
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Target No.</label>
                            <div class="col-9">
                                <input type="text" class="form-control" name="target_no"  placeholder="Enter Sales Target No.">
                        ...
                        <div class="form-group row">
                                <label for="example-date-input" class="col-3 col-form-label">Deadline Date</label>
                                <div class="col-9">
                                    <input type="text" class="form-control kt_datepicker_1" autocomplete="off" name="deadline_date"  placeholder="Enter Deadline Date ">
                                    <span class="form-text text-muted"></span> 
