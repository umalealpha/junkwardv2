...
<div id="content" style="margin-bottom: 0px;">
    ...
    <p style="font-size: large">Total number of Without Cellphone Details Policy Upto Today: {{ count($policies) }} </p>
    ...
    @if($policies->count() > 0)
        <tr>
            ...
            <td style="background-color: #dbe5f1;">
                <p style="text-align: center;margin: 0px;">
                    <b>Imei No/Serial code </b>
                </p>
            </td>
             <td style="background-color: #dbe5f1;">
                <p style="text-align: center;margin: 0px;">
                    <b>Cellphone Photo Uploaded</b>
                </p>
            </td>
            ...
            <td>
             ...
             <td>
                <p style="color: #000000; margin: 0px;">
                    ...
                    <b>
                    @if($p->cell_phone_front != null && $p->cell_phone_back != null  && $p->cell_phone_left != null && $p->cell_phone_right != null  &&  $p->cell_phone_top != null && $p->cell_phone_bottom != null )
                        {{  "Yes"}}
                    @else
                         {{  "No"}}
                    @endif
