...
<div id="content" style="margin-bottom: 0px;">
    ...
    <div style="text-align: center">
        <h3>Policy Activated Today Report @if(env('APP_STATUS') == 'Development') {{  '-DEVELOPMENT' }}@endif</h3>
    </div>

    @if(count($policies) > 0)
        <p style="font-size: large"> {{ count($policies) }} are policies activated today.</p>
    ...
    @else
        <p>No policies has been activated today.</p>
    @endif
