    ...
    <div class="container clearfix" style="position: relative; padding: 40px 0px;">
        <div class="inner-container clearfix" style="z-index: 11; max-width:650px;margin: auto; ">
            ...
            <table class="table-responsive" style="border-collapse: collapse;width:100%">
                ...
                <tr>
                    <td>
                        <h4 style="margin: 0px; font-weight: 600; "><u>COVER NOTE & PROOF OF INSURANCE : <span style="text-transform: uppercase">{{ $policy->firstName.' '.$policy->middleName.' '.$policy->lastName }}</span></u></h4>
                ...
                <tr>
                    <td>
                        <p>This serves to confirm that <span style="font-weight: 600;"><span style="text-transform: uppercase">{{ $policy->firstName.' '.$policy->middleName.' '.$policy->lastName }}</span></span> in accordance with their instructions, is comprehensively covered
                            on the following class by <span style="font-weight: 600;">Alpha Direct Insurance Company(Pty) Ltd.</span>
                        </p>
                    </td>
                </tr>
                <tr>
            ...
            <table class="table-responsive" style="border-collapse: collapse;width:100%">
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <img src="{{ url('/images/qrcode'.$policy->policy_id.'.png') }}" alt="QR Code " style="max-height: 150px; margin-bottom: 5px;">
                        <div>
