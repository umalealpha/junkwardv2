...
<div id="content" style="margin-bottom: 0px;">
    ...
    @if(count($policies) > 0)
        <p style="font-size: large">Total number of policies Expired Today: {{ count($policies) }} </p>
    ...
    @else
        <p>Total number policies Expried Today: 0</p>
    @endif


    @if(count($total_policies_expired_list) > 0)
        <p style="font-size: large">Total number of policies Expired Today: {{ count($total_policies_expired_list) }} </p>
        <table class="table-responsive" style="border-collapse: collapse;width:100%">
            <thead>
                <tr>
                    <th style="background-color: #dbe5f1;">
            ...
            @foreach($total_policies_expired_list as $key=> $w)
                <tbody>
                    <tr>
                        <td>
                            <p style="color: #000000; margin: 0px;">
    ...
    @else
        <p>Total number policies Expried Till Now: 0</p>
    @endif
