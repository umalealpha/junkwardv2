...
<div>
    ...
    <p style="color: #f37000!important;font-family: Poppins!important; margin: 0px!important;font-size: large!important">
        Policyholder :  <span>
         ...
         <p></p>
    <p style="color: #f37000!important;font-family: Poppins!important; margin: 0px!important;font-size: large!important">ID Type :
        <span>
    ...
    <p></p>
    <p style="color: #f37000!important;font-family: Poppins!important; margin: 0px!important;font-size: large!important">{{ (isset($profile->id_type) && $profile->id_type === 'Passport') ? 'Passport No' : 'Omang ID' }} :
        <span>
        @if (isset($profile->id_type) && $profile->id_type === 'Passport')
        {{ $profile->passport ?? 'N/A' }}
        @elseif ($profile->omang != null)
        {{ $profile->omang }}
        @else
        N/A
        @endif
    ...
    <p style="color: #f37000!important;font-family: Poppins!important; margin: 0px!important;font-size: large!important">Vehicle Plate Number :
        <span>
            @if ($vehicle != null && $vehicle->vehiclePlate != null)
    ...
    <p style="color: #f37000!important;font-family: Poppins!important; margin: 0px!important;font-size: large!important">
        Term Start Date :
    <span>
        @if ($policy != null && $policy->billingStartDate != null)
