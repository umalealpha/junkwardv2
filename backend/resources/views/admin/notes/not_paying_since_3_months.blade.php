...
<div id="content" style="margin-bottom: 0px;">
    ...
    @if(count($policies) > 0)
        <p style="font-size: large">Total number policies not paying since 3 months: {{ count($policies) }} </p>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                         ...
                         <td>
                            <p style="color: #000000; margin: 0px;">
                                <b>@if(isset($q->customer)){{ $q->customer->firstName.' '.$q->customer->lastName }} @endif</b>
                            </p>
                        </td>
    ...
    @else
        <p>Total number policies not paying since 3 months: 0</p>
    @endif
