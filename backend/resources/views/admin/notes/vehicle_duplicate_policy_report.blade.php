...
<div id="content" style="margin-bottom: 0px;">
    ...
    <p style="font-size: large">Total number of Motor 3rd Party Duplicate Policy upto Today: {{ count($policies) }} </p>
    <p style="font-size: large">Total number of Motor Comprehensive Duplicate Policy upto Today: {{ count($policiesMotorComp) }} </p>
    ...
    @endif
    @if($policiesMotorComp->count() > 0)
    @foreach($policiesMotorComp as $p)
        <tr>
            <td>
                <p style="color: #000000; margin: 0px;">
                    <b>{{ $p->id }}</b>
