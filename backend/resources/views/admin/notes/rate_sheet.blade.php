            ...
            <table style="width:100%;">
                <tr valign="middle">
                    <td width="50%">
                        ...
                        <p style="font-size: 13px; margin: 0px;color: black!important;">Postal Address: P.O. Box 26 ADC<br>Gaborone, Botswana</p>
                    ...
                    <td width="50%">
                        ...
                        <p style="text-align: right; font-weight: 600!important;"> SUB TYPE : THRUAGENT</p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="commaSeperateValue">
            ...
            <tr style="">
                ...
                <td width="10%" >
                    ...
                    @if(count($coverages->coverageDetail)>0)
                        @foreach($coverages->coverageDetail as $newIndex => $sub_coverages)
                        <p style="font-size: 10px;">P {{number_format($sub_coverages->coverage_value?? '', 2, '.', ',')}}<br>
                        @endforeach
                    @endif
                </td>
                <td width="10%" >
                    ...
                    @if(count($coverages->coverageDetail)>0)
                        @foreach($coverages->coverageDetail as $newIndex => $sub_coverages)
                        <p style="font-size: 10px;">P {{number_format($sub_coverages->calculated_value?? '', 2, '.', ',')}}<br>
                        @endforeach
                    @endif
                </td>
                <td width="10%" >
            ...
            <tr style="border-bottom: 0.5px solid #73c9ed!important;border-top: 2px solid #73c9ed!important">
                ...
                <td width="10%" >
                    <p style="font-weight: 600!important;font-size: 10px;text-align: left;margin: 0px;padding:0px!important;">
                        P {{number_format($coverages->coverage_calculated_value?? '', 2, '.', ',')}}
                    </p>
                </td>
                <td width="10%" >
                    <p style="font-weight: 600!important;font-size: 10px;text-align: left;margin: 0px;padding:0px!important;">
            ...
            <tr style="border-bottom: 0.5px solid #73c9ed!important;border-top: 2px solid #2e77c3!important">
                ...
                <td width="10%" >
                    <p style="font-weight: 600!important;font-size: 10px;text-align: left;margin: 0px;padding:0px!important;">
                         P {{number_format($premiumExcludingVAT ?? '', 2, '.', ',')}}
                    </p>
                </td>
                <td width="10%" >
                    <p style="font-weight: 600!important;font-size: 10px;text-align: left;margin: 0px;padding:0px!important;">
            ...
            <tr style="border-top: 0.5px solid #73c9ed!important;border-bottom: 2px solid #2e77c3!important">
                ...
                <td width="10%" >
                    <p style="font-weight: 600!important;font-size: 10px;text-align: left;margin: 0px;padding:0px!important;"> P {{number_format($policyAction->premium, 2, '.', ',')}}</p>
                </td>
                <td width="10%" >
                    <p style="font-weight: 600!important;font-size: 10px;text-align: left;margin: 0px;padding:0px!important;">P {{number_format($policyAction->premium, 2, '.', ',')}}</p>
                </td>
