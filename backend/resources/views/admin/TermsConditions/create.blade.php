        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin.accounts.index')}}" class="kt-subheader__breadcrumbs-link"> Config </a><span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin.accounts.index')}}" class="kt-subheader__breadcrumbs-link"> Terms and conditions </a> <span class="kt-subheader__breadcrumbs-separator"></span>
    ...
    <!-- begin:: Content -->
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="accountCreate" action="{{ route('storeTermsConditions') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control kt_selectpicker" title="Please select product"
                                        data-live-search="true" name="productId">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control kt_selectpicker" title="Please select payment frequency"
                                        data-live-search="true" name="paymentFrequency">
                                    <option value="" selected disabled>Please select payment frequency</option>
                                    <option value='-1' >All Frequencies</option>
                                    <option value='1' >Monthly Instalments</option>
                                    <option value='2' >Three Instalments in a year</option>
                                    <option value='3' >Annual Instalments</option>
                                </select>
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label  class="col-3 col-form-label">Short Text:</label>
                            <div class="col-9">
                                <textarea  class="form-control" name="shortText"  title="Please enter short text" placeholder="Enter short text"></textarea>
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('terms_conditions') }}" >Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
