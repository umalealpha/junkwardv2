    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    Create Specified Coverages Items
                </h3>
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="reinsuranceTreatyEdit" action="{{ route('admin.specifiedCoveragesItems.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="code" style="margin-left: 2px;"  placeholder="Enter Specified Code" title="Specified Code is required">
                            </div>
                        </div>
                        <div class="form-group row" >
                            <label for="example-text-input" class="col-3 col-form-label">Specified Screen Name</label>
                            <div class="col-9">
                                <input  class="form-control" name="name"  placeholder="Enter Specified Screen Name" title="Specified Screen Name is required">
                            </div>
                        </div>
                        <div class="form-group row" >
                            <label for="example-text-input" class="col-3 col-form-label">Specified Item Rate</label>
                            <div class="col-9">
                                <input  class="form-control" name="rate"  placeholder="Enter Specified Item Rate" title="Specified Item Rate is required">
                            </div>
                        </div>
                        <div class="form-group row">
