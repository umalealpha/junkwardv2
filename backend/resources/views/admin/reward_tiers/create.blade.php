    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Create Reward Tier</h3>
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            <div class="kt-portlet">
                <form action="{{ route('reward-tiers.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <label class="col-3 col-form-label">Name</label>
                            <div class="col-8">
                                <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Enter tier name" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">Label</label>
                            <div class="col-8">
                                <input type="text" class="form-control" name="label" value="{{ old('label') }}" placeholder="Enter tier label">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" class="form-control" name="condition1" value="{{ old('condition1') }}" placeholder="Enter number of months" min="0" max="40">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <select class="form-control" name="condition2">
                                    ...
                                    <option value="1" {{ old('condition2') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('condition2') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <select class="form-control" name="condition3">
                                    <option value="">Select</option>
                                    <option value="1" {{ old('condition3') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('condition3') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <select class="form-control" name="condition4">
                                    <option value="">Select</option>
                                    <option value="1" {{ old('condition4') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('condition4') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" class="form-control" name="level_point" value="{{ old('level_point') }}" placeholder="Enter level point (1000-4000)" min="1000" max="4000" required>
                            </div>
                        </div>
                        <div class="form-group row">
