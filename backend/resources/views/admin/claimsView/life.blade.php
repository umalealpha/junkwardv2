...
<div class="kt-portlet kt-portlet--height-fluid">
    ...
    <div class="kt-portlet__body">
        <div class="kt-widget-4">
            <form id="storeClaim" action="{!! action('Admin\ClaimsController@update',  $life->claim_id) !!}" method="POST" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                {{csrf_field()}}
                <div class="form-group row">
                        <label for="example-text-input" class="col-3 col-form-label">Date of Death</label>
                        <div class="col-9">
                            <input disabled type="text" class="form-control kt_datepicker_1" name="date_of_death" autocomplete="off"  title="Date of death is required"  @if($life->date_of_death != NULL) value="{!! \Carbon\Carbon::parse($life->date_of_death )->format('Y-m-d') !!}" @endif>
                        </div>
                </div>
                <div class="form-group row">
                        <label  for="example-text-input" class="col-3 col-form-label">Cause of Death</label>
                        <div class="col-9">
                            <select name="cause" class="form-control kt_selectpicker" data-live-search="true" title="Please select cause of death " disabled>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-7">
                            <textarea disabled class="form-control" name="description" placeholder="Add description" id="description" rows="3">{!! $life->description !!}</textarea>
                        </div>
                    </div>
...
{{--                </div>--}}
                ...
                @if($policy->kyc_recipient == 1)
                    @include('admin.claimsView.recipient_kyc')
                @endif
