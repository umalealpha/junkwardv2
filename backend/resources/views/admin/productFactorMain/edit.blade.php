    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="productFactorMainEdit" action="{{ route('admin.factorMain.update', $factormain->id) }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                {!! Form::select('product_id', $product, $factormain->product_id, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" placeholder="Enter Product Factor Main"
                                       name="product_name" value="{{ $factormain->name }}">
                            ...
                            <div class="col-9">
                                <select class="form-control kt_selectpicker" id="productFactorType"
                                    ...
                                    @foreach($lookup as $record)
                                        <option value="{{$record->value}}" @if($factormain->type == $record->value) selected @endif>{{$record->value}}</option>
                                    @endforeach
                                    </select>
                            </div>
                        </div>
                        ...
                        @foreach($factorValues as $factorValue)
                            ...
                            <div class="kt-repeater__close kt-repeater__close--align-right form-group" style="height: 0px;text-align: right;margin-bottom: 0px;position: relative;right: 10%">
                                <a href="{{route('admin.factorMain.factorValueDelete',$factorValue->id)}}" class="btn btn-danger"> <i class="la la-close"></i> Close </a>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label"></label>
                                <div class="col-lg-3">
                                    <input type="text" name="factor_type_values_names[{{$factorValue->id}}]" class="form-control" value="{{$factorValue->name}}" placeholder="Enter Value">
                                </div>
                                <div class="col-lg-3">
                                    <input type="number" name="factor_type_factor_names[{{$factorValue->id}}]" class="form-control" value="{{$factorValue->factor}}" placeholder="Enter Factor">
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <span class="kt-switch" >
                                    <label>
                                        <input id="switchValue" type="checkbox" @if($factormain->status) checked="checked" @endif name="status" value="1" onchange="statusMsg()">
...
// Private functions
        ...
        var demo1 = function () {
            $( "#productFactorMainEdit" ).validate({
...
//display error alert on form submit
                invalidHandler: function(event, validator) {
                    $('#update_btn').show();
                    KTUtil.scrollTo("productFactorMainEdit", -200);
                },
