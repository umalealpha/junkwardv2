            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span
                            class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">KYC Compliance</span>
                    </div>
                </div>



                <form id="" action="{{ route('admin.kycCompliance.enableMati') }}" method="POST"
                    ...
                    <div class="grid-container">
                            ...
                            <div class="grid-item">
                                <label for="example-text-input" style="color: #5d78ff;font-size:large;" class="col-form-label">Enable Mati</label>
                            </div>
                            <div class="grid-item">
                                <span class="kt-switch">
                                    <label>
                                        <input id="scheduleValue" type="checkbox" @if($mati_enable->value)
                                        checked="checked" @endif name="enable_mati" value="1"
                                            onchange="scheduleMsg()">
                                        <span style="margin-top: 10px;margin-left: 10px;"></span>
                                        @if($mati_enable->value)
                                            <h4 id="schedule"
                            ...
                            <div class="grid-item" style="padding :10px">
                                <button type="submit" value="Submit" id="submit_btn" class="btn btn-brand">Submit</button>
                            </div>
                ...
                {{-- @can('repair_centers-create') --}}
                    <div class="kt-subheader__toolbar">
                        <div class="kt-subheader__wrapper">
                            <a href="{{ route('admin.kycCompliance.create') }}" class="btn btn-sm btn-elevate btn-brand btn-elevate"
...
{{--                        </div>--}}
                        ...
                        <!--end: Filter -->
                        <!--begin: Datatable -->
                        <table class="table table-striped table-bordered table-hover table-checkable" id="compliance_table">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Name</th>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#compliance_table').DataTable({
                responsive: true,
                searchDelay: 500,
                language:{
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('admin.kycCompliance.data') !!}',
                    data: function (d) {
    ...
    <script>
        ...
        $("#compliance_table").on("click", "a.confirm-delete" , function(event) {
            ...
            $.ajax({
                url: '{{ route('admin.kycCompliance.confirm-delete') }}',
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id":id
                },
                ...
                success: function(data) {
                    ...
                    if(data.status == 'success'){
                        ...
                        var url = '{{ route("admin.kycCompliance.delete", ":id") }}';
