    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="reinsuranceTreatyEdit" action="{{ route('admin.subCoverages.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row" >
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="name"  placeholder="Enter Name" title="Name is required">
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="code"  placeholder="Enter Code" title="Code is required">
                            </div>
                        </div>
                        <div class="form-group row">
