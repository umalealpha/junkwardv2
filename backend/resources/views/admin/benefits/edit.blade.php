    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid--hor">
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Edit Benefit</h3>
                ...
                <form action="{{ route('benefits.update', $benefit->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="tag" value="{{ old('tag', $benefit->tag) }}" placeholder="Enter benefit tag" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8 d-flex align-items-center">
                                <select class="form-control mr-2" name="type" id="type-select">
                                    ...
                                    @foreach($types as $type)
                                        <option value="{{ $type->code }}" {{ old('type', $benefit->type) == $type->code ? 'selected' : '' }}>{{ $type->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <select class="form-control" name="status" required>
                                    <option value="1" {{ old('status', $benefit->status) == '1' ? 'selected' : '' }}>Active</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" step="0.01" class="form-control" name="price" value="{{ old('price', $benefit->price) }}" placeholder="Enter price">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">Point</label>
                            <div class="col-8">
                                <input type="number" class="form-control" name="point" value="{{ old('point', $benefit->point) }}" placeholder="Enter point">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <div class="kt-avatar" id="image" style="float: left; clear: left;">
                                    @if($benefit->image)
                                        <div class="kt-avatar__holder" style="background-image: url({!! \AlphaDirect\Helper::getCloudFrontURL($benefit->image) !!})"></div>
                                    @else
