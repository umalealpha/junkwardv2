        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                ...
                <div class="kt-portlet">
                    ...
                    <form id="productEdit" action="{{ route('admin.repairCenters.updateStore',$center->id) }}" method="POST"
                        enctype="multipart/form-data" class="kt-form">
                        <input type="hidden" name="_method" value="PUT">
                        <!-- CSRF Token -->
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                        <input type="hidden" name="store_id" value="{{ $center->id }}" />
                        <input type="hidden" name="state_id" id="state_id" value="{{ $center->state_id }}" />
                        ...
                        <div class="kt-portlet__body">
                         <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" name="name" value="{{ $center->name }}"
                                           placeholder="Please provide store Name" title="Please provide Name" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input type="number" class="form-control" name="mobile" value="{{ $center->mobile }}"
                                           placeholder="Please provide Mobile Number" title="Please provide Mobile Number" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input  class="form-control" name="vat" value="{{ $center->vat }}" placeholder="Enter VAT Number" title="VAT is required">
                                </div>
                            </div>
                                ...
                                <div class="col-6">
                                    <select class="form-control selectpicker" name="state" id="state"
                                        ...
                                        <option value="{{ $state->id }}" @if($state->id ==
                                            $center->state_id){{ 'selected' }} @endif>{{ $state->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <select class="form-control" name="city" id="city" placeholder="Select select city"
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{ $city->id }}"
                                                    {{ $city->id == $center->city_id ? 'selected' : '' }}>{{ $city->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
