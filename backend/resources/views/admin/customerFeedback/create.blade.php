    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="ruleCreate" action="{{ route('admin.customerFeedback.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        <table class="block block-rounded block-bordered table table-bordered" id="ruleDiv" >
                            ...
                            <tr style="height: auto!important;" class="fieldGroup">
                                <td>
                                    <select class="form-control kt_selectpicker" title="Please choose Vehicle Make " data-live-search="true" name="parent_options" >
                                        
                                    </select>
                                </td>
                                <td>
                                    <input class="form-control kt_selectpicker" title="Please choose name" data-live-search="true" name="child_option">
                                </td>
                                <td>
                                    <input class="form-control kt_selectpicker" title="Please choose name" data-live-search="true" name="child_option">
                                </td>
