                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <select name="status_filter" class="form-control" id="status_filter">
                                    ...
                                    <option style="text-transform: capitalize" value="1">Active</option>
                                    <option style="text-transform: capitalize" value="2">Suspended</option>
                                </select>
                            </div>
                            <div class="col-sm-3">
                                <label>Filter By Roles</label>
                                <select name="roles_filter" class="form-control" id="roles_filter">
                                    <option value="-1">All</option>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table = $('#user_table').DataTable({
                ...
                ajax: {
                    url: '{!! url('admin/report/dataReport') !!}',
                    data: function (d) {
                        d.status_filter = status_filter;
                        d.roles_filter = roles_filter;
                    }
                },
...
<script>
    ...
    $('#refreshRoles').click(function (e) {
        ...
        $.ajax({
            ...
            url:  '{{ route('admin.user.refreshRoles') }}',
            data: {},
            dataType: 'JSON',
