        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">View Kyc Activity Log</span> </a>
                </div>
            </div>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#region_table').DataTable({
                ...
                serverSide: true,
               ajax: {
                    url: '{!! route('admin.getKycActivityLogData',$customer->id) !!}',
               },
                order: [0, 'DESC'],
                columns: [
                    {data: 'activity_description'},
                    {data: 'action_perfomed_by'},
                    {data: 'action_performed_at'},
                ],
            });
        };
        return {
