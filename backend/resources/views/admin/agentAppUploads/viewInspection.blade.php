...
{{--                                                        <img src="{{ \AlphaDirect\Helper::getCloudFrontURL($data->front) }}" style="height:100px;width:100px;"  >--}}
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <label >
                                                       @if($data->front_status == '1') <p style="color:green">Approve</p> @else  <p style="color:red">Unapprove</p> @endif
                                                ...
                                                <label >
                                                <h6>Image Remark:</h6> 
                                                @if($data->front_image_remark) <p>{{ $data->front_image_remark }}</p> @else <p>--</p>  @endif
                                                 </label>
                                                   </div>
                                            </div>
                                        </td>
...
PATHINFO_EXTENSION) == 'pdf')
    ...
    @endif
                                                ...
                                                <div class="col-4">
                                                    <h6>Update Image Status:</h6>
                                                    <label >
                                                       @if($data->back_status == '1') <p style="color:green">Approve</p> @else  <p style="color:red">Unapprove</p> @endif
                                                ...
                                                <label >
                                                <h6>Image Remark:</h6> 
                                                @if($data->back_image_remark) <p>{{ $data->back_image_remark }}</p> @else <p>--</p>  @endif
                                                 </label>
                                                   </div>
                                            </div>
...
<!--                                                        <img src="{{ \AlphaDirect\Helper::getCloudFrontURL($data->right) }}" style="height:100px;width:100px;"  >-->
                        ...
                        PATHINFO_EXTENSION) == 'pdf')
                                                ...
                                                <div class="col-4">
                                                    <h6>Update Image Status:</h6>
                                                    <label >
                                                       @if($data->right_status == '1') <p style="color:green">Approve</p> @else  <p style="color:red">Unapprove</p> @endif
                                                ...
                                                <label >
                                                <h6>Image Remark:</h6> 
                                                @if($data->right_image_remark) <p>{{ $data->right_image_remark }}</p> @else <p>--</p>  @endif
                                                 </label>
                                                   </div>
                                            </div>
...
<!--                                                        <img src="{{ \AlphaDirect\Helper::getCloudFrontURL($data->left) }}" style="height:100px;width:100px;"  >-->
                        ...
                        PATHINFO_EXTENSION) == 'pdf')
                                                ...
                                                <div class="col-4">
                                                    <h6>Update Image Status:</h6>
                                                    <label >
                                                       @if($data->left_status == '1') <p style="color:green">Approve</p> @else  <p style="color:red">Unapprove</p> @endif
                                                ...
                                                <label >
                                                <h6>Image Remark:</h6> 
                                                @if($data->left_image_remark) <p>{{ $data->left_image_remark }}</p> @else <p>--</p>  @endif
                                                 </label>
                                                   </div>
                                            </div>
...
<!--                                                        <img src="{{ \AlphaDirect\Helper::getCloudFrontURL($data->vehicleRegistration) }}" style="height:100px;width:100px;"  >-->
                       ...
                       PATHINFO_EXTENSION) == 'pdf')
                                                ...
                                                <div class="col-4">
                                                    <h6>Update Image Status:</h6>
                                                    <label >
                                                       @if($data->vehicle_registration_status == '1') <p style="color:green">Approve</p> @else  <p style="color:red">Unapprove</p> @endif
                                                ...
                                                <label >
                                                <h6>Image Remark:</h6> 
                                                @if($data->registration_image_remark) <p>{{ $data->registration_image_remark }}</p> @else <p>--</p>  @endif
                                                 </label>
                                                   </div>
                                            </div>
...
<!--                                                        <img src="{{ \AlphaDirect\Helper::getCloudFrontURL($data->vehicle_valuation) }}" style="height:100px;width:100px;"  >-->
                        ...
                        PATHINFO_EXTENSION) == 'pdf')
                                                ...
                                                <div class="col-4">
                                                    <h6>Update Image Status:</h6>
                                                    <label >
                                                       @if($data->vehicle_invoice_status == '1') <p style="color:green">Approve</p> @else  <p style="color:red">Unapprove</p> @endif
                                                ...
                                                <label >
                                                <h6>Image Remark:</h6> 
                                                @if($data->vehicle_invoice_remark) <p>{{ $data->vehicle_invoice_remark }}</p> @else <p>--</p>  @endif
                                                 </label>
                                                   </div>
                                            </div>
                            ...
                            <tr>
                                ...
                                <tr>
                                    <th>Remark:</th>
                                    <td>
                                       @if($data->remark != null) {{ $data->remark }}@else -- @endif
                                    </td>
                                </tr>
                                </thead>
                            </table>
