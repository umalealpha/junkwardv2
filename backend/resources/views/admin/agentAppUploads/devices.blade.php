            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        Device Preinspection
                    </h3>
                    <span class="kt-subheader__separator kt-hidden"></span>
                    <div class="kt-subheader__breadcrumbs">
                        <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a class="kt-subheader__breadcrumbs-link"><span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Device Preinspection</span> </a>
                    </div>
                </div>
            </div>
            <!-- end:: Subheader -->
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#policy_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('admin.deviceInspectionData') !!}',
                ...
                columns: [
                    ...
                    {data: 'device_type'},
                    {data: 'imei'},
                    {data: 'cell_phone_make'},
                    {data: 'cell_phone_model'},
                    {data: 'cell_phone_front'},
                    {data: 'cell_phone_back'},
                    {data: 'cell_phone_left'},
                    {data: 'cell_phone_right'},
                    {data: 'cell_phone_top'},
                    {data: 'cell_phone_bottom'},
                    {data: 'status'},
                    {data: 'action'},
                ],
