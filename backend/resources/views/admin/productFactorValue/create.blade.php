    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="factorValueCreate" action="{{ route('admin.factorValue.store') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control kt_selectpicker"
                                        ...
                                        id="factor"  name="main_type">
                                    @if($factorMain->count() > 0)
                                        @foreach($factorMain as $main)
...
//display error alert on form submit
                invalidHandler: function(event, validator) {
                    $('#btn').show();
                    KTUtil.scrollTo("factorValueCreate", -200);
                },
