    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="docForm" action="{{ route('organizationdocument.update',$document->id) }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input  class="form-control" value="{{$document->title}}" name="title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input  class="form-control"  value="{{$document->slug}}" name="slug">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                ...
                                name="text">{{html_entity_decode($document->text)}}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet__foot kt-portlet__foot--solid">
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    @can('org-doc-edit')
                                    <button type="submit" style="margin-left: 190px;" value="Submit" class="btn btn-brand">Update</button>
                                    @endcan
