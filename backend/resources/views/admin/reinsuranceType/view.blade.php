                ...
                <!--begin::Form-->
                    <div class="kt-portlet__body">
                        <table class="table table-striped m-table">
                            ...
                            <tr>
                                <th>Type Code</th>
                                <td>{{ $reinsuranceType->type_code }}</td>
                            </tr>
                            <tr>
                                <th>Type Name</th>
                                <td>{{ ucwords($reinsuranceType->type_name) }}</td>
                            </tr>
                            <tr>
                                <th>Type Description</th>
                                <td>{{ $reinsuranceType->type_description }}</td>
                            </tr>
                            <tr>
                                <th>Status</th>
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('admin.reinsuranceType.index') }}" >Back</a>
                                </div>
                            </div>
