            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">All Coverages</span>
                    </div>
                </div>
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper">
                        <a href="{{ route('coverage.create') }}"
                            ...
                            data-placement="left" data-original-title="Add New"> <span class="kt-opacity-11" id="">Add
                                New Coverage</span>&nbsp; <i class="flaticon2-add-1 kt-padding-l-5 kt-padding-r-0"></i> </a>
...
<script>
    ...
    $("#coverage_table").on("click", "a.confirm-delete" , function(event) {
        event.preventDefault();
        var coverage_id = $(this).attr('value');
        $.ajax({
            url: '{{ route('coverage.confirm-delete') }}',
            data: {
                "_token": "{{ csrf_token() }}",
                "id": coverage_id
            },
            ...
            success: function(data) {
                ...
                if(data.status == 'success'){
                    ...
                    var url = '{{ route("coverage.delete", ":id") }}';
