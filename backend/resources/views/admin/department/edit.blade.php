    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin.department.index')}}" class="kt-subheader__breadcrumbs-link"> Department </a> <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="deptForm" action="{{ route('admin.department.update', $department->id) }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Department Name:</label>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <span class="kt-switch" >
                                    <label>
                                        <input id="switchValue" type="checkbox" @if($department->status) checked="checked" @endif name="status" value="1" onchange="statusMsg()">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('admin.department.index') }}" >Cancel</a>
                                </div>
                            </div>
