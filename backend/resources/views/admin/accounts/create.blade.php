       ...
       {{--    @if (Auth::user()->default_password == "111111")     
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="accountCreate" action="{{ route('admin.accounts.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="account_name"  title="Account name is required" placeholder="Enter Account Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="account_num"  title="Account number is required" placeholder="Enter Account Number">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="branch_name"  title="Branch name is required" placeholder="Enter Branch Name">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="branch_code"  title="Branch Code is required" placeholder="Enter Branch Name">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
{{--                        <div class="form-group row">--}}
{{--                            <label  class="col-3 col-form-label">Front:</label>--}}
{{--                            <div class="col-9">--}}
{{--                                <input type="file" class="form-control" name="front"  title="Branch Code is required" placeholder="Enter Branch Name">--}}
{{--                                <span class="form-text text-muted"></span>--}}
{{--                            </div>--}}
{{--                        </div>--}}
