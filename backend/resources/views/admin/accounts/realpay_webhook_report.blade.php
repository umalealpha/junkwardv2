                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="accounts_table">
                            ...
                            <tr>
                                ...
                                <th>Webhook resp date</th>
                                <th>Web Response in days</th>
                            </tr>
                            </thead>
                        </table>
                        <!--end: Datatable -->
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table.DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.realpay.realPayReportForWebHook') !!}',
                order: [0, 'DESC'],
                columns: [
                    {data: 'policyNumber'},
                    {data: 'instalmentSequence'},
                    {data: 'instalmentActionDate'},
                    {data: 'instalmentRefNumber'},
                    {data: 'bankResponse'},
                    {data: 'status'},
                    {data: 'created_at'},
                    {data: 'webhook_response_in_days'},
                ],
