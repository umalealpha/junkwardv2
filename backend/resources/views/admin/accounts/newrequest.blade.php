                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="accounts_table">
                            ...
                            <tr>
                                ...
                                <th>Policy Number</th>
                                <th>Client Number</th>
                                <th>Client API Response</th>
                                <th>Client Created</th>
                                <th>Contract Number</th>
                                <th>Contract API Response</th>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            ...
            table.DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.realpay.request-data') !!}',
                order: [0, 'DESC'],
                columns: [
                    {data: 'id'},
                    {data: 'policy_id'},
                    {data: 'clientNumber'},
                    {data: 'client_response_sequence'},
                    {data: 'clientCreated'},
                    {data: 'contract'},
                    {data: 'contract_response_sequence'},
