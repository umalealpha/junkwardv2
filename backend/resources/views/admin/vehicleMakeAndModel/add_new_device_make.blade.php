        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Add New Vehicle Make</span>
                </div>
            </div>
        </div>
        <!-- end:: Subheader -->
...
{{--        </div>--}}
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="ruleCreate" action="{{ route('vehicle_make_model_store') }}"
                      method="POST" enctype="multipart/form-data" class="kt-form">
                    <!-- CSRF Token -->
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select name="s_VehicleType"  class="form-control kt_selectpicker" title="Select vehicle type" data-live-search="true">
                                    <option value="">Select Vehicle type</option>
                                    <option value="Sedan">Sedan</option>
                                    <option value="Coupe">Coupe</option>
                                    <option value="HatchBack">HatchBack</option>
                                    <option value="SUV">SUV/Pickup Truck</option>
                                </select>
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label  class="col-3 col-form-label">Vehicle Make Name:</label>
                            <div class="col-9">
                                <input  class="form-control" name="s_Make"  title="Name is required" placeholder="Please enter vehicle brand name">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                    </div>
