        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                ...
                <div class="kt-portlet">
                    <!--begin::Form-->
                    <form id="ruleEdit" action="{{ route('vehicle_make_model_update',$vehicleMakeModelEdit->id) }}"
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select class="form-control kt_selectpicker"  data-live-search="true" name="make_id">
                                        @foreach($vehicleMakeModel as $make_Model)
                                            {{-- @if($make_Model->s_Make == null || ($vehicleMakeModelEdit->s_Make == $make_Model->s_Make)) --}}
                                                <option value="{{$make_Model->s_Make}}" @if($vehicleMakeModelEdit->s_Make == $make_Model->s_Make) selected
                                                        @endif >{{$make_Model->s_Make}}</option>
                                            {{-- @endif --}}
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control kt_selectpicker" title="Please choose name" data-live-search="true" name="name" value="{{$vehicleMakeModelEdit->name}}">
                                    <span class="form-text text-muted"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    ...
                                    <select class="form-control kt_selectpicker entry_type" title="Please choose entry type"  id="device_type" name="device_type">
                                        <option value="Cellphone" @if($vehicleMakeModelEdit->device_type == 'Cellphone' ) selected @endif>Cellphone</option>
                                        <option value="Mobile" @if($vehicleMakeModelEdit->device_type == 'Mobile' ) selected @endif>Mobile</option>
                                        <option value="Laptop" @if($vehicleMakeModelEdit->device_type == 'Laptop' ) selected @endif>Laptop</option>
                                        <option value="Tablet" @if($vehicleMakeModelEdit->device_type == 'Tablet' ) selected @endif>Tablet</option>
                                    </select>
                                    <span class="form-text text-muted"></span>
                                </div>
                            </div>
