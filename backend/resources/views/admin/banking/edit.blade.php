    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="accountCreate" action="{{ route('admin.financialInterest.update',$banks->id) }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                    <input class="form-control" name="bank_name" value="{{ $banks->bank_name }}" placeholder="Enter Bank Name" title="Bank Name is required">
                                    <span class="form-text text-muted"></span>
                                
                            </div>
                        </div>
                        <div class="form-group row">
                            <label  class="col-3 col-form-label">Emails:</label>
                            <div class="col-9">
                            <textarea  class="form-control" title="Emails is required" name="emails" id="emails"  placeholder="Enter Emails" multiple>{!! $banks->emails!!}</textarea>
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('admin.financialInterest') }}" >Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
