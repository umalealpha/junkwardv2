                    ...
                    <div class="kt-portlet__body">
                        <table class="block block-rounded block-bordered table table-bordered" id="ruleDiv" >
                            ...
                            <tr style="height: auto!important;" class="fieldGroup">
                                <td>
                                    <select class="form-control kt_selectpicker" title="Please choose Device Make " data-live-search="true" name="make_id" >
                                        @foreach($deviceMake as $makeModel)
                                            <option value="{{$makeModel->id}}">{{$makeModel->name}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td>
                                    <input class="form-control kt_selectpicker" title="Please choose name" data-live-search="true" name="name">
                                </td>
                                <td>
                                    <select class="form-control kt_selectpicker entry_type" title="Please choose device type"  id="device_type" name="device_type">
