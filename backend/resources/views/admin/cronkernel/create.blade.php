                    ...
                    <div class="kt-portlet__body">
                        ...
                        <label for="example-text-input" class="col-3 col-form-label">Run Time</label>
                                ...
                                <div class="form-group ">
                                        <input type="time" class="form-control " name="run_time" value="" placeholder="Enter Development Emails">
                      ...
                      <div class="form-group row">
                            ...
                            <div class=" col-8" >
                                ...
                                <select class="form-control" id="run_on_server" name="run_on_server">
                                    <option value="bw_server">BW Main server</option> 
                                    <option value="cron_server" selected>Cron server</option>
