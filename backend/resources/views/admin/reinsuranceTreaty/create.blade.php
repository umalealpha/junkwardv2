                ...
                <form id="reinsuranceTreatyEdit" action="{{ route('admin.reinsuranceTreaty.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="provisional_commission" placeholder="Enter Provisional Commission" title="Provisional Commission">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="proportional_share" placeholder="Enter Proportional Share" title="Proportional Share">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="cash_loss_advise" placeholder="Enter Cash Loss Advise" title="Cash Loss Advise">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input  class="form-control" name="event_limit" placeholder="Enter Event Limit" title="Event Limit">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea class="form-control" name="exclusions" placeholder="Enter Exclusions" title="Exclusions"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control kt_datepicker_1" name="effectivefrom" autocomplete="off" placeholder="Select date"/>                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Effective to</label>
                            <div class="col-4">
                                <input type="text" class="form-control kt_datepicker_1" name="effectiveto" autocomplete="off" placeholder="Select date"/>                            </div>
                        </div>

{{--                        <div class="form-group row">--}}
{{--                            <label class="col-form-label col-lg-3 col-sm-12">Formula Attached</label>--}}
{{--                            <div class="col-lg-9 col-md-9 col-sm-12 form-group-sub">--}}
{{--                                <select class="form-control" name="formula" multiple size="5" title="Formula Attached is required">--}}
...
{{--                        </div>--}}
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3 col-sm-12">Formula Attached</label>
                            <div class="col-9">
                                <select class="form-control kt_selectpicker" name="formula[]" multiple title="Select Formula Attached">
                                    @foreach($reinsuranceformula as $reinsuranceformula)
                                        <option value="{{ $reinsuranceformula->id }}" >{{ $reinsuranceformula->formula_name }}</option>
                                    @endforeach
                                </select>
