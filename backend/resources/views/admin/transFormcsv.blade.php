    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="transFormsave" action="{{ route('transFormview') }}" method="POST" enctype="multipart/form-data" class="kt-form">
                    <!-- CSRF Token -->
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <a href="{{ URL::to('admin/reconsilation/dpoExport') }}" class="btn btn-sm btn-elevate btn-brand btn-elevate" id="" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Download"> <span class="kt-opacity-11" id="">Download</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">DPO Reconsilation Import</label>
                            <div class="col-9">
        ...
        <div class="kt-portlet__body">
            ...
            <div class="row">
                <div class="col-2">
                    ...
                    <select name="status_filter" class="select2 form-control" id="status_filter">
                        ...
                        <option style="text-transform: capitalize" value="Paid">Paid</option>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable" id="DPOPaymenttable">
                ...
                <tr>
                    ...
                    {{-- <th>Info status</th> --}}
                    <th>Reason</th>
                    <th>Graphite Amount</th>
                    <th>Graphite Date</th>
                    <th>Graphite Customer Email</th>
                    <th>Action</th>
                </tr>
                </thead>
            </table>
        ...
        var initTable1 = function() {
            table = $('#DPOPaymenttable').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'graphite_amount'
                    },
                    {
                        data: 'graphite_date'
                    },
                    {
                        data: 'graphite_cust_email'
                    },
                    {
                        data: 'actions'
                    },
