                ...
                <form id="cron"  action="{{ route('admin.cron.store') }}" method="POST" enctype="multipart/form-data" class="">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="cron_name" value=""  placeholder="Enter cron name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                    <input type="email" class="form-control col-11" name="production_emails[]" value="" placeholder="Enter Production Emails">
                        ...
                        <label for="example-text-input" class="col-3 col-form-label">Development Emails</label>
                                ...
                                <div class="form-group row">
                                        <input type="email" class="form-control col-11" name="development_emails[]" value="" placeholder="Enter Development Emails">
                                        <a href="javascript:void(0);" class="add_button2 col-1" title="Add field"><i class="fas fa-plus" style="font-size:23px;"></i></a>  
                                </div>
                                </div>
