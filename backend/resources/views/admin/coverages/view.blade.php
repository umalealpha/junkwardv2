                ...
                <form id="reinsuranceTreatyEdit" action="{{ route('admin.reinsuranceTreaty.update', $reinsurancetreaty->id) }}"
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control kt_datepicker_1" value="{!! $reinsurancetreaty->effective_from !!}" name="effectivefrom" autocomplete="off" placeholder="Select date"/>                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Effective to</label>
                            <div class="col-4">
                                <input type="text" class="form-control kt_datepicker_1" value="{!! $reinsurancetreaty->effective_to !!}" name="effectiveto" autocomplete="off" placeholder="Select date"/>                            </div>
                        </div>
