    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin.coverages.index')}}" class="kt-subheader__breadcrumbs-link"> Coverage </a> <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="reinsuranceTreatyEdit" action="{{ route('admin.coverages.update', $coverage->id) }}"
                    ...
                    <div class="kt-portlet__body">
                                <div class="form-group row" >
                                    ...
                                    <div class="col-9">
                                        <input  class="form-control" name="coveragename" value="{!! $coverage->name !!}" placeholder="Enter Coverage Name" title="Treaty Name is required">
                                ...
                                <div class="form-group row" >
                                    ...
                                    <div class="col-9">
                                        <input  class="form-control" name="code"  placeholder="Enter Code" title="Code is required" value="{!! $coverage->code !!}">
                                    </div>
                                </div>  
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-3 col-form-label">Effective From</label>
                                    <div class="col-4">
                                        <input type="text" class="form-control kt_datepicker_1" value="{!! $coverage->effective_from !!}" name="effectivefrom" autocomplete="off" placeholder="Select date"/>                            </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-3 col-form-label">Effective to</label>
                                    <div class="col-4">
                                        <input type="text" class="form-control kt_datepicker_1" value="{!! $coverage->effective_to !!}" name="effectiveto" autocomplete="off" placeholder="Select date"/>                            </div>
                                </div>
                                <div class="form-group row" style="margin-top: 1%">
                                    ...
                                    <div class="col-9">
                                        <span class="kt-switch" >
                                            <label>
                                                <input id="switchValue" type="checkbox" @if($coverage->status) checked="checked" @endif name="status" value="1" onchange="statusMsg()">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('admin.coverages.index') }}" >Cancel</a>
                                </div>
                            </div>
