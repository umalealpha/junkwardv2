        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">New Otp</span>
                </div>
            </div>
        </div>
        <!-- end:: Subheader -->
                    ...
                    <div class="kt-portlet__body">
                            <div class="row">
                                <div class="form-group col-6">
                                    <label for="otp" class="col-3 col-form-label">OTP</label>
                                    <label><h4>{{ isset($otp) && $otp != null ? $otp->otp :  null }}</h4></label>
                                  
                                </div>
                                <div class="form-group col-6">
                                    <label for="otp" class="col-3 col-form-label">Exp Date</label>
                                    <label><h4>{{ isset($otp) && $otp != null ? Carbon::parse($otp->otp_exp)->format('d/m/Y H:i:s') :  null }}</h4></label>
                        ...
                        <div class="kt-portlet__foot kt-portlet__foot--solid">
                            <div class="kt-form__actions">
                                <div class="row">
                                    <div class="col-3"></div>
                                    <div class="col-9">
                                    <form action="{{ route('saveOTP') }}"
                      method="POST" enctype="multipart/form-data" class="kt-form">
                    <!-- CSRF Token -->
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    <button type="submit" id="btn-submit" class="btn btn-brand">Refresh</button>
