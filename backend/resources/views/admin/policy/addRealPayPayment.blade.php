                                    ...
                                    <tr>
                                        ...
                                        <td width="50%">
                                            {{-- @isset($premium->new_value) --}}
                                                @if (isset($premium->new_value) && $policy_renewal->rerate_update_renewal_rates == 1)
                                                    {{ $premium->new_value }}
                                                    {{-- <input type="hidden" name="new_premium" value="{{ $premium->new_value }}"> --}}
                                                @elseif (isset($premium->new_value) && isset($reinstate_type) && $reinstate_type == 'reinstate_fresh')
                                                    {{ $premium->new_value }}
                                ...
                                <div class="kt-portlet__body" id="paymentInfoDiv">
                                    ...
                                    @else
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input  class="form-control" name="premium" readonly id="premium" value="{{$policy->premium}}" title="Please provide premium" placeholder="Please provide premium">
                                                <span class="labelled" id="paymentNote" style="color: red;"></span>
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
