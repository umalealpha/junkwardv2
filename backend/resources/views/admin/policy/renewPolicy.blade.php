                        ...
                        <div class="kt-portlet__body">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="policy_table3">
                                ...
                                <tr>
                                    <th>Old Frequency:</th>
                                    <td width="50%">
                                        @if($policy_premium->premium_freq == 1) Monthly
                                        @elseif($policy_premium->premium_freq == 2) Three Installments
                                        @elseif($policy_premium->premium_freq == 3) Annual
                                        @else N/A
                                        @endif
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="50%">
                                        {{-- @isset($premium->new_value) --}}
                                            @if (isset($premium->new_value) && $data->rerate_update_renewal_rates == 1)
                                                {{ $premium->new_value }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-7">
                                    @can('policy_create_new_term')
                                    {{-- @if(auth()->user()->hasRole(['Super Admin'])) --}}
                                        <a href="{{ route('admin.policy.createNewTerms', $data->policy_id) }}" class="btn btn-success">Create Renew Terms</a>
                                    {{-- @endif --}}
                                    @endcan
