                ...
                <div class="kt-portlet_body">
                    <div class="kt-section">
                        <div class="kt-section__content" style="padding-left:20px; padding-right: 20px;">
                            ...
                            <form class="calculate kt-form" id="calculate_submit" enctype="multipart/form-data" action="{{ URL::to('creditNoteStatement',[$policy->id,$ledger->id]) }}"  method="POST">
                ...
                $("#calculateDays").on("click", function() {
                    ...
                    $('#new_calculation').show();
                        ...
                        if(document.getElementById('chkYes').checked) {
                            ...
                            if($("#calculate").valid()){
                                var date1 = "{{ Carbon::parse($ledger->invoice_date)->format('d/m/Y') }}";
