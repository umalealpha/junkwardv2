            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a class="kt-subheader__breadcrumbs-separator"><span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Edit</span> </a>
                    </div>
                </div>
            </div>
            <!-- end:: Subheader -->
            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        ...
                        <br>
                        <form id="policyForm1" action="{{ route('admin.policy.policyTermUpdateData') }}" method="POST" enctype="multipart/form-data" class="kt-form">

                            <!-- CSRF Token -->
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <input type="hidden" id="term_id" name="term_id" value="{{ $policy_term->id }}" />
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="policy_table3">
                                ...
                                <tr>
                                    ...
                                    <td width="50%">
                                        <input type="text" class="form-control kt_datepicker_1 required validateGroup1" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $policy_term->term_start_date)->format('d-m-Y') }}"
                                            name="term_start_date" id="term_start_date" autocomplete="off" placeholder="Select term start date" />
                                ...
                                <tr>
                                    <th>Term End Date:</th>
                                    <td width="50%">
                                        <input type="text" class="form-control kt_datepicker_1 required validateGroup1" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $policy_term->term_end_date)->format('d-m-Y') }}"
                                            name="term_end_date" id="term_end_date" autocomplete="off" placeholder="Select term end date" />
                                            <span class="form-text text-muted"></span>
                                ...
                                <tr>
                                    <th>Premium:</th>
                                    <td width="50%">
                                        {{-- <input type="number" class="form-control" value="{{ $policy_term->premium }}" name="premium" id="premium" title="Please provide the premium" placeholder="Please provide premium"/> --}}
                                ...
                                <tr>
                                    <th>Frequency:</th>
                                    <td width="50%">
                                        {{-- <select class="select2 form-control kt_selectpicker" name="frequency" id="frequency" data-live-search="true" title="Select frequency">
                                            <option value="">Select payment frequency</option>
                                            <option value="1" @if($policy_term->frequency == 1) selected @endif>Monthly Installments</option>
                                            <option value="2" @if($policy_term->frequency == 2) selected @endif>Three Installments in a year</option>
                                            <option value="3" @if($policy_term->frequency == 3) selected @endif>Annual Installment</option>
                                        </select> --}}
                                ...
                                <tr>
                                    <th>First Premium:</th>
                                    <td width="50%">
                                        {{-- <input type="number" class="form-control" value="{{ $policy_term->first_premium }}" name="first_premium" id="first_premium" title="Please provide the first premium" placeholder="Please provide first premium"/> --}}
                                ...
                                <tr>
                                    ...
                                    <td width="50%">
                                        {{-- <input type="text" class="form-control kt_datepicker_1 required validateGroup1" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $policy_term->billing_start_date)->format('d-m-Y') }}"
                                            name="billing_start_date" id="billing_start_date" autocomplete="off" placeholder="Select billing start date" />
                                            <span class="form-text text-muted"></span> --}}
                                ...
                                <tr>
                                    ...
                                    <td width="50%">
                                        {{-- <input type="text" class="form-control kt_datepicker_1 required validateGroup1" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $policy_term->policyActivatedDate)->format('d-m-Y') }}"
                                            name="policyActivatedDate" id="policyActivatedDate" autocomplete="off" placeholder="Select policy Activated date" />
                                            <span class="form-text text-muted"></span> --}}
                                ...
                                <tr>
                                    <th></th>
                                    <td width="50%">
                                        <button type="submit" class="btn btn-info" id="updateTermDates">Update</button>
...
<script>
    $("#policyForm1").validate({
            ...
            messages: {
                term_start_date: {
                    required: 'Please select term start date.'
                },
                term_end_date: {
                    required: 'Please select term end date.'
                },
            },
