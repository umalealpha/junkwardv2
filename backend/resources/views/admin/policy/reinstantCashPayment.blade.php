                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        <div style="margin-bottom:2%" id="rerate_div">
                            <form id="policyForm1" action="{{ route('admin.policy.addCashPaymentPolicyReinstate') }}" method="POST" enctype="multipart/form-data" class="kt-form">
                                <!-- CSRF Token -->
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                <input type="hidden" name="policyNumber" value="{{ $policy->policyNumber }}" />
                                <input type="hidden" name="policy_id" value="{{ $policy->id }}" />
                                <input type="hidden" name="paymentMethod" value="Cash" />
                                <input type="hidden" name="new_premium" value="{{ $new_premium }}">
                                <input type="hidden" name="term_start_date" value="{{ $term_start_date }}">
                                <input type="hidden" name="agent_id" value="{{ $agent_id }}">
                                <input type="hidden" name="paymentAmount" value="{{ $balance }}" >
                                <input type="hidden" name="reinstate_type" value="{{ $reinstate_type }}">
                                <div class="kt-portlet__body">
                                    <div class="form-group row" id="payWithCashAlreadyDoneReinstate">
                                        ...
                                        <div class="col-9">
                                            <span class="kt-switch">
                                                <label>
                                                    <input id="cashPaymentDoneReinstate" type="checkbox" name="cashPaymentDoneReinstate" value="1"
                                                        onchange="addPaymentButtonCashAlreadyDoneReinstate()" title="Please select payment">
                                                    <span style="margin-top: 5px;margin-left: 10px;"></span>
                                                    <h4 id="paymentMsgCashDoneReinstate"
                                    ...
                                    <div class="form-group row" id="addPaymentButtonCashAlreadyDoneReinstate" style="display: none;">
                                        <div class="kt-portlet__body">
                                            <div class="form-group row">
                                                <label class="col-3 col-form-label">Please select Payment :</label>
                                                <div class="col-9">
                                                    <select id="selectPaymentDataReinstate" class="form-control kt_selectpicker"
                                                        title="Please select payment" name="selectPaymentDataReinstate">
                                    ...
                                    <div id="cashPaymentForm">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control required validateGroup1" name="paymentAmount" value="{{ $balance }}" disabled title="Please provide amount" placeholder="Please provide amount">
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        {{-- <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control required validateGroup1" name="numberOfInstallmentsPaid" value="" title="Please provide the number of Installments paid" placeholder="Please provide the number of Installments paid">
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div> --}}
                                    ...
                                    <div class="form-group row" id="paymentRealpayDiv">
                                ...
                                <div class="kt-portlet__body" id="paymentInfoDiv" style="margin-top:-50px !important;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <select id="RPBanks" class="form-control required kt_selectpicker" title="Please select bank" name="RPBanks">
                                                ...
                                                <option value="{{ $bank->bank_number }}" @if($banking->bankName
                                                    == $bank->bank_number) selected  @endif>{{ $bank->bank_name }}</option>
                                                @endforeach
                                        ...
                                        <div class="col-9">
                                            <select id="RPBankBranch" class="form-control required kt_selectpicker" title="Please select bank branch" name="RPBankBranch">
                                                @isset($branches)
                                                    ...
                                                    <option value="{{ $branch->branch_id }}" @if($banking->branchCode
                                                        == $branch->branch_id) selected  @endif>{{ $branch->name }}</option>
                                                    @endforeach
                                                @endisset
                                            </select>
                                            <span class="form-text text-muted"></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <select id="RPBankBranch" class="form-control required kt_selectpicker" title="Please select account type" name="accountType">
                                                <option value="1" @if($banking->accountType == 1) selected  @endif>Cheque</option>
                                                <option value="2" @if($banking->accountType == 2) selected  @endif>Savings</option>
                                            </select>
                                            <span class="form-text text-muted"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control required validateGroup1" name="accountNumber" value="{{ $banking->accountNumber }}" title="Please provide account number" placeholder="Please provide account number">
                                            <span class="form-text text-muted"></span>
                                        </div>
                                    </div>
                                </div>
...
<script>
    function addPaymentButtonCashAlreadyDoneReinstate() {
        var isChecked = document.getElementById("cashPaymentDoneReinstate").checked;

        if (isChecked) {
            $('#addPaymentButtonCashAlreadyDoneReinstate').css('display','block');
            $('#paymentRealpayDiv').css('display','none');
            $('#cashPaymentForm').css('display','none');
            document.getElementById("paymentMsgCashDoneReinstate").innerHTML = "Yes";
            document.getElementById("paymentMsgCashDoneReinstate").style.color = "cornflowerblue";
        } else {
            $('#addPaymentButtonCashAlreadyDoneReinstate').css('display','none');
            $('#paymentRealpayDiv').css('display','block');
            $('#cashPaymentForm').css('display','block');
            document.getElementById("paymentMsgCashDoneReinstate").innerHTML = "No";
            document.getElementById("paymentMsgCashDoneReinstate").style.color = "#ff4d4d";
        }
    }
