            ...
            <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                <div class="row ol-lg-12">
                    <div class=" col-lg-3 text-left policyno">
                        <h5> Policy No<span class="kt-badge  kt-badge--info kt-badge--inline kt-badge--pill"  style="font-size:15px"> # {{$data->policyNumber}}</span>
                        </h5> <br>
                    </div>
                </div>
                <br>
                                ...
                                <h3 class="kt-portlet__head-title">Customer Details
                                    @if ($data->product_id == 3)
                                        <a href="{{ route('admin.policy.applyCustomRate',$data->policy_id) }}">
                                            <button class="btn btn-info" id="submit_custom_rate" style="float: right;">Apply Custom Rate</button>
                                        </a>
                                    @endif
                                </h3>
                            </div>
                                  ...
                                  <th>
                                   ...
                                   <td>
                                        <form  action="{{route('admin.policy.reinstantPaymentMethod')}}" method="POST">
                                            ...
                                            <input type="hidden" name="balance" value= @if(isset($balance->balance)) {{number_format(abs($balance->balance), 2, '.', '')}} @else 0 @endif>
                                            ...
                                            <div>
                                                ...
                                                <button type="submit" name="action"  class="btn btn-info " value="realpay" id="submit_realpay_button">Pay with Realpay</button>
                                                <button type="button" name="action"  class="btn btn-info " value="dpo" id="submit_dpo_button">collect payment on pay.alphadirect.co.bw</button>
...
<script>
    $(document).ready(function () {
        ...
        $('#submit_dpo_button').on('click', function() {
            ...
            var   note         = '';
            var   type         =  'reinstate_arrears'; //'reinstateAreas';
