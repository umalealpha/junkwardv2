        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Leads</span>
                </div>
            </div>
...
<script>
    ...
    $("#leads_table").on("click", "a.confirm-delete" , function(event) {
        event.preventDefault();
        var leadId = $(this).attr('value');
        $.ajax({
            url: '{{ route('lead.confirm-delete') }}',
            data: {
                "_token": "{{ csrf_token() }}",
                "id": leadId
            },
            ...
            success: function(data) {
                ...
                var append = '<div class="modal-header"><h5 class="modal-title" id="exampleModalLabel">Delete Lead</h5>' +
