            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Reinstant Policy</span> </a>
                    </div>
                </div>
            </div>
            <!-- end:: Subheader -->
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body">
                        <div style="margin-bottom:2%" id="rerate_div">
                            <form id="policyForm1" action="{{ route('admin.policy.addRealPayPaymentPolicyReinstate') }}" method="POST"
                                ...
                                <input type="hidden" name="new_premium" id="new_premium" value="{{ $new_premium }}">
                                ...
                                <input type="hidden" name="trans_type" value="reinstate">
                                ...
                                <div class="kt-portlet__body" id="paymentInfoDiv">
                                    ...
                                    @if ($policy->product_id == 3)
                                        ...
                                        <div class="form-group row" id="first_premium_row">
                                            ...
                                            <div class="col-9">
                                                <input  class="form-control" name="first_premium" readonly value="{{ $balance }}" id="first_premium" title="Please provide first premium" placeholder="Please provide premium">
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    @if ($policy->product_id == 3)
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input  class="form-control" name="premium" readonly id="premium" title="Please provide premium" placeholder="Please provide premium">
                                    ...
                                    @else
                                        <div class="form-group row">
                                            <label  class="col-3 col-form-label">Premium :</label>
                                            <div class="col-9">
                                                <input  class="form-control" name="premium" value="{{$policy->premium}}" readonly id="premium" title="Please provide premium" placeholder="Please provide premium">
                                                <span class="labelled" id="paymentNote" style="color: red;"></span>
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control required validateGroup1" name="accountNumber" value="{{ $banking->accountNumber }}"
