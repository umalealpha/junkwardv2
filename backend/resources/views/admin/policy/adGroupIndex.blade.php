        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                ...
                <div class="kt-subheader__toolbar">
                    ...
                    @endcan--}}
                    <div class="kt-subheader__wrapper">
                        <a href="{{ route('admin.policy.generateUserPoliciesPDF') }}" class="btn btn-sm btn-elevate btn-success btn-elevate" id="" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Generate PDF Report"> <span class="kt-opacity-11" id="">Generate PDF Report</span>&nbsp; <i class="flaticon2-download kt-padding-l-5 kt-padding-r-0"></i> </a>
                    </div>
                    <div class="kt-subheader__wrapper">
                        <button class="btn btn-sm btn-elevate btn-info btn-elevate" id="generateQuoteBtn" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Generate Quote"> <span class="kt-opacity-11" id="">Generate Quote</span>&nbsp; <i class="flaticon2-file kt-padding-l-5 kt-padding-r-0"></i> </button>
                    </div>
                    @can('policy-archive')
                    <div class="kt-subheader__wrapper">
...
<div class="modal fade" id="generateQuoteModal" tabindex="-1" role="dialog" aria-labelledby="generateQuoteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label>Filter By Employer Group</label>
                        <select class="form-control" id="employerGroupFilter">
                            <option value="">All Employer Groups</option>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        ...
        var initTable1 = function() {
            table = $('#policy_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('admin.policy.adGroupPolicyData') !!}',
                    data: function (d) {
...
$('#employerGroupFilter, #quotePolicyStatusFilter').on('change', function() {
    loadQuoteData();
});
...
function loadQuoteData() {
    ...
    $.ajax({
        url: '{{ route("admin.policy.getQuoteData") }}',
        method: 'GET',
        data: {
...
$('#generateQuoteReport').on('click', function() {
    ...
    var form = $('<form>', {
        'method': 'POST',
        'action': '{{ route("admin.policy.generateQuoteReport") }}',
        'target': '_blank'
    });
