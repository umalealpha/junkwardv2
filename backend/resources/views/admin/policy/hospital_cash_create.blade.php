<form id="storeHospitalCashClaim" action="{{ route('admin.policy.storeClaim') }}" method="POST" enctype="multipart/form-data" class="kt-form">
    {{csrf_field()}}
        ...
        <div class="col-9">
            <div class="kt-radio-inline">
                <label class="kt-radio">
                    <input type="radio" name="is_botswana_citizen" id="is_botswana_citizen_yes" value="yes"> Yes
                    <span></span>
                </label>
                <label class="kt-radio">
                    <input type="radio" name="is_botswana_citizen" id="is_botswana_citizen_no" value="no"> No
                    <span></span>
                </label>
            </div>
        </div>
    </div>
    <div class="form-group row" id="omang_field" style="display: none;">
        <label for="patient_omang" class="col-3 col-form-label">Omang:</label>
        <div class="col-9">
            <input type="text" id="patient_omang" name="patient_omang" class="form-control" autocomplete="off" placeholder="Enter Omang number">
        </div>
    </div>
    <div class="form-group row" id="passport_field" style="display: none;">
        <label for="patient_passport" class="col-3 col-form-label">Passport:</label>
        <div class="col-9">
            <input type="text" id="patient_passport" name="patient_passport" class="form-control" autocomplete="off" placeholder="Enter Passport number">
        </div>
    </div>
    <!-- Hidden field to store the selected value -->
    <input type="hidden" id="patient_identity_number" name="patient_identity_number" value="">
    <div class="form-group row">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const hospitalCashForm = document.getElementById('storeHospitalCashClaim');
