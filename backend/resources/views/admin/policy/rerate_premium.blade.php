            ...
            <table class="table table-striped table-bordered table-hover table-checkable"
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        @if ($user->profile->dob)
                            <td width="50%">
                                <input type="text" required class="form-control kt_datepicker_1_rerate dob"
        ...
        <form id="updateVehicleDetails" action="" method="POST" enctype="multipart/form-data"
            ...
            <table class="table table-striped table-bordered table-hover table-checkable"
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td width="50%" height="72px">
                            <select class="form-control " required name="model"
                                ...
                                <option value="vehicle_rerate_other_model" class="vehicle_rerate_other_model">Other Model</option>

                            </select>

                            <div id="vehicle_rerate_otherModel_div" style="display: none;">
                                <input  class="form-control" id="vehicle_rerate_otherModel" name="vehicle_rerate_otherModel"  value="" title="Please provide vehicle other model" placeholder="Please provide vehicle other model">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="50%">
                            <select class="form-control " required name="year"
                                title="Please select manufacturing year"
                                id="year_rerate">
                    ...
                    <tr id="model_Variant_div" @if($premiumCalcDetails->is_imported == 'Yes') style="display: none" @endif>
                                    <th>Variant:</th>
                                    <td width="50%">
                                    <select class=" form-control" id="variant_rerate" name="variant" >
                                    <option value="">Select Variant</option>
                                    @if($premiumCalcDetails->is_imported == 'No')
                                    @if(isset($premiumCalcDetails->variant))
                                    <option value="{{ $premiumCalcDetails->variant }}" selected>{{$premiumCalcDetails->variant}}</option>
                                    @endif
                                    @endif
        ...
        <div style="margin-bottom:2%; display: none;" id="new_rate_div">
            ...
            {{-- <form id="newPremiumRate"
                ...
                <div class="form-group row" id="add_custom_rate">
                    ...
                    <div class="col-3">
                        <span class="kt-switch">
                            <label>
                                <input id="customDiscountSurchargeValue" type="checkbox" name="customAddDiscSurc" value="1"
                                    onchange="customDiscountSurcharge()">
                ...
                <form id="newPremiumRate" action="{{ route('admin.policy.acceptReratedPremium', $policy->policyNumber) }}"
                    ...
                    <div class="form-group row">
                        <div class="col-6">
                            <h5><input id="rerate_without_payment" type="checkbox" name="rerate_without_payment" value="1" onchange="rerateWithoutPayment()">
                            Rerate without changing premium and payment contract ? </h5>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-4">
                            <h5><input id="rerate_update_renew_term" type="checkbox" name="rerate_update_renew_term" value="1">
                            Apply rates to current term ?</h5>
                        </div>
                        {{-- <div class="col-6">
                            <div id="selectTermToUpdateDiv" style="display: none;">
                                <select class="form-control kt_selectpicker" required name="termDataUpdate"
                                    title="Please select term" data-live-search="true" id="termDataUpdate">
                                    @foreach ($termData as $key => $term)
                                        <option value="{{ $term->id }}">
                                            {{ $term->term_start_date }} - {{ $term->term_end_date }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div> --}}
                    ...
                    <div class="form-group row">
                        <div class="col-4">
                            <h5><input id="rerate_update_renewal_rates" type="checkbox" name="rerate_update_renewal_rates" value="1" onchange="applyRerateRatesToRenewal()">
                            Apply rates to renewal ?</h5>
                        </div>
                    </div>
                    <br><br>
                    <div>
