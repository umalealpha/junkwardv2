                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input id="passport" type="text" class="form-control id-type validateGroup1 passport" name="passport" placeholder="Please enter passport number" maxlength="20" minlength="3">
