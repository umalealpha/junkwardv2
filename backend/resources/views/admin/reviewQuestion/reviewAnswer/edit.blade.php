    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="regionCreate" action="{{ route('admin.review.answers.store') }}"
                    ...
                    <div class="kt-portlet__body"> 
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Select Question</label>
                                <div class="col-9">
                                    <select class="form-control kt_selectpicker" id="question" title="Please Choose Risk"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                            <input  class="form-control" name="answer" value="{{ $answer->answers}}" title="Answer is required" placeholder="Enter Answer">
