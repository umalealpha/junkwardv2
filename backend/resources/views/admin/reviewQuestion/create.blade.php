    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin-dashboard')}}" class="kt-subheader__breadcrumbs-link"> Dashboard </a> <span class="kt-subheader__breadcrumbs-separator"></span> <a href="{{Route('admin.review.index')}}" class="kt-subheader__breadcrumbs-link"> Question </a> <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet">
                <!--begin::Form-->
                <form id="regionCreate" action="{{ route('admin.review.question.store') }}"
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input  class="form-control" name="question" title="Question is required" placeholder="Enter Question">
                        ...
                        <div class="form-group row {{ $errors->has('answer_type') ? 'has-error' : ''}}">
                            ...
                            <div class="col-6">
                                <select class="form-control kt_selectpicker" id="answer_type" title="Please choose element"
                                        ...
                                        <option value="{{$answer_type->id}}">{{$answer_type->type}}</option>
                                    @endforeach
                                </select>  
                        ...
                        <div class="form-group row">
                            ...
                            @foreach($reviewPages as $pages) 
                                <div class="col-sm-3 kt-checkbox-inline"> 
                                    ...
                                    <input type="checkbox" class="input-group kt-group-checkable" value="{{ $pages->id }}" id="{{ $pages->name }}" name="reviewPage[]"> 
                                        <span></span> 
                                    </label> 
