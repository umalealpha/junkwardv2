            ...
            <!-- begin:: Page -->
                        ...
                        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                            ...
                            <div class="col-lg-3 text-center policyno">
                             <a href="{{Route('EditCustomerDetails',['id'=>$userDetails->id])}}">
                             <button class="btn btn-info" type="button">Edit {{$userDetails->firstName}}'s Details</button>
                            </a>
                            </div>
							...
							<tr>
								<th>Billing Date</th>
								<td>{{$customerBanking->created_at->format('d M Y')}}</td>
							  </tr>
							  <tr>
								<th>Billing Cell</th>
								<td>Monthly</td>
