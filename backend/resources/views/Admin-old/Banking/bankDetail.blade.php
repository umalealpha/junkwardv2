                                           ...
                                           <div class="col-lg-12 newsearch1"> 
                                             <form class="navbar-form navbar-search" role="search">
                                                                     ...
                                                                     <button type="button" class="btn btn-outline-hover-secondary" disabled="disabled"><i class="fa fa-search"></i></button>
                                                                         <input type="text" class="form-control" name="query" id="query" placeholder="Search Banks Here">
  ...
  columns: [
    {
      ...
      template: function(row, index, datatable) {
        return row['ns0:bankName'];
       /* return datatable.dataSet[index-1]!=null?datatable.dataSet[index]['ns0:bankName'] == datatable.dataSet[index-1]['ns0:bankName']?"-----------":row['ns0:bankName']:row['ns0:bankName'];*/
      },
    },
    {
      field: 'bankBranchDesc',
      title: 'Branch Name',
      template: function(row, index, datatable) {
       
        return row['ns0:bankBranchDesc'].split("-").length>=2?row['ns0:bankBranchDesc'].split("-")[1].trim():row['ns0:bankBranchDesc'];
      },
    },
    {
      field: 'bankBranchNum',
