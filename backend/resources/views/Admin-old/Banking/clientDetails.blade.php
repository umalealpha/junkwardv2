                                           ...
                                           <div class="col-lg-12 newsearch1"> 
                                             <form class="navbar-form navbar-search" role="search">
                                                                     ...
                                                                     <button type="button" class="btn btn-outline-hover-secondary" disabled="disabled"><i class="fa fa-search"></i></button>
                                                                         <input type="text" class="form-control" name="query" id="query" placeholder="Search Clients Here">
  ...
  columns: [
...

    {
      ...
      template: function(row, index, datatable) {
        ...
        let fnb = 'FNB Botswana';
        let CBB = 'Captial Bank Botswana';
        let BG = 'Bank Gaborone';
        let BB = 'Barclays Botswana';
        let SB = 'Stanbic Botswana';
        let BA = 'Bank ABC';
        let SCB = 'Standard Chartered Botswana';

        if(row['ns0:bankNum'] == 12 ){
        return fnb;
        }

        if(row['ns0:bankNum'] == 17 ){
        return CBB;
        }
        if(row['ns0:bankNum'] == 18 ){
        return BG;
        }
        if(row['ns0:bankNum'] == 14 ){
        return BB;
        }
        if(row['ns0:bankNum'] == 13 ){
        return SB;
        }
        if(row['ns0:bankNum'] == 15 ){
        return BA;
        }
        if(row['ns0:bankNum'] == 19 ){
        return SCB;
        }
    ...
    return '<div class="dropdown ' + dropup + '">\
                        ...
                        <div class="dropdown-menu dropdown-menu-right">\
                            <a class="dropdown-item" href="EditClients?id='+row['ns0:clientNumber']+'"><i class="la la-folder-open"></i>Edit Client RealPay Billing</a>\
                        </div>\
                    </div>\
                    ';
