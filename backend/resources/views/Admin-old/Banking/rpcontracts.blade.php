                                           ...
                                           <div class="col-lg-12 newsearch1"> 
                                             <form class="navbar-form navbar-search" role="search">
                                                                     ...
                                                                     <button type="button" class="btn btn-outline-hover-secondary" disabled="disabled"><i class="fa fa-search"></i></button>
                                                                         ...
                                                                         <input type="text" class="form-control" name="query" id="query" placeholder="Search Contracts Here">
                                                                             ...
                                                                             <div class="col">
                                                                                 <!-- <div class="dropdown">
                                                                                     ...
                                                                                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="right" data-skin="dark" data-container="body" data-original-title="Tooltip title">Bank Name</a>
                                                                                         <a class="dropdown-item" href="#">Bank ID</a>
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Tooltip title">Bank Location</a>
                                                                                     </div>
                                                                                 </div> -->
                                                                             </div>
                                                                         </div>
                                ...
                                <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                                    ...
                                    <div class="kt-portlet kt-portlet--height-fluid">
                                        ...
                                        <div class="kt-portlet__body kt-portlet__body--fit">
                                            ...
                                            <div class="kt-datatable" id="bankDt"></div>
                                        </div>
                                    </div>
                                    <!--end::Portlet-->
...
var datatable = $('#bankDt').KTDatatable({
  ...
  data: {
    ...
    source: {
      read: {
        method:'GET',
        url: urlValue+'realpay/getContracts', 
        map: function(raw) {
  ...
  columns: [
    ...
    //  return ''+row['ns0:clientNumber']+'';
        return '<a href="ClientsContracts?id='+row['ns0:contractNumber']+'">'+row['ns0:clientNumber']+'</a>';
    ...
    },
    {
      ...
      template: function(row, index, datatable) {
        ...
        return '<a href="ClientsContracts?id='+row['ns0:contractNumber']+'">'+row['ns0:contractNumber']+'</a>' ;
    ...
    },
    {
      ...
      template: function(row, index, datatable) {
        ...
        return row['ns0:firstActionDate'];
      },
    },
    {
      ...
      template: function(row, index, datatable) {
          ...
          if(row['ns0:installmentFrequency'] == 'M' ){
        return M;
        }
        if(row['ns0:installmentFrequency'] == 'W' ){
        return W;
        }
        if(row['ns0:installmentFrequency'] == 'F' ){
        return F;
        }
      },
    },
  /*  {
      ...
      template: function(row, index, datatable) {
        ...
        $('.billingCheck').on('click', function() {
             ...
             var bankNum = $(this).data("id");

                 $.post("{{Route('BankStore')}}", {"quickVar1a": bankNum}, 
                      function(data) {

                          $('#quickVar1a').html(data);
                          
                          });
                });

        return '<div class="custom-control custom-switch"><input type="checkbox" checked data-id="'+row['ns0:bankNum']+'" class="custom-control-input billingCheck '+row['ns0:bankNum']+'" id="customSwitches'+row['ns0:bankNum']+'"> <label class="custom-control-label" for="customSwitches'+row['ns0:bankNum']+'">\
        </label> </div>';
      },
    },*/
    /*{
    ...
    return '<div class="dropdown ' + dropup + '">\
                        ...
                        <div class="dropdown-menu dropdown-menu-right">\
                            <a class="dropdown-item" href="ClientsContracts?id='+row['ns0:contractNumber']+'"><i class="la la-folder-open"></i>Edit Clients Installments</a>\
                        </div>\
                    </div>\
                    ';
