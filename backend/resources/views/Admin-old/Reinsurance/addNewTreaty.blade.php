                                        ...
                                        <div class="kt-portlet__head">
                                            <div class="kt-portlet__head-label">
                                                <h3 class="kt-portlet__head-title">
                                                    Search For a Reinsurance Treaty
                                                </h3>
                                            </div>
                                        </div>
                                                                             ...
                                                                             <div class="col">
                                                                                 <div class="dropdown">
                                                                                     ...
                                                                                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="right" data-skin="dark" data-container="body" data-original-title="Tooltip title">Treaty Name</a>
                                                                                         <a class="dropdown-item" href="#">Treaty Number</a>
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Tooltip title">Treaty Formula</a>
                                                                                     </div>
                                                                                 </div>
                                                                             </div>
                                                                         </div>
                                                                         <div class="input-group-btn">
                                                                            <button type="button" class="btn btn-outline-hover-danger"><i class="fa fa-search"></i> Go</button>
                                                                         </div>
                                                                     </div>
                                                                 </form>                                                      </div>
                                        </div>
                                ...
                                <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                                    ...
                                    <div class="kt-portlet kt-portlet--height-fluid">
                                                    ...
                                                    <div class="kt-form__group kt-form__group--inline kt-margin-r-10">
                                                        ...
                                                        <div class="kt-form__control" style="width: 160px;">
                                                            <select class="form-control bootstrap-select" id="kt_form_status" title="Status">
                                                                ...
                                                                <option value="2">Treaty Name</option>
                                                                <option value="3">Treaty Number </option>
                                                                <option value="4">Treaty Formula</option>
                                                                
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <button type="button" class="btn btn-outline-brand" ><a href="{{Route('addNewTreaty')}}" class="kt-nav__link"><i class="flaticon2-add-circular-button"></i></a></button>
                                        ...
                                        <div class="kt-portlet__body kt-portlet__body--fit">
                                            ...
                                            <div class="kt-datatable" id="treaties"></div>
                                        </div>
                                    </div>
                                    <!--end::Portlet-->
                                </div> 
 ...
 <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-xl">
     <div class="modal-content">
        ...
        <h5 class="modal-title">Add Treaty</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
        </div>
        <form action="{{Route('saveTreaty')}}" method="POST">
                {{ csrf_field() }}
        <div class="modal-body">
            <div class="row">
				  <div class="col-md-6 form-group">
						<label>Treaty Name :</label>
						<input type="text" class="form-control" name="treatyName" aria-describedby="emailHelp" placeholder="Treaty Name" required> 
					</div>
			
                    <div class="col-md-6 form-group">
						<label>Treaty Number :</label>
						<input type="text" class="form-control" name="treatyNumber" aria-describedby="emailHelp" placeholder="Treaty Number" required> 
					</div>
              </div>
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
						<label for="exampleSelect1">Treaty Status:</label>
                       ...
                       <div class="col-md-6 form-group">
						<label for="exampleSelect1">Formula:</label>
							<select class="form-control" name="formula" id="exampleSelect1">
...
var datatable = $('#treaties').KTDatatable({
  ...
  columns: [
    
    {
    ...
    },
     {
      ...
      title: 'Treaty Number',
      template: function(row, index, datatable) {
        return row.treatyNumber;
      },
    },
    {
      field: 'formula',
      title: 'Treaty Formula',
      template: function(row, index, datatable) {
        return row.formula;
      },
    },
