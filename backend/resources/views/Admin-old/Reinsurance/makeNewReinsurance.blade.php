                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                        ...
                                        <form id="kt_form" name="TreatyForm" class="kt-form" action="" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                            <!--begin: Form Wizard Step 1-->
                                            <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current" style="width:80%">
                                               <h3 class="kt-section__title" >New Reinsurance Treaty Form</h3>
                                                <div class="kt-heading kt-heading--md">Reinsurance Treaty Details</div>
                                                <div class="kt-separator kt-separator--height-xs"></div>
                                                <div class="kt-form__section kt-form__section--first">
                                                  <div class="row">
                                                    <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Reinsurance Treaty Name</label>
                                                        <input type="text" class="form-control" name="rtname" placeholder="Name" title="Reinsurance Treaty Name" pattern="[A-Za-z]{1,25}" maxlength="25" required> 
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Reinsurance Treaty Number</label>
                                                        <input type="text" class="form-control" name="rttelephone" placeholder="Telephone Number" title="Reinsurance Treaty Number" pattern="[0-9]{1,25}" minlength="8" maxlength="8" required> 
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                             ...
                                                             <input type="text" class="form-control" name="tstatus" title="The Status of the Treaty" placeholder="Treaty Status" required> 
                                                        </div>

                                                        <div class="form-group">
                                                             <label>Formula:</label>
                                                             <input type="text" class="form-control" name="formula" title="Formula" placeholder="Formula" required> 
                                                        </div>
                                                  ...
                                                  <br>
                                                   <div class="row">
                                                    <div class="col-lg-12">
													 <button id="esetForm" type="button" class="btn btn-success btn-lg btn-block"  >Add Reinsurance Treaty</button>
                                                     </form>
...
$('#esetForm').click(function(e){
        ...
        Swal.fire({
                    title: 'Are you sure?',
                    text: "You are about to add a New Reinsurance Treaty!",
                    type: 'question',
                    
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: 'Yes, Add New Reinsurance Treaty!'
                    }).then((result) => {
                    if (result.value) {
                        document.getElementById('kt_form').submit();
                        Swal.fire(
                        'ADDED',
                        'Reinsurance Treaty added',
                        'success'
                        )
                    }
                        })
