...
<!---new--->
 ...
 <!--begin::Portlet-->
  <div class="kt-portlet kt-portlet--height-fluid">
   ...
   <div class="kt-portlet__body kt-portlet__body--fluid">
   <a href="{{Route('admin-makePolicy')}}">
        <img id="manually" src="{{asset('images/manually.jpg')}}" alt=""/> 
       </a>
    </div>
   </div>
 <!--end::Portlet-->
        ...
        <div class="modal-body">
            <div class="row">
				  <div class="col-md-3 form-group">
						...
						<input id="FirstName" type="text" class="form-control" name="fname" aria-describedby="emailHelp" placeholder="First Name" required>
					</div>
				  <div class="col-md-3 form-group">
						<label>Last Name :</label>
						<input id="LastName" type="text" class="form-control" name="lname" aria-describedby="emailHelp" placeholder="Last Name" required>
					</div>
				  <div class="col-md-3 form-group">
						<label>Omang :</label>
						<input id="Omang" type="text" class="form-control" name="id" aria-describedby="emailHelp" placeholder="Omang ID" required>
					</div>
                    <div class="col-md-3 form-group">
...
<div class="col-md-6 orcname">
    ...
    <br>
    <label>Omang</label>
    <span><input id="omangNumber" class="form-control" name="omangNumber" maxlength="9"  type="text"></span>
    <br>
    ...
    <span><input id="placeOfBirth" class="form-control" name="address" type="text"></span>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button id="closeModal" type="button" class="btn btn-outline-brand" data-dismiss="modal">Close</button>
                                                                    <button id="saveChanges" type="button" class="btn btn-outline-brand">Save changes</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
		...
		$("#imageForm").on("submit", function (e) {
			...
			//- });
                    $('#saveChanges').on("click",function(){
                        ...
                        $("#FirstName").val($("#customerName").val());
