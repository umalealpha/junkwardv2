...
<html lang="en" >
                                ...
                                <form id="kt_form" name="ClaimForm" class="kt-form" action="{{Route('admin-savePolicy')}}" method="POST" accept="image/jpeg , image/bmp , image/png" enctype="multipart/form-data">
                                    ...
                                    <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current" style="width:80%">
                                        ...
                                        <div class="kt-form__section kt-form__section--first">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="kt-radio-inline">
                                                        <label class="kt-radio">
                                                            <input type="radio" name="gender" id="gender" value="male" class="premiumField">
                                                            Male <span></span> 
                                                        </label>
                                                        <label class="kt-radio">
                                                            <input type="radio" name="gender" id="gender" value="female" class="premiumField">
                                                            Female<span></span> 
                                                        </label>
                                                       </div>
                                                    </div> 
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="omang" type="text" id="kt_maxlength_9" class="form-control id-type" name="omang" placeholder="Please enter omang number" title="Omang must have 9 digits only" pattern="[0-9]{9}" minlength="9" maxlength="9"  value="{{old('omang')}}"  required>
                                                    </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input  type="date" class="form-control premiumField" id="dob" name="dob" value="{{old('dob')}}" title="Customers age, must be 18 years or older" placeholder="DD/MM/YYYY"
                                            ...
                                            <div class="kt-heading kt-heading--md">Product Selection</div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control kt_selectpicker"  title="Please choose product" data-live-search="true" id="Product" required>

                                                            <option value="" selected>Please choose</option>
                                                            <option data-subtext="Life" data-section= 'Funeral' value="funeralPlan">Funeral Plan</option>
                                                            <option value="motorThirdPartyCover" data-section= 'ThirdPartyMotor' data-subtext="Motor">Third party cover</option>
                                                            <option data-divider="true"></option>
                                                            <option value="motorUBI" data-section= 'UBIMotor' data-subtext="Motor">UBI</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>

                                            <div id="Funeral" class="productDivHide">
                                                <div class="kt-separator kt-separator--border-dashed kt-separator--space-lg"></div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-form-label col-lg-12 col-sm-12">How much cover do you need ?</label>
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="row align-items-center">
                                                                    <div class="col-10">
                                                                        <div id="kt_nouislider_1" class="premiumField"></div>
                                                                    </div> 
                                                                    <div class="col-2">
                                                                        <input type="text" class="form-control" id="Coverage" placeholder="Coverage" disabled="" >
                                                                    </div>
                                                                </div>
  <!--                                                              <span class="form-text text-muted">Input control is attached to slider</span>-->
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-form-label col-lg-12 col-sm-12">What is your currently monthly income ? *(before deductions)</label>
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="row align-items-center">
                                                                    <div class="col-12">

                                                                        <select class="form-control premiumField" id="incomeRange" >
                                                                            <option value="">Please Choose...</option>
                                                                            <option value="5000">Less than 5000P</option>
                                                                            <option value="10000">Less than 10000P</option>
                                                                            <option value="20000">Less than 20000P</option>
                                                                            <option value="35000">Less than 35000P</option>
                                                                            <option value="50000">Less than 50000P</option>    
                                                                        </select>
  ...
  <!--                                                              <span class="form-text text-muted">Input control is attached to slider</span>-->
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Calculate premium : <span id="premiumLife"></span></label>
                                                        </div>
                                                        <div class="form-group">
                                                        </div>
                                                        <div class="col-xl-12">
                                                                    ...
                                                                    <div class="kt-portlet__head">
                                                                        <div class="kt-portlet__head-label">
                                                                            <h3 class="kt-portlet__head-title">
                                                                                    ...
                                                                                    <span>&nbsp;<i class="flaticon-plus" style="font-size: 35px; display: inline-block;cursor: pointer;" id="addMember"></i></span>
                                                                            </h3>
                                                                        </div>
                                                                    </div>
                                                                    <!--begin::Form-->
                                                                        ...
                                                                        <div class="kt-portlet__body">
                                                                            <div class="kt-repeater">
                                                                                <div data-repeater-list="demo2">
                                                                                    <div data-repeater-item class="kt-repeater__item">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-lg-6">
                                                                                             <select class="form-control memberRelatives" id="memberRelatives" >
                                                                                                <option value="">Please Choose...</option>
                                                                                        ...
                                                                                        <div class="col-lg-6">
                                                                                            <label>Date Of Birth</label>
                                                                                            <input  type="date" class="form-control" name="dobMember[]" title="Customers age, must be 18 years or older" placeholder="DD/MM/YYYY"
                                                                                                    onclick="datePicker(event)" data-relmax="-18" required> 
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="kt-radio-inline">
                                                                                            <label class="kt-radio">
                                                                                                <input type="radio" name="genderMember[]" id="genderMember[]" value="male">
                                                                                                Male <span></span> 
                                                                                            </label>
                                                                                            <label class="kt-radio">
                                                                                                <input type="radio" name="genderMember[]" id="genderMember[]" value="female">
                                                                                                Female<span></span> 
                                                                                            </label>
                                                                                           </div>
                                                                                        </div> 
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                                     <label class="col-form-label col-lg-6 col-sm-6">How much cover do you need ?</label>
                                                                                                    <div class="row align-items-center">
                                                                                                        <div class="col-10">
                                                                                                            <div id="sliderMember" class="sliderMember"></div>
                                                                                                        </div> 
                                                                                                        <div class="col-2">
                                                                                                            <input type="text" class="form-control memberCoverage" id="memberCoverage" placeholder="Coverage" disabled="" >
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        <div class="form-group">
                                                                                                ...
                                                                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                                    ...
                                                                                                    <span class="form-text text-muted">You spouse qualified for the same cover amounts as you, chrildren and parents qualify for up to 50% of your cover amount.</span>
                                                                                                </div>
                                                                                        </div>
                                                                                ...
                                                                                <div class="kt-repeater__add-data">
                                                                                    <span data-repeater-create="" class="btn btn-success btn-sm"> <i class="la la-plus"></i> Add Another Contact </span>
                                                                                    <span data-repeater-delete="" class="btn btn-primary btn-sm"> <i class="la la-plus"></i> Add to plan </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <div id="ThirdPartyMotor" class="productDivHide">
                                                <div class="kt-separator kt-separator--border-dashed kt-separator--space-lg"></div>
                                            ...
                                            <div id="UBIMotor" class="productDivHide">
                                                <div class="kt-separator kt-separator--border-dashed kt-separator--space-lg"></div>
                                                <div class="kt-heading kt-heading--md">UBI Details</div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control kt_selectpicker" name="makek" title="Please choose vehicle make..." data-live-search="true" id="carMakeDropDown" required>
                                                                @foreach ($carMake as $make)
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="form-control kt_selectpicker" title="Please select the policy plan the customer prefers" name="policyPlan1" id="exampleSelect1" required>
                                                            @foreach ($policyPlan as $plan )
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <button id="submitForm" type="submit" value="submit" class="btn btn-success btn-lg pull-right">Submit Policy</button>
                                                </div>
...
<script>
    ...
    $("#Product").change(function(){
        $('.loading').css("display", "block");
            $('#Product').find("option:not(:selected)").each(function()
            {
            var elementId = $(this).attr('data-section');
            //$('div#' + elementId).removeClass('productDivShow').addClass('productDivHide');  
            $('div#' + elementId).slideUp('slow');
            });
        var element = $(this).find('option:selected');
        var elementId = element.attr('data-section');
        //$("div#".elementId).removeClass('productDivHide').addClass('productDivShow'); 
        $('div#' + elementId).slideDown('slow');
        $('.loading').css("display", "none");
     });
    
    var $options = $('.premiumField');
    $options.click(function(e) {
        var coverage = $("#Coverage").val().replace('(BWP)', '').replace(',', '');
        var gender = $("input[name='gender']:checked").val();
        var dob = $("#dob").val();
        dob = new Date(dob);
        var today = new Date();
        var age = Math.floor((today-dob) / (365.25 * 24 * 60 * 60 * 1000));
        var salary = $("#incomeRange").val();
        premium = (coverage / 100) * 6;
        
        $("#premiumLife").html('<strong> '+ premium +' BWP</strong>');
    });
    ...
    bigValueSlider = document.getElementById('kt_nouislider_1');
    ...
    start: 20000,
            ...
            pips: {
            mode: 'values',
                    values: [20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000],
                    density: 2
            }
    });
    var inputFormat = document.getElementById('Coverage');
    ...
    bigValueSliderMember = document.getElementsByClassName('sliderMember');
    var sliders = [];
    for (var i = 0; i < bigValueSliderMember.length; i++) {
   
    noUiSlider.create(bigValueSliderMember[i], {
         start: 20000,
            step: 10000,
            format: wNumb({
            decimals: 0,
...
//    var inputFormat = document.getElementsByClassName('memberCoverage');
//    bigValueSliderMember.noUiSlider.on('update', function (values, handle) {
//    inputFormat.value = values[handle];
//    });
//    inputFormat.addEventListener('change', function () {
//    sliderFormat.noUiSlider.set(this.value);
...
<script>
    ...
    required: true,
            ...
            back: {required: true, accept: "image/*"},
            right: {required: true, accept: "image/*"},
            left: {required: true, accept: "image/*"},
    }
    });
