        ...
        <div class="kt-grid kt-grid--hor kt-grid--root">
            <!-- begin:: Page -->
                        ...
                        <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                            ...
                            <div class="col-lg-8 text-center policyno">
                            <h1>Editing Policy No # MIS-2019-{{$policies->policyNumber}}</h1>
                            </div>
                            <div class="col-lg-4 text-right policyno" >
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <br>
																	<label>
                                                                           ...
                                                                           <h3>Policy Status: <span style="color:#CC0000"> Deactivated</span></h3>
                                                                            @endif
																		<span></span> 
																	</label>
                                                            </div>
                        ...
                        <table class="table table-hover">
							<tr>
								<th>Name:</th>
								<td><input value="{{$policies->firstName}} {{$policies->lastName}}"></td>
							  </tr>
							  <tr>
								<th>Cellphone:</th>
								<td><input value="{{$policies->cellphone}}"></td>
							  </tr>
							  <tr>
								<th>Email:</th>
							  ...
							  <tr>
								<th>Omang ID:</th>
								<td><input value="{{$policies->omang}}"></td>
							  </tr>
							  <tr>
							  ...
							  <tr>
								<th>DOB:</th>
								<td><input value="{{$policies->dob}}"></td>
							  </tr>
						  </table>
							  ...
							  <tr>
								...
								<td><span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--metal">
                                                              <label>
                                                             ...
                                                             <div class="file btn  btn-primary">
                                                                ...
                                                                <input type="hidden" name="firstName" value="{{$policies->firstName}}" />
                                                                <input type="hidden" name="lastName" value="{{$policies->lastName}}" />  
                                                                <input type="hidden" name="id" value="{{$userDetails->id}}" />

                                                                <input type="file" name="driversLicense"  onchange="this.form.submit()" />
							  ...
							  <tr>
								...
								<td><span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--metal">
                                                            ...
                                                            <form action="{{Route('uploadOmang')}}" method="POST" accept="application/pdf , image/jpeg , image/bmp , image/png" enctype="multipart/form-data">
                                                                ...
                                                                <input type="file" name="omang"  onchange="this.form.submit()" />
								...
								<td><span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--metal">
                                                            <label>
                                                             ...
                                                             <div class="file btn  btn-primary">
                                                                ...
                                                                <input type="file" name="bluebook"  onchange="this.form.submit()" />
...
<div class="dropdown">
                                 ...
                                 <p style="font-weight: bold;">P{{$selectedPolicyPlan->cost}}/month – for P{{$selectedPolicyPlan->sumInsured}} of insusrance cover</p>
							  ...
							  <tr>
								...
								<td>
									<table class="preminum">
										<tr>
											<th>Name</th>
											<td style="font-weight: bold;">P {{number_format($selectedPolicyPlan->cost, 2)}}</td>
										</tr>
										<tr>
											<th>Vat(5%)</th>
											<td style="font-weight: bold;">P {{5/100 * $selectedPolicyPlan->cost }}</td>
										</tr>
										<tr class="total">
											<th>Total</th>
											<td style="font-weight: bold;">P {{5/100 * $selectedPolicyPlan->cost + $selectedPolicyPlan->cost}}</td>
										</tr>
									</table>
								</td>
							  </tr>
							...
							<tr>
							  ...
							  <tr>
								...
								<td>{{$policies->billingStartDate}}</td>
							  </tr>
							  ...
							  <tr>
								...
								<td>
									<table class="preminum">
								   @if($policies->billing == 'Bank Account')

                                         	<tr>
											<th>Bank Name</th>
											<td>{{$policies->bankName}}</td>
										</tr>
										<tr>
											<th>Branch Code</th>
											<td>{{$policies->branchCode}}</td>
										</tr>
                                        	<tr>
											<th>Account Number</th>
											<td>{{str_repeat("*", strlen($policies->accountNumber)-4).substr($policies->accountNumber,-4)}}</td>
										</tr>   
	                                    ...
	                                    <tr>
											...
											<td>{{$policies->billing}}</td>
										</tr>
										<tr>
											<th>Billing Cell</th>
											<td>{{$policies->cellphone}}</td>
										</tr>
                                            ...
                                            @if($policies->isActive == 1)
                                               ...
                                               <div>
                                                        ...
                                                        {{csrf_field()}}
                                                            ...
                                                            <input type="hidden" name="billingStartDate" value="{{$policies->billingStartDate}}" />
                                                            <input type="hidden" name="cellphone" value="{{$policies->cellphone}}" />
                                                            </form>
                                                            </div>
                                          @elseif ($customerKYC->omang == null || $customerKYC->bluebook == null || $customerKYC->driversLicense == null)
                                          <button type="button" class="btn btn-success" data-toggle="button" aria-pressed="false" autocomplete="off" disabled>Activate policy</button>
                                            
                                            @elseif($customerKYC->omang != null && $customerKYC->bluebook != null && $customerKYC->driversLicense != null)
                                                             <div>
                                                                <form action="{{Route('activateUserPolicy')}}" method="POST">
                                                                 <button class=" btn btn-success btn-block" onclick="this.form.submit()">Activate Policy</button>
                    ...
                    <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                        <div class="kt-footer__copyright" > 2019&nbsp;&copy;&nbsp;<a href="#" target="_blank" class="kt-link">Alpha Direct in Partnership with : </a><a href="https://www.aig.com/individual" target="_blank"><img src="{{ asset('img/aig7.png') }}" alt="not found"></a> </div>
