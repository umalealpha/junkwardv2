                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                        ...
                                        <form id="kt_form" name="SupplierForm" class="kt-form" action="{{Route('saveSupplier')}}" method="POST"  accept="image/jpeg , image/bmp , image/png" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                            <!--begin: Form Wizard Step 1-->
                                            <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current" style="width:80%">
                                               <h3 class="kt-section__title" >New Supplier Form</h3>
                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                  <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="sname" name="sname" placeholder="Name" title="Suppliers First Name" pattern="[A-Za-z]{1,25}" maxlength="25" required> 
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Suppliers Telephone Number</label>
                                                        <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Suppliers Telephone Number" title="Suppliers Number" pattern="[0-9]{1,25}" minlength="8" maxlength="8" required> 
                                                    </div>

                                                    <div class="form-group">
                                                             <label>Suppliers Image</label>
                                                             <input type="file" name="image" title="Upload Companies Image" class="form-control">
                                                    </div>    
                                                        ...
                                                        <div class="form-group">
                                                             <label>Suppliers Email</label>
                                                             <input type="email" class="form-control" name="semail" title="Suppliers Email" placeholder="Email" maxlength="100" required> 
                                                        </div>

                                                        <div class="form-group">
                                                             <label>Suppliers Location</label>
                                                             <input type="text" class="form-control" name="slocation" title="Suppliers Location" placeholder="Location" maxlength="60" required> 
                                                        </div>
