                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                        ...
                                        <form id="kt_form"  class="kt-form" action="{{Route('admin-createPolicyPlan')}}" method="POST">
                                        {{csrf_field()}}
                                            <!--begin: Form Wizard Step 1-->
                                            <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current" style="width:80%">
                                               <h3 class="kt-section__title" >New Policy Plan Form</h3>
                                                <div class="kt-heading kt-heading--md">Policy Plan Details</div>
                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                  <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="premium" aria-describedby="emailHelp" placeholder="Please enter premium" maxlength="6" onkeydown="return isNumberKey(event)" required>                                                    </div>
                                                    <div class="form-group">
                                                  ...
                                                  <br>
                                                   <div class="row">
                                                    ...
                                                    <input type="hidden" name="claim_id">
													 <button id="esetForm" type="button" class="btn btn-success btn-lg btn-block" >Add Policy Plan</button>
                                                     </form>
