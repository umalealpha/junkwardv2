                                        ...
                                        <div class="kt-portlet__body">
                                           ...
                                           <form class="navbar-form navbar-search" role="search">
                                                                     ...
                                                                     <button type="button" class="btn btn-outline-hover-secondary" disabled="disabled"><i class="fa fa-search"></i></button>
                                                                                 ...
                                                                                 <!-- <div class="dropdown">
                                                                                     ...
                                                                                     <div class="form-group">
                                                                                        <select class="form-control" name="category" id="exampleSelect1">
                                                                                            ...
                                                                                            <option value="CellphoneNumber">Cellphone Number</option>
                                                                                            <option value="VehiclePlate">Vehicle Registration No.</option>
                                                                                        </select>
                                                                                    </div>
                                                                         ...
                                                                         <div class="input-group-btn">
                                                                            <!-- <button type="submit" class="btn btn-outline-hover-danger" onclick="fetch_customer_data()"><i class="fa fa-search"></i> Go</button> -->
                                                                         </div>
                                                                     </div>
                                                                 </form>                                                      </div>
                                        </div>
                                                    ...
                                                    <div class="kt-form__group kt-form__group--inline kt-margin-r-10">
                                                        ...
                                                        <div class="kt-form__control" style="width: 160px;">
                                                            <select class="form-control bootstrap-select" id="kt_form_status" title="Status">
                                                                ...
                                                                <option value="4">Motor Reg. No </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                     <button type="button" class="btn btn-outline-brand" ><a href="{{Route('admin-addPolicyPlan')}}" title="Add a Policy Plan" class="kt-nav__link"><i class="flaticon2-add-circular-button"></i></a></button>
                                                </div>
                                            </div>
                                        </div>
...
{{-- 
                    ...
                    <div class="kt-footer__copyright">2019&nbsp;&copy;&nbsp;<a target="_blank" class="kt">Alpha Direct in Partnership with : </a><a href="https://www.aig.com/individual" target="_blank"><img src="{{ asset('img/aig7.png') }}" alt="not found"></a> </div>
                    </div>
                    <!-- end:: Footer -->
                </div>
                <!-- end:: Wrapper -->
 ...
 <div id="editModal" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-xl">
     <div class="modal-content">
        ...
        <form action="{{Route('admin-createPolicyPlan')}}" method="POST">
        {{csrf_field()}}
        <div class="modal-body">
            <div class="row">
				  <div class="col-md-6 form-group">
						<label>Premium Paid Per Cycle:</label>
						<input type="number" class="form-control" name="premium" aria-describedby="emailHelp" placeholder="Please enter premium" maxlength="6" onkeydown="return isNumberKey(event)" required>
					</div>
                    <div class="col-md-6 form-group">
                        <label>Term Type :</label>
                        <select  name="termType"  title="Please select billing cycle" data-live-search="true" class="form-control kt_selectpicker">
            ...
            <div class="row">
				  <div class="col-md-6 form-group">
						...
						<input type="text" class="form-control" name="sumInsured" aria-describedby="emailHelp" placeholder="Please enter the sum insured" maxlength="9" onkeydown="return isNumberKey(event)" required>
					</div>
                    <div class="col-md-6 form-group">
                        <label>Activate Policy Plan :</label>
                        <select  name="planStatus"  title="Please select billing cycle" data-live-search="true" class="form-control kt_selectpicker">
        ...
        {{ csrf_field() }}
            ...
            <div class="form-group">
               <input type="hidden" id="id" name="id" />
                ...
                <input  type="text" class="form-control" id="editCellphone" name="cellphone">
                </div>
                </div>
                <div class="row">
...
<!-- /modal 2 -->
    ...
    "colors": {
       ...
       <script src="{{asset('css/vendors/custom/datatables/datatables.bundle.js')}}" type="text/javascript"></script>
...
<script>
  ...
  @endif
   ...
   @if(Session::has('policyPlanDeleted'))
    Toastify({
      text: "{{ Session::get('policyPlanDeleted') }}",
      duration: 4000,
      newWindow: true,
      gravity: "top", // `top` or `bottom`
      positionRight: true, // `true` or `false`
  ...
  @endif
   ...
   @if(Session::has('policyPlanActivated'))
    Toastify({
      text: "{{ Session::get('policyPlanActivated') }}",
      duration: 4000,
      newWindow: true,
      gravity: "top", // `top` or `bottom`
      positionRight: true, // `true` or `false`
  ...
  @endif
   ...
   @if(Session::has('policyPlanDeactivated'))
    Toastify({
      text: "{{ Session::get('policyPlanDeactivated') }}",
      duration: 4000,
      newWindow: true,
      gravity: "top", // `top` or `bottom`
      positionRight: true, // `true` or `false`
  ...
  @endif
   ...
   @if(Session::has('policyPlanCreated'))
    Toastify({
      text: "{{ Session::get('policyPlanCreated') }}",
      duration: 4000,
      newWindow: true,
      gravity: "top", // `top` or `bottom`
      positionRight: true, // `true` or `false`
...
var datatable = $('#policies').KTDatatable({
  ...
  data: {
    ...
    source: {
      read: {
        method:'GET',
        url: '{{Route('admin-getAllPolicyPlans')}}',
        map: function(raw) {
  ...
  columns: [
    ...
    },
    {
      ...
      field: 'status',
      width:165,
      title: 'Policy Plan Status ',
      template: function(row, index, datatable) {

        if(row.status == 1){

         return '<i class="la la-check" data-toggle="tooltip" data-placement ="top" title = "Policy Plan has been activated " style="color:#00C851;font-size:22px;"></i>';
        } else{
            
         return '<i class="la la-close" data-toggle="tooltip" data-placement ="top" title = "Policy Plan has been deactivated" style="color:#CC0000;font-size:22px;"></i>';
        }
      },
    },
      {
      ...
      template: function(row, index, datatable) {
        ...
        if(row.status == 1){
         ...
         return '<a href="deactivatePolicyPlan/'+row.id+'">Deactivate</a>' 
        } else{
            
            return '<a href="activatePolicyPlan/'+row.id+'">Activate</a>' 
        }
      },
    },
...
/*{
      ...
      return '<div class="dropdown ' + dropup + '">\
                        ...
                        <div class="dropdown-menu dropdown-menu-right">\
                            <a class="dropdown-item" href="deletePlan/'+row.id+'"><i class="la la-trash-o"></i>Delete Policy Plan</a>\
                            \
                            \
                        </div>\
                    </div>\
