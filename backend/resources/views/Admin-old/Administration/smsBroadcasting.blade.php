                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                  <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <label><h5>Cellphone Numbers</h5></label>
                                                        <input type="text" class="form-control" name="Dcellphone" placeholder="Enter Cellphone Number Here" title="Select or Enter Cellphone numbers to SMS" required> 
                                                    </div>

                                                    

                                                    <div class="form-group">
                                                        <label><h5>SMS Message Here</h5></label>
                                                        <textarea rows = "15" cols = "60" name = "smsMessage"  title="Enter SMS Message Here"> </textarea><br>
                                                    </div>
                                                  ...
                                                  <br>
                                                   <div class="row">
                                                    ...
                                                    <input type="hidden" name="claim_id">
													 <button id="esetForm" type="button" class="btn btn-success btn-lg btn-block" >Send SMS</button>
                                                     </form>
...
$.ajax({
        ...
        Swal.fire({
                title: 'Are you sure?',
                text: "You are about to send an SMS Broadcast!",
                type: 'question',
                
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, Send the SMS Broadcast!'
                }).then((result) => {
