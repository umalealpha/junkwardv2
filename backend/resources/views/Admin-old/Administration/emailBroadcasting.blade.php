                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                        ...
                                        <form id="kt_form" name="EmailForm" class="kt-form" action="{{ \Config::get('values.graphite_url') }}/mailer/mail" method="POST">
                                        {{csrf_field()}}
                                            <!--begin: Form Wizard Step 1-->
                                            <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current" style="width:80%">
                                               <h2 class="kt-section__title" >Email Broadcasting</h2>
                                                <div class="kt-heading kt-heading--md"></div>
                                                <div class="kt-separator kt-separator--height-xs"></div>
                                                <div class="kt-form__section kt-form__section--first">
                                                  <div class="row">
                                                    <div class="col-lg-12">
                                                    <div class="form-group multiple-val-input">
                                                        ...
                                                        <!-- <label for="exampleSelect1">To:</label> -->
							                                    <select class="form-control" name="bankAccountType"  required>
                                                                    ...
                                                                    <option value="21" >All Departments</option>
                                                                    <option value="2" >Head Of Departments</option>
                                                                    <option value="31" >Sales</option>
                                                                    <option value="32" >Accounts</option>
                                                                    <option value="4" >Claims</option>
                                                                    
                                                                </select>
<!-- 
                                                        <ul>
                                                            <input type="email" multiple class="form-control" name="too" placeholder="Enter Emails Here" title="Select or Enter Email" required>
                                                            <span class="input_hidden"></span>
                                                        </ul> -->
                                                    </div>

                                                    <div class="form-group multiple-val-input">
                                                        <label><h5>CC</h5></label>
                                                        <!-- <ul>
                                                            <input type="email" multiple class="form-control" name="cc" placeholder="Enter Emails Here" title="Select or Enter Email" required>
                                                            <span class="input_hidden"></span>
                                                        </ul> -->
                                                        <select class="form-control" name="bankAccountType"  required>
                                                                    <option ></option>
                                                    ...
                                                    <label><h5>Subject</h5></label>
                                                        <input type="text" class="form-control" name="subject" placeholder="Enter Subject" title="Enter Email Subject" maxlength="50" required> 
                                                    </div>

                                                    <div class="form-group">
                                                        <label><h5>Attach a File</h5></label>
                                                        <input type="file" name="image" title="Upload a File" class="form-control">
                                                    </div>    
                                                  

                                                    <div class="form-group">
                                                        <label></label>
                                                        <textarea rows = "15" cols = "60" name="content" placeholder="Enter Message Here Here"> </textarea><br>
                                                    </div>
                                                  ...
                                                  <br>
                                                   <div class="row">
                                                    ...
                                                    <input type="hidden" name="claim_id">
													 <button id="esetForm" type="button" class="btn btn-success btn-lg btn-block">Send Email</button>
                                                     </form>
...
if(billingMethod === 'Bank'){
        ...
        $('.multiple-val-input ul input').on('input propertychange', function() {
            $(this).siblings('span.input_hidden').text($(this).val());
            // var inputWidth = $(this).siblings('span.input_hidden').width();
            // $(this).width(inputWidth);
        });
        $('.multiple-val-input ul input').on('keypress', function(event){
        ...
        Swal.fire({
                title: 'Are you sure?',
                text: "You are about to send an Email Broadcast!",
                type: 'question',
                
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, Send the Email Broadcast!'
                }).then((result) => {
