                                           ...
                                           <div class="col-lg-12 newsearch1"> 
                                             <form class="navbar-form navbar-search" role="search">
                                                                     ...
                                                                     <button type="button" class="btn btn-outline-hover-secondary" disabled="disabled"><i class="fa fa-search"></i></button>
                                                                         <input type="text" class="form-control" name="query" id="query" placeholder="Search For Staff Members Here">
                                                                             ...
                                                                             <div class="col">
                                                                                 <!-- <div class="dropdown">
                                                                                     ...
                                                                                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="right" data-skin="dark" data-container="body" data-original-title="Tooltip title">Employee Name</a>
                                                                                         <a class="dropdown-item" href="#">Staff Email</a>
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Tooltip title">stafff Cellphone</a>
                                                                                     </div>
                                                                                 </div> -->
                                                                             </div>
                                                                         </div>
                                ...
                                <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                                    ...
                                    <div class="kt-portlet kt-portlet--height-fluid">
                                        ...
                                        <div class="kt-portlet__body kt-portlet__body--fit">
                                            ...
                                            <div class="kt-datatable" id="staff"></div>
                                        </div>
                                    </div>
                                    <!--end::Portlet-->
                                </div> 
        ...
        <div class="modal-body">
            <div class="row">
				  <div class="col-md-4 form-group">
						...
						<input type="text" class="form-control" name="firstName" aria-describedby="firstNameHelp" placeholder="Enter first name" required maxlength="40"> 
					</div>
			
                    <div class="col-md-4 form-group">
						<label>Last Name :</label>
						<input type="text" class="form-control" name="lastName" aria-describedby="lastNameHelp" placeholder="Enter last name" required maxlength="40"> 
					</div>

                    
                  <div class="col-md-4 form-group">
					<label for="exampleSelect1"> Account Type:</label>
						<select class="form-control" name="accountType" id="exampleSelect1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
						<label for="exampleSelect1">Email:</label>
							<input type="email" class="form-control" name="email" aria-describedby="emailHelp" placeholder="Please enter email" required maxlength="40"> 

					</div>
              
                       <div class="col-md-4 form-group">
						<label for="exampleSelect1">Password:</label>
							<input type="password" class="form-control" autocomplete="off" name="password" aria-describedby="passwordHelp" placeholder="Please enter password" required minlength="6" maxlength="15">

					</div>

                     <div class="col-md-4 form-group">
						<label for="exampleSelect1">Cellphone:</label>
						<!-- <input type="number" class="form-control" name="cellphone" max="11" min="8" aria-describedby="passwordHelp" placeholder="Please enter Phone Number" title="Phone Number" required> -->
                        <input class="form-control" name="cellphone" aria-describedby="emailHelp" type="text" required  minlength="8" maxlength="8"/>
					</div>
...
<script>
   ...
   @if(Session::has('accountCreation'))
    Toastify({
      text: "{{ Session::get('accountCreation') }}",
      duration: 4000,
      newWindow: true,
  ...
  @endif
   ...
   @if(Session::has('staffAdded'))
    Toastify({
      text: "{{ Session::get('staffAdded') }}",
      duration: 4000,
      newWindow: true,
      gravity: "top", // `top` or `bottom`
      positionRight: true, // `true` or `false`
...
var datatable = $('#staff').KTDatatable({
    ...
    },
    {
     ...
     /*{
      ...
      template: function(row, index, datatable) {
        ...
        //     console.log(currentEditData.dob.split("\/"));
        //     $("#dob").val(currentEditData.dob.split("\/")[0]+"/"+currentEditData.dob.split("\/")[1]+"/"+currentEditData.dob.split("\/")[2]);
        ...
        //                 </a>\
        //                 <div class="dropdown-menu dropdown-menu-right">\
        //                     <a class="dropdown-item" href="#"><i class="la la-edit"></i> Edit Agent Details</a>\
        //                     <a class="dropdown-item"><i class="la la-file-pdf-o"></i> Generate PDF</a>\
        //                 </div>\
        //             </div>\
        //             <a class="btn btn-hover-brand btn-icon btn-pill" title="View Policy">\
        //                 <i class="la la-eye"></i>\
        //             </a>\
        //             <button type="button" class="btn btn-hover-brand btn-icon btn-pill showModal" data-toggle="modal" data-id="'+row.id+'" data-data='+JSON.stringify(row)+' data-target="#editModal" title="Edit"><i class="la la-edit"></i></button>\
        //             </a>\
        //             ';
