                                           ...
                                           <div class="col-lg-12 newsearch1"> 
                                             <form class="navbar-form navbar-search" role="search">
                                                                     ...
                                                                     <button type="button" class="btn btn-outline-hover-secondary" disabled="disabled"><i class="fa fa-search"></i></button>
                                                                         <input type="text" class="form-control" name="query" id="query" placeholder="Search For Companies Here">
                                                                             ...
                                                                             <div class="col">
                                                                                 <!-- <div class="dropdown">
                                                                                     ...
                                                                                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="right" data-skin="dark" data-container="body" data-original-title="Tooltip title">Company Name</a>
                                                                                         <a class="dropdown-item" href="#">Company Email</a>
                                                                                         <a class="dropdown-item" href="#" data-toggle="kt-tooltip" title="" data-placement="left" data-original-title="Tooltip title">Company Location</a>
                                                                                     </div>
                                                                                 </div> -->
                                                                             </div>
                                                                         </div>
                                ...
                                <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                                    ...
                                    <div class="kt-portlet kt-portlet--height-fluid">
                                                    ...
                                                    <div class="kt-form__group kt-form__group--inline kt-margin-r-10">
                                                        ...
                                                        <div class="kt-form__control" style="width: 160px;">
                                                            <select class="form-control bootstrap-select" id="kt_form_status" title="Status">
                                                                ...
                                                                <option value="3">Company Location</option>
                                                                <option value="4">Company Email</option>
                                                                
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <button type="button" class="btn btn-outline-brand"><a href="{{Route('addCompanies')}}" title="Add A New Company" class="kt-nav__link"><i class="flaticon2-add-circular-button"></i></a></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="kt-portlet__body kt-portlet__body--fit">
                                            ...
                                            <div class="kt-datatable" id="companies"></div>
                                        </div>
                                    </div>
                                    <!--end::Portlet-->
                                </div> 
        ...
        <div class="modal-body">
             <div class="row">
				  ...
				  <div class="col-md-6 form-group">
						...
						<input type="text" class="form-control" name="cname" aria-describedby="emailHelp" placeholder="Company Name" required> 
					</div>
                    <div class="col-md-6 form-group">
						<label>Company Location :</label>
						<input type="text" class="form-control" name="clocation" aria-describedby="emailHelp" placeholder="Company Location" required> 
					</div>
                ...
                <div class="row">
				  ...
				  <div class="col-md-4 form-group">
						<label>Email :</label>
						<input type="text" class="form-control" name="cemail" aria-describedby="emailHelp" placeholder="Company Email" required> 
					</div>
                    <div class="col-md-4 form-group">
						<label>Telephone :</label>
						<input type="text" class="form-control" name="ctelephone" aria-describedby="emailHelp" placeholder="Company Telephone" required> 
					</div>
                    <div class="col-md-4 form-group">
						<label>Ratio For The Company :</label>
						<input type="text" class="form-control" name="cratio" aria-describedby="emailHelp" placeholder="Ratio" required> 
					</div>
              </div>
...
var datatable = $('#companies').KTDatatable({
