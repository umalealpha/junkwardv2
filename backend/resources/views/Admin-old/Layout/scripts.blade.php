...
<!--begin::Global Theme Bundle(used by all pages) -->
   ...
   <!--end::Global Theme Bundle -->
        ...
        <script src="{{asset('css/app/custom/general/components/forms/validation/controls.js')}}" type="text/javascript"></script>
        <!--end::Page Vendors -->
                    ...
                    if (xhr.status <= 200) {
                        if (notifications.length > 0 && typeof notifications != "undefined") {
                            ...
                            if (Push.Permission.has()) {
                                Push.create(title, {
                                    body: body,
                                        link:'https://'+window.location.hostname+'/admin/'+action,
