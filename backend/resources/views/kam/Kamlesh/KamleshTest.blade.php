                        ...
                        <div class="kt-portlet__body kt-portlet__body--fit">
                            ...
                            <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                <div class="tab-content">
                                            ...
                                            <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current" style="width:80%">
                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="omang" type="text" class="form-control" name="omang" placeholder="Please enter omang number" title="Omang must have 9 digits only" pattern="[0-9]{9}" minlength="9" maxlength="9" value="{{old('omang')}}"  required> 
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="passport" type="text" class="form-control" name="passport" placeholder="Please enter passport number" title="Passport Number" maxlength="12" value="{{old('passport')}}"  required> 
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <button id="submitForm" type="submit" class="btn btn-success btn-lg pull-right" onclick="document.getElementById('kt_form').submit();">Submit Policy</button>
                                                        </div>
                                    ...
                                    <div class="tab-pane" id="claim_history" role="tabpanel"> It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. </div>
...
<script>
    ...
    url: '{{Route('getCarModel')}}',
            ...
            data: {_token: CSRF_TOKEN, make:$('#carMakeDropDown option:selected').val()},
            dataType: 'JSON',
