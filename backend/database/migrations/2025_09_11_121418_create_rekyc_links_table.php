...
class CreateRekycLinksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rekyc_links', function (Blueprint $table) {
            $table->id();
            $table->foreignId('campaign_id')->constrained('rekyc_campaigns')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('rekyc_links');
    }
}
