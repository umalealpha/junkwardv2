...
return new class extends Migration {
    /**
     * Append MACHINERYBREAKDOWNLOSSOFPROFIT to the claims.claim_type ENUM
     * (2026-07-14). Same non-destructive, idempotent append approach as the
     * earlier claim-type enum migrations: read the live column definition and
     * only APPEND the missing value at the END, preserving every existing
     * value's index and the column's NULL / DEFAULT clause. Safe to re-run.
     */
    private const ADD = [
