...
class CreateMotorTradersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('motor_traders')) {
            Schema::create('motor_traders', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('motor_traders');
    }
}
