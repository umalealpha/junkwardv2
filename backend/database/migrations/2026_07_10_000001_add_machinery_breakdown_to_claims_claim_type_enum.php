...
return new class extends Migration {
    /**
     * Append MACHINERYBREAKDOWN to the claims.claim_type ENUM (2026-07-10).
     *
     * Same non-destructive, idempotent approach as
     * 2026_07_02_120000_add_coverage_types_to_claims_claim_type_enum: read the
     * live column definition and only APPEND the missing value at the END, so
     * every existing value keeps its internal ENUM index (no row data changes)
     * and the column's NULL-ability + default are preserved. Safe to re-run.
     */
    private const ADD = [
        'MACHINERYBREAKDOWN',
    ];
    ...
    public function down(): void
    {
        ...
        // Never drop a value that rows still use.
