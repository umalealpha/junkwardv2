...
class CreateAdGroupKycCampaignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ad_group_kyc_campaigns', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('employer_group_id')->nullable(); // AD Group employer group ID
            $table->integer('product_id')->nullable(); // Product ID (12 for AD Group)
    ...
    {
        Schema::dropIfExists('ad_group_kyc_campaigns');
    }
}
