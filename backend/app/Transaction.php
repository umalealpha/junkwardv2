...
class Transaction extends Model implements Auditable
{
    ...
    protected $fillable = ['customer_id', 'orangeTransaction_id', 'vcsTransaction_id', 'realPayTransaction_id', 'transactionType', 'amount', 'policyNumber', 'status', 'paymentDescription','referenceNumber'];
