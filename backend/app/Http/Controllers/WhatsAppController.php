      ...
      switch($data['hook_slug']) 
      {
            ...
            "template" => [
              ...
              "components" => [
                ...
                [
                  ...
                  "index" => "0",
                  "parameters" => [
                    ["type" => "text", "text" => $data['rekyc_url']]   // button will open this URL
                  ]
                ]
              ]
            ]
        ...
        case "bank_statement_upload":
          $payload = [
            ...
            "type" => "template",
            "template" => [
              "name" =>  env("APP_STATUS") == "Production" ? "bank_statement_upload_p" : "bank_statement_upload_d",   // must be the approved template name that has a URL button
              "language" => ["code" => "en_US"],
              "components" => [
                [
                  "type" => "body",
                ...
                [
                  ...
                  "index" => "0",
                  "parameters" => [
                    ["type" => "text", "text" => $data['bank_statement_url']]   // button will open this URL
                  ]
                ]
              ]
            ]
        ...
        // ── Payment Failed ────────────────────────────────────────
        // Template body: "Hi {{1}}, your payment of P{{2}} for policy {{3}} was unsuccessful.
        //                 Please update your payment details or contact us to avoid policy lapse."
        case "payment_failed":
          $payload = [
            "messaging_product" => "whatsapp",
            "to" => "267" . preg_replace('/\D+/', '', $data['mobileNumber']),
            ...
            "template" => [
              ...
              "components" => [[
                ...
                "parameters" => [
                  ...
                  ["type" => "text", "text" => $data['policyNumber']],
                ]
              ]]
            ]
          ];
        ...
        // ── Payment Success ───────────────────────────────────────
        // Template body: "Hi {{1}}, your payment of P{{2}} for policy {{3}} was received successfully.
        //                 Thank you for staying covered with Alpha Direct Insurance."
          ...
          $payload = [
            ...
            "template" => [
              ...
              "components" => [[
                ...
                "parameters" => [
                  ["type" => "text", "text" => $data['firstName']],
                  ["type" => "text", "text" => (string)$data['premium']],
                  ["type" => "text", "text" => $data['policyNumber']],
                ]
              ]]
            ]
        ...
        // ── Policy Cancelled ──────────────────────────────────────
        // Template body: "Hi {{1}}, your policy {{2}} has been cancelled as requested.
        ...
        // ── Policy Pending Activation ─────────────────────────────
        // Template body: "Hi {{1}}, your policy {{2}} is pending activation.
        //                 Your premium of P{{3}} will be collected on your next billing date."
        case "policy_pending_activation":
          $payload = [
            "messaging_product" => "whatsapp",
            "to" => "267" . preg_replace('/\D+/', '', $data['mobileNumber']),
            "type" => "template",
            "template" => [
              "name" => "policy_pending_activation",
              "language" => ["code" => "en_US"],
              "components" => [[
                "type" => "body",
                "parameters" => [
        ...
        // ── Payment Reminder ──────────────────────────────────────
        // Template body: "Hi {{1}}, a friendly reminder that your premium of P{{2}} for policy {{3}}
        //                 is due on {{4}}. Please ensure sufficient funds are available."
        ...
        // ── Policy Created / Welcome ──────────────────────────────
        // Template body: "Welcome to Alpha Direct Insurance, {{1}}! Your policy {{2}} is now active.
        //                 Your monthly premium is P{{3}}. Download your documents on the app."
        case "policy_created":
          $payload = [
            "messaging_product" => "whatsapp",
            "to" => "267" . preg_replace('/\D+/', '', $data['mobileNumber']),
