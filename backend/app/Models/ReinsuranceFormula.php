...
class ReinsuranceFormula extends Model implements Auditable
{
    ...
    protected $fillable = [
        'product_id', 'type_id', 'reinsurance_type_id', 'formula_code',
        'formula_name', 's_FormulaType', 'status', 'group_id', 'operator',
        'vehicle_type', 'si_allocation', 'percentage', 'date_from', 'date_to'
    ];
