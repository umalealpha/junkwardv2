...
class SendQuote extends Mailable
{
    ...
    public function __construct($data)
    {
        ...
        foreach ($templatefields as $field) {
            ...
            // array_push($replace_parameter, $msg_replace_fields[0]); //commented beacuse it was giving undefined 0 error issue
            if ($msg_replace_fields->isNotEmpty()) {
                array_push($replace_parameter, $msg_replace_fields[0]);
            } else {
                array_push($replace_parameter, null);
            }
        }
