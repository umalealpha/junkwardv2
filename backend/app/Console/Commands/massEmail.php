...
class massEmail extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'massEmail:cron';
    ...
    public function handle()
    {
      ...
      //  if(env('APP_STATUS') == 'Production') {
            ...
            $gfs = GFSEmails::whereNotNull('Email_Address')->get();
            foreach($gfs as $d){
               ...
               ->get(array('policies.policyNumber','policies.status','customer.email','customer.id','policies.id'));
            ...
            foreach($policies  as $policy){
              ...
              //  $sent = \Illuminate\Support\Facades\Mail::to($policy->email)->send(new MailTemplate($data));
                ...
                $log = new VATMemoLog();
                $log->document = 'mass_crisis_email3';
