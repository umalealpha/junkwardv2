...
/**
 * Quarterly auto-renew for SPECIALIST products only (backend copy).
 *
...
class SpecialistQuaterlyAutoRenew extends Command
{
     ...
     * @var string
     */
    protected $signature = 'SpecialistQuaterlyAutoRenew:cron {--policy= : Restrict the run to a single policy (id or policyNumber) — for local/testing. Omit to run the full batch as the scheduler does.}';
    ...
    public function handle()
    {
        ...
        $cron->save();
        Log::info("SpecialistQuaterlyAutoRenew Cron is working fine!");
