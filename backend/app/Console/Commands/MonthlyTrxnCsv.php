...
class MonthlyTrxnCsv extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'monthlytransectioncsv:cron';
     ...
     * @var string
     */
    protected $description = 'Monthly transactions CSV';
    ...
    {
        $cron = new CronStatus();
        $cron->name = "monthlytransectioncsv:cron";
        $cron->start = \Carbon\Carbon::now();
        $cron->save();

        $startDate =  Carbon::parse('today')->subMonth(1)->format('Y-m-d'). ' 00:00:01';
