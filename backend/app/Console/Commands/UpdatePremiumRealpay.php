        ...
        try{
            ...
            if($data != null || count($data) > 0){
                foreach($data as $key=>$d){
                    ...
                    $request = new Request();
                    $request['clientNumber'] = isset($d->ClientNumber) ? $d->ClientNumber : null;
                    ...
                    if (!isset($getcontract)) {
                        ...
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => config('realpay.base_url') . "/maintain/contracts/" . config('realpay.product') . "?ClientNumber=" . $d->ClientNumber . "&ContractNumber=" . $d->ContractNumber . "&ContractSequence=" . $d->ContractSequence . "&BeneficiaryUser=" . config('realpay.merchant') . "&Version=" . config('realpay.version'),
                        ...
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => config('realpay.start.base_url') . "/maintain/contracts/" . config('realpay.start.product') . "?ClientNumber=" . $d->ClientNumber . "&ContractNumber=" . $d->ContractNumber . "&ContractSequence=" . $d->ContractSequence . "&BeneficiaryUser=" . config('realpay.start.merchant') . "&Version=" . config('realpay.start.version'),
                            CURLOPT_RETURNTRANSFER => true,
                            CURLOPT_ENCODING => "",
                            CURLOPT_MAXREDIRS => 10,
                            CURLOPT_TIMEOUT => 0,
