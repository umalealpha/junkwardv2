...
class AddRealpayContractForExpiredPolicies extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'AddRealpayContractForExpiredPolicies:cron';
     ...
     * @var string
     */
    protected $description = 'This cron is used for adding realpay contract for expired policies';
    ...
    {
        $cron = new CronStatus();
        $cron->name = "AddRealpayContractForExpiredPolicies:cron";
        ...
        if (isset($policy_data)) {
            foreach ($policy_data as $key => $item) {
